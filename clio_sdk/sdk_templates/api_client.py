...
import clio_client.models as clio_client_models
from clio_client import rest
from clio_client.api_response import ApiResponse
from clio_client.api_response import T as ApiResponseT
from clio_client.configuration import Configuration
from clio_client.exceptions import (
    ApiException,
    ApiValueError,
    BadRequestException,
    ForbiddenException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clio_client_models, klass)
