...
class PolymorphicCustomRate:
    ...
    activity_description: Union[Unset, "PolymorphicCustomRateActivityDescription"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_activity_description, Unset):
            ...
            activity_description = PolymorphicCustomRateActivityDescription.from_dict(_activity_description)
