...
from ..models.contactupdate_json_body_data_addresses_item_name import (
    ContactupdateJsonBodyDataAddressesItemName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactupdateJsonBodyDataAddressesItem")


@_attrs_define
class ContactupdateJsonBodyDataAddressesItem:
    """
    Attributes:
        ...
        name (Union[Unset, ContactupdateJsonBodyDataAddressesItemName]): Name of the Address. Default:
            ContactupdateJsonBodyDataAddressesItemName.OTHER.
    ...
    name: Union[Unset, ContactupdateJsonBodyDataAddressesItemName] = ContactupdateJsonBodyDataAddressesItemName.OTHER
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name: Union[Unset, ContactupdateJsonBodyDataAddressesItemName]
        if isinstance(_name, Unset):
            name = UNSET
        else:
            name = ContactupdateJsonBodyDataAddressesItemName(_name)
        ...
        contactupdate_json_body_data_addresses_item = cls(
        ...
        contactupdate_json_body_data_addresses_item.additional_properties = d
        return contactupdate_json_body_data_addresses_item
