...
@_attrs_define
class FoldercreateFilesBodyDataParent:
    """
    Attributes:
        id (int): The unique identifier of the parent object.
        type_ (FoldercreateFilesBodyDataParentType): Type of parent object:
    ...
    id: int
    type_: FoldercreateFilesBodyDataParentType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = FoldercreateFilesBodyDataParentType(d.pop("type"))

        foldercreate_files_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        foldercreate_files_body_data_parent.additional_properties = d
        return foldercreate_files_body_data_parent
