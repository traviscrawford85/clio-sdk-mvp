...
@_attrs_define
class CustomFieldcreateDataBody:
    """
    Attributes:
        data (CustomFieldcreateDataBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_fieldcreate_data_body = cls(
            data=data,
        )

        custom_fieldcreate_data_body.additional_properties = d
        return custom_fieldcreate_data_body
