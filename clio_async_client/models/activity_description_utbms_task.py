...
T = TypeVar("T", bound="ActivityDescriptionUtbmsTask")


@_attrs_define
class ActivityDescriptionUtbmsTask:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_description_utbms_task = cls(
            code=code,
        ...
        activity_description_utbms_task.additional_properties = d
        return activity_description_utbms_task
