...
class ContactupdateDataBodyDataWebSitesItem:
    ...
    name: Union[Unset, ContactupdateDataBodyDataWebSitesItemName] = ContactupdateDataBodyDataWebSitesItemName.OTHER
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name: Union[Unset, ContactupdateDataBodyDataWebSitesItemName]
