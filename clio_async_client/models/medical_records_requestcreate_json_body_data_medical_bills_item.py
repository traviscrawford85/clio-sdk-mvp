...
if TYPE_CHECKING:
    from ..models.medical_records_requestcreate_json_body_data_medical_bills_item_payers_item import (
        MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItemPayersItem,
    )


T = TypeVar("T", bound="MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItem")


@_attrs_define
class MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItem:
    """
    Attributes:
        ...
        payers (Union[Unset, list['MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItemPayersItem']]):
    """
    ...
    payers: Union[Unset, list["MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItemPayersItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for payers_item_data in _payers or []:
            payers_item = MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItemPayersItem.from_dict(payers_item_data)

            payers.append(payers_item)

        medical_records_requestcreate_json_body_data_medical_bills_item = cls(
            adjustment=adjustment,
            amount=amount,
            balance=balance,
            mark_balance_as_lien=mark_balance_as_lien,
        ...
        medical_records_requestcreate_json_body_data_medical_bills_item.additional_properties = d
        return medical_records_requestcreate_json_body_data_medical_bills_item
