...
T = TypeVar("T", bound="ClioPaymentsPaymentBankTransaction")


@_attrs_define
class ClioPaymentsPaymentBankTransaction:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_payment_bank_transaction = cls(
            amount=amount,
        ...
        clio_payments_payment_bank_transaction.additional_properties = d
        return clio_payments_payment_bank_transaction
