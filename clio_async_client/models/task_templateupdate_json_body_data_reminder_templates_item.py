...
from ..models.task_templateupdate_json_body_data_reminder_templates_item_notification_type import (
    TaskTemplateupdateJsonBodyDataReminderTemplatesItemNotificationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="TaskTemplateupdateJsonBodyDataReminderTemplatesItem")


@_attrs_define
class TaskTemplateupdateJsonBodyDataReminderTemplatesItem:
    """
    Attributes:
        ...
        notification_type (Union[Unset, TaskTemplateupdateJsonBodyDataReminderTemplatesItemNotificationType]):
            Notification method.
    """
    ...
    notification_type: Union[Unset, TaskTemplateupdateJsonBodyDataReminderTemplatesItemNotificationType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_notification_type, Unset):
            ...
            notification_type = TaskTemplateupdateJsonBodyDataReminderTemplatesItemNotificationType(_notification_type)

        task_templateupdate_json_body_data_reminder_templates_item = cls(
        ...
        task_templateupdate_json_body_data_reminder_templates_item.additional_properties = d
        return task_templateupdate_json_body_data_reminder_templates_item
