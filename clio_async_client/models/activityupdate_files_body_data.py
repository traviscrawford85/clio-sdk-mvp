...
class ActivityupdateFilesBodyData:
    ...
    activity_description: Union[Unset, "ActivityupdateFilesBodyDataActivityDescription"] = UNSET
    ...
    tax_setting: Union[Unset, ActivityupdateFilesBodyDataTaxSetting] = UNSET
    text_message_conversation: Union[Unset, "ActivityupdateFilesBodyDataTextMessageConversation"] = UNSET
    type_: Union[Unset, ActivityupdateFilesBodyDataType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_activity_description, Unset):
            ...
            activity_description = ActivityupdateFilesBodyDataActivityDescription.from_dict(_activity_description)
        ...
        if isinstance(_calendar_entry, Unset):
            ...
            calendar_entry = ActivityupdateFilesBodyDataCalendarEntry.from_dict(_calendar_entry)
        ...
        if isinstance(_client_portal, Unset):
            ...
            client_portal = ActivityupdateFilesBodyDataClientPortal.from_dict(_client_portal)
        ...
        if isinstance(_communication, Unset):
            ...
            communication = ActivityupdateFilesBodyDataCommunication.from_dict(_communication)
        ...
        if isinstance(_contact_note, Unset):
            ...
            contact_note = ActivityupdateFilesBodyDataContactNote.from_dict(_contact_note)
        ...
        if isinstance(_expense_category, Unset):
            ...
            expense_category = ActivityupdateFilesBodyDataExpenseCategory.from_dict(_expense_category)
        ...
        tax_setting: Union[Unset, ActivityupdateFilesBodyDataTaxSetting]
        ...
        if isinstance(_text_message_conversation, Unset):
            ...
            text_message_conversation = ActivityupdateFilesBodyDataTextMessageConversation.from_dict(
                _text_message_conversation
            )

        _type_ = d.pop("type", UNSET)
        type_: Union[Unset, ActivityupdateFilesBodyDataType]
        ...
        if isinstance(_utbms_expense, Unset):
            ...
            utbms_expense = ActivityupdateFilesBodyDataUtbmsExpense.from_dict(_utbms_expense)
