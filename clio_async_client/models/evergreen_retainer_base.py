...
class EvergreenRetainerBase:
    """
    Attributes:
        created_at (Union[Unset, str]): The time the *EvergreenRetainer* was created (as a ISO-8601 timestamp)
        ...
        updated_at (Union[Unset, str]): The time the *EvergreenRetainer* was last updated (as a ISO-8601 timestamp)
    """
