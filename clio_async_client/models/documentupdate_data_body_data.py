...
class DocumentupdateDataBodyData:
    ...
    document_category: Union[Unset, "DocumentupdateDataBodyDataDocumentCategory"] = UNSET
    external_properties: Union[Unset, list["DocumentupdateDataBodyDataExternalPropertiesItem"]] = UNSET
    fully_uploaded: Union[Unset, bool] = UNSET
    multiparts: Union[Unset, list["DocumentupdateDataBodyDataMultipartsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document_category, Unset):
            ...
            document_category = DocumentupdateDataBodyDataDocumentCategory.from_dict(_document_category)

        external_properties = []
        _external_properties = d.pop("external_properties", UNSET)
        for external_properties_item_data in _external_properties or []:
            external_properties_item = DocumentupdateDataBodyDataExternalPropertiesItem.from_dict(
        ...
        for multiparts_item_data in _multiparts or []:
            multiparts_item = DocumentupdateDataBodyDataMultipartsItem.from_dict(multiparts_item_data)
