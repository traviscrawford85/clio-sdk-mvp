...
if TYPE_CHECKING:
    from ..models.noteupdate_data_body_data_notification_event_subscribers_item import (
        NoteupdateDataBodyDataNotificationEventSubscribersItem,
    )


T = TypeVar("T", bound="NoteupdateDataBodyData")


@_attrs_define
class NoteupdateDataBodyData:
    """
    Attributes:
        date (Union[Unset, str]): Date for the Note. (Expects an ISO-8601 date).
        detail (Union[Unset, str]): Note body.
        notification_event_subscribers (Union[Unset, list['NoteupdateDataBodyDataNotificationEventSubscribersItem']]):
        subject (Union[Unset, str]): Note subject.
    """

    date: Union[Unset, str] = UNSET
    detail: Union[Unset, str] = UNSET
    notification_event_subscribers: Union[Unset, list["NoteupdateDataBodyDataNotificationEventSubscribersItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for notification_event_subscribers_item_data in _notification_event_subscribers or []:
            notification_event_subscribers_item = NoteupdateDataBodyDataNotificationEventSubscribersItem.from_dict(
        ...
        noteupdate_data_body_data.additional_properties = d
        return noteupdate_data_body_data
