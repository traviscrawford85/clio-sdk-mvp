...
from ..models.report_schedulecreate_data_body_data_frequency import (
    ReportSchedulecreateDataBodyDataFrequency,
)
from ..models.report_schedulecreate_data_body_data_time_zone import (
    ReportSchedulecreateDataBodyDataTimeZone,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReportSchedulecreateDataBodyData")


@_attrs_define
class ReportSchedulecreateDataBodyData:
    """
    Attributes:
        frequency (ReportSchedulecreateDataBodyDataFrequency): How often to run the Report Schedule.
        ...
        time_of_day (str): What time the Report Schedule should run. Although the entire datetime is sent, only the time
            information is used.
        time_zone (ReportSchedulecreateDataBodyDataTimeZone): Used in conjunction with `time_of_day` to determine when
    ...
    frequency: ReportSchedulecreateDataBodyDataFrequency
    report_preset_id: int
    time_of_day: str
    time_zone: ReportSchedulecreateDataBodyDataTimeZone
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        frequency = ReportSchedulecreateDataBodyDataFrequency(d.pop("frequency"))

        report_preset_id = d.pop("report_preset_id")

        time_of_day = d.pop("time_of_day")

        time_zone = ReportSchedulecreateDataBodyDataTimeZone(d.pop("time_zone"))
        ...
        report_schedulecreate_data_body_data = cls(
            frequency=frequency,
            report_preset_id=report_preset_id,
            time_of_day=time_of_day,
            time_zone=time_zone,
        ...
        report_schedulecreate_data_body_data.additional_properties = d
        return report_schedulecreate_data_body_data
