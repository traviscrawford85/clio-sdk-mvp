...
class TaskTemplatecreateJsonBodyData:
    ...
    cascading_offset_polarity: Union[Unset, TaskTemplatecreateJsonBodyDataCascadingOffsetPolarity] = UNSET
    cascading_offset_type: Union[Unset, TaskTemplatecreateJsonBodyDataCascadingOffsetType] = UNSET
    cascading_source: Union[Unset, "TaskTemplatecreateJsonBodyDataCascadingSource"] = UNSET
    description: Union[Unset, str] = UNSET
    priority: Union[Unset, TaskTemplatecreateJsonBodyDataPriority] = TaskTemplatecreateJsonBodyDataPriority.NORMAL
    private: Union[Unset, bool] = UNSET
    reminder_templates: Union[Unset, list["TaskTemplatecreateJsonBodyDataReminderTemplatesItem"]] = UNSET
    task_template_list: Union[Unset, "TaskTemplatecreateJsonBodyDataTaskTemplateList"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cascading_offset_polarity: Union[Unset, TaskTemplatecreateJsonBodyDataCascadingOffsetPolarity]
        if isinstance(_cascading_offset_polarity, Unset):
            cascading_offset_polarity = UNSET
        else:
            cascading_offset_polarity = TaskTemplatecreateJsonBodyDataCascadingOffsetPolarity(
                _cascading_offset_polarity
            )

        _cascading_offset_type = d.pop("cascading_offset_type", UNSET)
        cascading_offset_type: Union[Unset, TaskTemplatecreateJsonBodyDataCascadingOffsetType]
        if isinstance(_cascading_offset_type, Unset):
            cascading_offset_type = UNSET
        else:
            cascading_offset_type = TaskTemplatecreateJsonBodyDataCascadingOffsetType(_cascading_offset_type)
        ...
        if isinstance(_cascading_source, Unset):
            ...
            cascading_source = TaskTemplatecreateJsonBodyDataCascadingSource.from_dict(_cascading_source)

        description = d.pop("description", UNSET)

        _priority = d.pop("priority", UNSET)
        priority: Union[Unset, TaskTemplatecreateJsonBodyDataPriority]
        ...
        for reminder_templates_item_data in _reminder_templates or []:
            reminder_templates_item = TaskTemplatecreateJsonBodyDataReminderTemplatesItem.from_dict(
        ...
        if isinstance(_task_template_list, Unset):
            ...
            task_template_list = TaskTemplatecreateJsonBodyDataTaskTemplateList.from_dict(_task_template_list)
