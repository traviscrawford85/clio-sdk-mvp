...
@_attrs_define
class CustomFieldSetcreateFilesBodyData:
    """
    Attributes:
        name (str): CustomFieldSet name.
        displayed (Union[Unset, bool]): Whether or not the CustomFieldSet should be displayed by default.
        parent_type (Union[Unset, CustomFieldSetcreateFilesBodyDataParentType]): Type of object the CustomFieldSet is
            for.
    """

    name: str
    displayed: Union[Unset, bool] = UNSET
    parent_type: Union[Unset, CustomFieldSetcreateFilesBodyDataParentType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parent_type: Union[Unset, CustomFieldSetcreateFilesBodyDataParentType]
        if isinstance(_parent_type, Unset):
            parent_type = UNSET
        else:
            parent_type = CustomFieldSetcreateFilesBodyDataParentType(_parent_type)

        custom_field_setcreate_files_body_data = cls(
            name=name,
            displayed=displayed,
            parent_type=parent_type,
        )

        custom_field_setcreate_files_body_data.additional_properties = d
        return custom_field_setcreate_files_body_data
