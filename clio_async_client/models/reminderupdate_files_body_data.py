...
class ReminderupdateFilesBodyData:
    ...
    duration_unit: Union[Unset, ReminderupdateFilesBodyDataDurationUnit] = UNSET
    duration_value: Union[Unset, int] = UNSET
    notification_method: Union[Unset, "ReminderupdateFilesBodyDataNotificationMethod"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duration_unit: Union[Unset, ReminderupdateFilesBodyDataDurationUnit]
        ...
        if isinstance(_notification_method, Unset):
            ...
            notification_method = ReminderupdateFilesBodyDataNotificationMethod.from_dict(_notification_method)
