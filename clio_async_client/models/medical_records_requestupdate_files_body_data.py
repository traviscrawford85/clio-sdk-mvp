...
from ..models.medical_records_requestupdate_files_body_data_bills_status import (
    MedicalRecordsRequestupdateFilesBodyDataBillsStatus,
)
from ..models.medical_records_requestupdate_files_body_data_records_status import (
    MedicalRecordsRequestupdateFilesBodyDataRecordsStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.medical_records_requestupdate_files_body_data_medical_bills_item import (
        MedicalRecordsRequestupdateFilesBodyDataMedicalBillsItem,
    )
    from ..models.medical_records_requestupdate_files_body_data_medical_records_item import (
        MedicalRecordsRequestupdateFilesBodyDataMedicalRecordsItem,
    )


T = TypeVar("T", bound="MedicalRecordsRequestupdateFilesBodyData")


@_attrs_define
class MedicalRecordsRequestupdateFilesBodyData:
    """
    Attributes:
        ...
        bills_status (Union[Unset, MedicalRecordsRequestupdateFilesBodyDataBillsStatus]): Current status for the Medical
            Bills.
        ...
        medical_bills (Union[Unset, list['MedicalRecordsRequestupdateFilesBodyDataMedicalBillsItem']]):
        ...
        medical_records (Union[Unset, list['MedicalRecordsRequestupdateFilesBodyDataMedicalRecordsItem']]):
        ...
        records_status (Union[Unset, MedicalRecordsRequestupdateFilesBodyDataRecordsStatus]): Current status for the
            Medical Records.
    ...
    bills_status: Union[Unset, MedicalRecordsRequestupdateFilesBodyDataBillsStatus] = UNSET
    description: Union[Unset, str] = UNSET
    in_treatment: Union[Unset, bool] = UNSET
    medical_bills: Union[Unset, list["MedicalRecordsRequestupdateFilesBodyDataMedicalBillsItem"]] = UNSET
    medical_provider_id: Union[Unset, int] = UNSET
    medical_records: Union[Unset, list["MedicalRecordsRequestupdateFilesBodyDataMedicalRecordsItem"]] = UNSET
    records_follow_up_date: Union[Unset, str] = UNSET
    records_request_date: Union[Unset, str] = UNSET
    records_status: Union[Unset, MedicalRecordsRequestupdateFilesBodyDataRecordsStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bills_status: Union[Unset, MedicalRecordsRequestupdateFilesBodyDataBillsStatus]
        if isinstance(_bills_status, Unset):
            bills_status = UNSET
        else:
            bills_status = MedicalRecordsRequestupdateFilesBodyDataBillsStatus(_bills_status)
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = MedicalRecordsRequestupdateFilesBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = MedicalRecordsRequestupdateFilesBodyDataMedicalRecordsItem.from_dict(
        ...
        records_status: Union[Unset, MedicalRecordsRequestupdateFilesBodyDataRecordsStatus]
        if isinstance(_records_status, Unset):
            records_status = UNSET
        else:
            records_status = MedicalRecordsRequestupdateFilesBodyDataRecordsStatus(_records_status)

        treatment_end_date = d.pop("treatment_end_date", UNSET)

        treatment_start_date = d.pop("treatment_start_date", UNSET)

        medical_records_requestupdate_files_body_data = cls(
        ...
        medical_records_requestupdate_files_body_data.additional_properties = d
        return medical_records_requestupdate_files_body_data
