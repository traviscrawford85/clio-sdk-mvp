...
from ..models.documentcopy_json_body_data_parent_type import (
    DocumentcopyJsonBodyDataParentType,
)

T = TypeVar("T", bound="DocumentcopyJsonBodyDataParent")


@_attrs_define
class DocumentcopyJsonBodyDataParent:
    """
    Attributes:
        id (int): The unique identifier of the parent object.
        type_ (DocumentcopyJsonBodyDataParentType): Type of parent object:
    ...
    id: int
    type_: DocumentcopyJsonBodyDataParentType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DocumentcopyJsonBodyDataParentType(d.pop("type"))

        documentcopy_json_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        documentcopy_json_body_data_parent.additional_properties = d
        return documentcopy_json_body_data_parent
