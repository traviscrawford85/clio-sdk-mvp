...
class ReportScheduleupdateDataBodyData:
    ...
    frequency: Union[Unset, ReportScheduleupdateDataBodyDataFrequency] = UNSET
    report_preset_id: Union[Unset, int] = UNSET
    time_of_day: Union[Unset, str] = UNSET
    time_zone: Union[Unset, ReportScheduleupdateDataBodyDataTimeZone] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        frequency: Union[Unset, ReportScheduleupdateDataBodyDataFrequency]
        ...
        time_zone: Union[Unset, ReportScheduleupdateDataBodyDataTimeZone]
