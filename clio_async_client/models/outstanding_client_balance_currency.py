...
T = TypeVar("T", bound="OutstandingClientBalanceCurrency")


@_attrs_define
class OutstandingClientBalanceCurrency:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        outstanding_client_balance_currency = cls(
            code=code,
        ...
        outstanding_client_balance_currency.additional_properties = d
        return outstanding_client_balance_currency
