...
@_attrs_define
class MedicalRecordsRequestupdateDataBodyDataMedicalBillsItem:
    """
    Attributes:
        ...
        payers (Union[Unset, list['MedicalRecordsRequestupdateDataBodyDataMedicalBillsItemPayersItem']]):
    """
    ...
    payers: Union[Unset, list["MedicalRecordsRequestupdateDataBodyDataMedicalBillsItemPayersItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for payers_item_data in _payers or []:
            payers_item = MedicalRecordsRequestupdateDataBodyDataMedicalBillsItemPayersItem.from_dict(payers_item_data)

            payers.append(payers_item)

        medical_records_requestupdate_data_body_data_medical_bills_item = cls(
        ...
        medical_records_requestupdate_data_body_data_medical_bills_item.additional_properties = d
        return medical_records_requestupdate_data_body_data_medical_bills_item
