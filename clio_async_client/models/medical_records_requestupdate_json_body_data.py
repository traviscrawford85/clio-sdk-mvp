...
from ..models.medical_records_requestupdate_json_body_data_bills_status import (
    MedicalRecordsRequestupdateJsonBodyDataBillsStatus,
)
from ..models.medical_records_requestupdate_json_body_data_records_status import (
    MedicalRecordsRequestupdateJsonBodyDataRecordsStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.medical_records_requestupdate_json_body_data_medical_bills_item import (
        MedicalRecordsRequestupdateJsonBodyDataMedicalBillsItem,
    )
    from ..models.medical_records_requestupdate_json_body_data_medical_records_item import (
        MedicalRecordsRequestupdateJsonBodyDataMedicalRecordsItem,
    )


T = TypeVar("T", bound="MedicalRecordsRequestupdateJsonBodyData")


@_attrs_define
class MedicalRecordsRequestupdateJsonBodyData:
    """
    Attributes:
        ...
        bills_status (Union[Unset, MedicalRecordsRequestupdateJsonBodyDataBillsStatus]): Current status for the Medical
            Bills.
        ...
        medical_bills (Union[Unset, list['MedicalRecordsRequestupdateJsonBodyDataMedicalBillsItem']]):
        ...
        medical_records (Union[Unset, list['MedicalRecordsRequestupdateJsonBodyDataMedicalRecordsItem']]):
        ...
        records_status (Union[Unset, MedicalRecordsRequestupdateJsonBodyDataRecordsStatus]): Current status for the
            Medical Records.
    ...
    bills_status: Union[Unset, MedicalRecordsRequestupdateJsonBodyDataBillsStatus] = UNSET
    description: Union[Unset, str] = UNSET
    in_treatment: Union[Unset, bool] = UNSET
    medical_bills: Union[Unset, list["MedicalRecordsRequestupdateJsonBodyDataMedicalBillsItem"]] = UNSET
    medical_provider_id: Union[Unset, int] = UNSET
    medical_records: Union[Unset, list["MedicalRecordsRequestupdateJsonBodyDataMedicalRecordsItem"]] = UNSET
    records_follow_up_date: Union[Unset, str] = UNSET
    records_request_date: Union[Unset, str] = UNSET
    records_status: Union[Unset, MedicalRecordsRequestupdateJsonBodyDataRecordsStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bills_status: Union[Unset, MedicalRecordsRequestupdateJsonBodyDataBillsStatus]
        if isinstance(_bills_status, Unset):
            bills_status = UNSET
        else:
            bills_status = MedicalRecordsRequestupdateJsonBodyDataBillsStatus(_bills_status)
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = MedicalRecordsRequestupdateJsonBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = MedicalRecordsRequestupdateJsonBodyDataMedicalRecordsItem.from_dict(
        ...
        records_status: Union[Unset, MedicalRecordsRequestupdateJsonBodyDataRecordsStatus]
        if isinstance(_records_status, Unset):
            records_status = UNSET
        else:
            records_status = MedicalRecordsRequestupdateJsonBodyDataRecordsStatus(_records_status)

        treatment_end_date = d.pop("treatment_end_date", UNSET)

        treatment_start_date = d.pop("treatment_start_date", UNSET)

        medical_records_requestupdate_json_body_data = cls(
        ...
        medical_records_requestupdate_json_body_data.additional_properties = d
        return medical_records_requestupdate_json_body_data
