...
from ..models.contactupdate_json_body_data_phone_numbers_item_name import (
    ContactupdateJsonBodyDataPhoneNumbersItemName,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactupdateJsonBodyDataPhoneNumbersItem")


@_attrs_define
class ContactupdateJsonBodyDataPhoneNumbersItem:
    """
    Attributes:
        ...
        name (Union[Unset, ContactupdateJsonBodyDataPhoneNumbersItemName]): Name of the PhoneNumber. Default:
            ContactupdateJsonBodyDataPhoneNumbersItemName.OTHER.
    ...
    name: Union[Unset, ContactupdateJsonBodyDataPhoneNumbersItemName] = (
        ContactupdateJsonBodyDataPhoneNumbersItemName.OTHER
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = ContactupdateJsonBodyDataPhoneNumbersItemName(_name)

        number = d.pop("number", UNSET)

        contactupdate_json_body_data_phone_numbers_item = cls(
        ...
        contactupdate_json_body_data_phone_numbers_item.additional_properties = d
        return contactupdate_json_body_data_phone_numbers_item
