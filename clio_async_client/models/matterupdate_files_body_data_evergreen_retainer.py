...
if TYPE_CHECKING:
    from ..models.matterupdate_files_body_data_evergreen_retainer_recipients_item import (
        MatterupdateFilesBodyDataEvergreenRetainerRecipientsItem,
    )


T = TypeVar("T", bound="MatterupdateFilesBodyDataEvergreenRetainer")


@_attrs_define
class MatterupdateFilesBodyDataEvergreenRetainer:
    """
    Attributes:
        ...
        recipients (Union[Unset, list['MatterupdateFilesBodyDataEvergreenRetainerRecipientsItem']]):
    """

    field_destroy: Union[Unset, bool] = UNSET
    minimum_threshold: Union[Unset, float] = UNSET
    recipients: Union[Unset, list["MatterupdateFilesBodyDataEvergreenRetainerRecipientsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for recipients_item_data in _recipients or []:
            recipients_item = MatterupdateFilesBodyDataEvergreenRetainerRecipientsItem.from_dict(recipients_item_data)

            recipients.append(recipients_item)

        matterupdate_files_body_data_evergreen_retainer = cls(
            field_destroy=field_destroy,
            minimum_threshold=minimum_threshold,
            recipients=recipients,
        )

        matterupdate_files_body_data_evergreen_retainer.additional_properties = d
        return matterupdate_files_body_data_evergreen_retainer
