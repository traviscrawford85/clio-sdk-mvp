...
T = TypeVar("T", bound="InterestChargeBill")


@_attrs_define
class InterestChargeBill:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        interest_charge_bill.additional_properties = d
        return interest_charge_bill
