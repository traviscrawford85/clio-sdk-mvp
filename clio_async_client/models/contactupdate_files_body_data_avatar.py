...
T = TypeVar("T", bound="ContactupdateFilesBodyDataAvatar")


@_attrs_define
class ContactupdateFilesBodyDataAvatar:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contactupdate_files_body_data_avatar = cls(
            field_destroy=field_destroy,
            image=image,
        )

        contactupdate_files_body_data_avatar.additional_properties = d
        return contactupdate_files_body_data_avatar
