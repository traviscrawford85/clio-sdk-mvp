...
T = TypeVar("T", bound="ActivitycreateDataBodyDataActivityDescription")


@_attrs_define
class ActivitycreateDataBodyDataActivityDescription:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activitycreate_data_body_data_activity_description = cls(
            id=id,
            utbms_activity_id=utbms_activity_id,
            utbms_task_id=utbms_task_id,
        )

        activitycreate_data_body_data_activity_description.additional_properties = d
        return activitycreate_data_body_data_activity_description
