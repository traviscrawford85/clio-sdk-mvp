...
from ..models.task_templateupdate_json_body_data_cascading_offset_polarity import (
    TaskTemplateupdateJsonBodyDataCascadingOffsetPolarity,
)
from ..models.task_templateupdate_json_body_data_cascading_offset_type import (
    TaskTemplateupdateJsonBodyDataCascadingOffsetType,
)
from ..models.task_templateupdate_json_body_data_priority import (
    TaskTemplateupdateJsonBodyDataPriority,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.task_templateupdate_json_body_data_cascading_source import (
        TaskTemplateupdateJsonBodyDataCascadingSource,
    )
    from ..models.task_templateupdate_json_body_data_reminder_templates_item import (
        TaskTemplateupdateJsonBodyDataReminderTemplatesItem,
    )


T = TypeVar("T", bound="TaskTemplateupdateJsonBodyData")


@_attrs_define
class TaskTemplateupdateJsonBodyData:
    """
    Attributes:
        ...
        cascading_offset (Union[Unset, int]): The amount of time that will differentiate the cascaded TaskTemplate from
            its parent.
        cascading_offset_polarity (Union[Unset, TaskTemplateupdateJsonBodyDataCascadingOffsetPolarity]): Determines
            whether or not the cascading_offset occurs before or after its parent.
        cascading_offset_type (Union[Unset, TaskTemplateupdateJsonBodyDataCascadingOffsetType]): Determines the quantity
            of the cascading offset (e.g. CalendarDays, CalendarWeeks etc.)
        cascading_source (Union[Unset, TaskTemplateupdateJsonBodyDataCascadingSource]):
        description (Union[Unset, str]): Longer description for the TaskTemplate.
        name (Union[Unset, str]): Short name for the TaskTemplate.
        priority (Union[Unset, TaskTemplateupdateJsonBodyDataPriority]): Priority of the task. Default:
            TaskTemplateupdateJsonBodyDataPriority.NORMAL.
        private (Union[Unset, bool]): Whether or not this TaskTemplate should be private.
        reminder_templates (Union[Unset, list['TaskTemplateupdateJsonBodyDataReminderTemplatesItem']]):
    """

    cascading: Union[Unset, bool] = UNSET
    cascading_offset: Union[Unset, int] = UNSET
    cascading_offset_polarity: Union[Unset, TaskTemplateupdateJsonBodyDataCascadingOffsetPolarity] = UNSET
    cascading_offset_type: Union[Unset, TaskTemplateupdateJsonBodyDataCascadingOffsetType] = UNSET
    cascading_source: Union[Unset, "TaskTemplateupdateJsonBodyDataCascadingSource"] = UNSET
    description: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    priority: Union[Unset, TaskTemplateupdateJsonBodyDataPriority] = TaskTemplateupdateJsonBodyDataPriority.NORMAL
    private: Union[Unset, bool] = UNSET
    reminder_templates: Union[Unset, list["TaskTemplateupdateJsonBodyDataReminderTemplatesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cascading_offset_polarity: Union[Unset, TaskTemplateupdateJsonBodyDataCascadingOffsetPolarity]
        if isinstance(_cascading_offset_polarity, Unset):
            cascading_offset_polarity = UNSET
        else:
            cascading_offset_polarity = TaskTemplateupdateJsonBodyDataCascadingOffsetPolarity(
                _cascading_offset_polarity
            )

        _cascading_offset_type = d.pop("cascading_offset_type", UNSET)
        cascading_offset_type: Union[Unset, TaskTemplateupdateJsonBodyDataCascadingOffsetType]
        if isinstance(_cascading_offset_type, Unset):
            cascading_offset_type = UNSET
        else:
            cascading_offset_type = TaskTemplateupdateJsonBodyDataCascadingOffsetType(_cascading_offset_type)
        ...
        if isinstance(_cascading_source, Unset):
            ...
            cascading_source = TaskTemplateupdateJsonBodyDataCascadingSource.from_dict(_cascading_source)
        ...
        priority: Union[Unset, TaskTemplateupdateJsonBodyDataPriority]
        if isinstance(_priority, Unset):
            priority = UNSET
        else:
            priority = TaskTemplateupdateJsonBodyDataPriority(_priority)
        ...
        for reminder_templates_item_data in _reminder_templates or []:
            reminder_templates_item = TaskTemplateupdateJsonBodyDataReminderTemplatesItem.from_dict(
                reminder_templates_item_data
            )

            reminder_templates.append(reminder_templates_item)

        task_templateupdate_json_body_data = cls(
            cascading=cascading,
        ...
        task_templateupdate_json_body_data.additional_properties = d
        return task_templateupdate_json_body_data
