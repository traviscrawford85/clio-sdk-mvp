...
T = TypeVar("T", bound="MatterupdateJsonBodyDataSplitInvoicePayersItem")


@_attrs_define
class MatterupdateJsonBodyDataSplitInvoicePayersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matterupdate_json_body_data_split_invoice_payers_item = cls(
        ...
        matterupdate_json_body_data_split_invoice_payers_item.additional_properties = d
        return matterupdate_json_body_data_split_invoice_payers_item
