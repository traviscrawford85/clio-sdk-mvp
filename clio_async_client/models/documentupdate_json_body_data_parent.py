...
@_attrs_define
class DocumentupdateJsonBodyDataParent:
    """
    Attributes:
        id (Union[Unset, int]): The unique identifier of the parent object.
        type_ (Union[Unset, DocumentupdateJsonBodyDataParentType]): Type of parent object:
    ...
    type_: Union[Unset, DocumentupdateJsonBodyDataParentType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, DocumentupdateJsonBodyDataParentType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = DocumentupdateJsonBodyDataParentType(_type_)

        documentupdate_json_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        documentupdate_json_body_data_parent.additional_properties = d
        return documentupdate_json_body_data_parent
