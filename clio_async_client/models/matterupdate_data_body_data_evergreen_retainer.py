...
if TYPE_CHECKING:
    from ..models.matterupdate_data_body_data_evergreen_retainer_recipients_item import (
        MatterupdateDataBodyDataEvergreenRetainerRecipientsItem,
    )


T = TypeVar("T", bound="MatterupdateDataBodyDataEvergreenRetainer")


@_attrs_define
class MatterupdateDataBodyDataEvergreenRetainer:
    """
    Attributes:
        ...
        recipients (Union[Unset, list['MatterupdateDataBodyDataEvergreenRetainerRecipientsItem']]):
    """

    field_destroy: Union[Unset, bool] = UNSET
    minimum_threshold: Union[Unset, float] = UNSET
    recipients: Union[Unset, list["MatterupdateDataBodyDataEvergreenRetainerRecipientsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for recipients_item_data in _recipients or []:
            recipients_item = MatterupdateDataBodyDataEvergreenRetainerRecipientsItem.from_dict(recipients_item_data)

            recipients.append(recipients_item)

        matterupdate_data_body_data_evergreen_retainer = cls(
            field_destroy=field_destroy,
            minimum_threshold=minimum_threshold,
            recipients=recipients,
        )

        matterupdate_data_body_data_evergreen_retainer.additional_properties = d
        return matterupdate_data_body_data_evergreen_retainer
