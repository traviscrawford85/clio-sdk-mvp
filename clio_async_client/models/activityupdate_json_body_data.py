...
class ActivityupdateJsonBodyData:
    ...
    activity_description: Union[Unset, "ActivityupdateJsonBodyDataActivityDescription"] = UNSET
    ...
    tax_setting: Union[Unset, ActivityupdateJsonBodyDataTaxSetting] = UNSET
    text_message_conversation: Union[Unset, "ActivityupdateJsonBodyDataTextMessageConversation"] = UNSET
    type_: Union[Unset, ActivityupdateJsonBodyDataType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_activity_description, Unset):
            ...
            activity_description = ActivityupdateJsonBodyDataActivityDescription.from_dict(_activity_description)
        ...
        if isinstance(_calendar_entry, Unset):
            ...
            calendar_entry = ActivityupdateJsonBodyDataCalendarEntry.from_dict(_calendar_entry)
        ...
        if isinstance(_client_portal, Unset):
            ...
            client_portal = ActivityupdateJsonBodyDataClientPortal.from_dict(_client_portal)
        ...
        if isinstance(_communication, Unset):
            ...
            communication = ActivityupdateJsonBodyDataCommunication.from_dict(_communication)
        ...
        if isinstance(_contact_note, Unset):
            ...
            contact_note = ActivityupdateJsonBodyDataContactNote.from_dict(_contact_note)
        ...
        if isinstance(_expense_category, Unset):
            ...
            expense_category = ActivityupdateJsonBodyDataExpenseCategory.from_dict(_expense_category)
        ...
        tax_setting: Union[Unset, ActivityupdateJsonBodyDataTaxSetting]
        ...
        if isinstance(_text_message_conversation, Unset):
            ...
            text_message_conversation = ActivityupdateJsonBodyDataTextMessageConversation.from_dict(
                _text_message_conversation
            )

        _type_ = d.pop("type", UNSET)
        type_: Union[Unset, ActivityupdateJsonBodyDataType]
        ...
        if isinstance(_utbms_expense, Unset):
            ...
            utbms_expense = ActivityupdateJsonBodyDataUtbmsExpense.from_dict(_utbms_expense)
