...
T = TypeVar("T", bound="RelationshipMatter")


@_attrs_define
class RelationshipMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        relationship_matter.additional_properties = d
        return relationship_matter
