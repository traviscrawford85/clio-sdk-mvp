...
class ExpenseCategoryupdateDataBodyData:
    ...
    entry_type: Union[Unset, ExpenseCategoryupdateDataBodyDataEntryType] = UNSET
    groups: Union[Unset, list["ExpenseCategoryupdateDataBodyDataGroupsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entry_type: Union[Unset, ExpenseCategoryupdateDataBodyDataEntryType]
        ...
        for groups_item_data in _groups or []:
            groups_item = ExpenseCategoryupdateDataBodyDataGroupsItem.from_dict(groups_item_data)
        ...
        if isinstance(_utbms_code, Unset):
            ...
            utbms_code = ExpenseCategoryupdateDataBodyDataUtbmsCode.from_dict(_utbms_code)
