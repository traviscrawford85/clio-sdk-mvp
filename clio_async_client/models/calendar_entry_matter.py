...
T = TypeVar("T", bound="CalendarEntryMatter")


@_attrs_define
class CalendarEntryMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calendar_entry_matter.additional_properties = d
        return calendar_entry_matter
