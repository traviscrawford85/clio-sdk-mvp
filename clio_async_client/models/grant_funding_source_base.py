...
T = TypeVar("T", bound="GrantFundingSourceBase")


@_attrs_define
class GrantFundingSourceBase:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grant_funding_source_base.additional_properties = d
        return grant_funding_source_base
