...
class TaskcreateJsonBodyData:
    ...
    cascading_offset_polarity: Union[Unset, TaskcreateJsonBodyDataCascadingOffsetPolarity] = UNSET
    cascading_offset_type: Union[Unset, TaskcreateJsonBodyDataCascadingOffsetType] = UNSET
    ...
    permission: Union[Unset, TaskcreateJsonBodyDataPermission] = TaskcreateJsonBodyDataPermission.PUBLIC
    priority: Union[Unset, TaskcreateJsonBodyDataPriority] = TaskcreateJsonBodyDataPriority.NORMAL
    status: Union[Unset, TaskcreateJsonBodyDataStatus] = TaskcreateJsonBodyDataStatus.PENDING
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cascading_offset_polarity: Union[Unset, TaskcreateJsonBodyDataCascadingOffsetPolarity]
        if isinstance(_cascading_offset_polarity, Unset):
            cascading_offset_polarity = UNSET
        else:
            cascading_offset_polarity = TaskcreateJsonBodyDataCascadingOffsetPolarity(_cascading_offset_polarity)

        _cascading_offset_type = d.pop("cascading_offset_type", UNSET)
        cascading_offset_type: Union[Unset, TaskcreateJsonBodyDataCascadingOffsetType]
        if isinstance(_cascading_offset_type, Unset):
            cascading_offset_type = UNSET
        else:
            cascading_offset_type = TaskcreateJsonBodyDataCascadingOffsetType(_cascading_offset_type)
        ...
        permission: Union[Unset, TaskcreateJsonBodyDataPermission]
        ...
        priority: Union[Unset, TaskcreateJsonBodyDataPriority]
        ...
        status: Union[Unset, TaskcreateJsonBodyDataStatus]
