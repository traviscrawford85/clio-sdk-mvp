...
@_attrs_define
class DamageupdateDataBodyData:
    """
    Attributes:
        amount (Union[Unset, float]): Amount
        damage_type (Union[Unset, DamageupdateDataBodyDataDamageType]): Damage type
        description (Union[Unset, str]): Description
    """

    amount: Union[Unset, float] = UNSET
    damage_type: Union[Unset, DamageupdateDataBodyDataDamageType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        damage_type: Union[Unset, DamageupdateDataBodyDataDamageType]
        if isinstance(_damage_type, Unset):
            damage_type = UNSET
        else:
            damage_type = DamageupdateDataBodyDataDamageType(_damage_type)

        description = d.pop("description", UNSET)

        damageupdate_data_body_data = cls(
            amount=amount,
            damage_type=damage_type,
            description=description,
        )

        damageupdate_data_body_data.additional_properties = d
        return damageupdate_data_body_data
