...
if TYPE_CHECKING:
    from ..models.medical_billupdate_json_body_data_payers_item import (
        MedicalBillupdateJsonBodyDataPayersItem,
    )


T = TypeVar("T", bound="MedicalBillupdateJsonBodyData")


@_attrs_define
class MedicalBillupdateJsonBodyData:
    """
    Attributes:
        ...
        payers (Union[Unset, list['MedicalBillupdateJsonBodyDataPayersItem']]):
    """
    ...
    payers: Union[Unset, list["MedicalBillupdateJsonBodyDataPayersItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for payers_item_data in _payers or []:
            payers_item = MedicalBillupdateJsonBodyDataPayersItem.from_dict(payers_item_data)

            payers.append(payers_item)

        medical_billupdate_json_body_data = cls(
        ...
        medical_billupdate_json_body_data.additional_properties = d
        return medical_billupdate_json_body_data
