...
from ..models.communicationcreate_data_body_data_type import (
    CommunicationcreateDataBodyDataType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.communicationcreate_data_body_data_external_properties_item import (
        CommunicationcreateDataBodyDataExternalPropertiesItem,
    )
    from ..models.communicationcreate_data_body_data_matter import (
        CommunicationcreateDataBodyDataMatter,
    )
    from ..models.communicationcreate_data_body_data_notification_event_subscribers_item import (
        CommunicationcreateDataBodyDataNotificationEventSubscribersItem,
    )
    from ..models.communicationcreate_data_body_data_receivers_item import (
        CommunicationcreateDataBodyDataReceiversItem,
    )
    from ..models.communicationcreate_data_body_data_senders_item import (
        CommunicationcreateDataBodyDataSendersItem,
    )


T = TypeVar("T", bound="CommunicationcreateDataBodyData")


@_attrs_define
class CommunicationcreateDataBodyData:
    """
    Attributes:
        body (str): The body value.
        subject (str): The subject value.
        type_ (CommunicationcreateDataBodyDataType): Type of the Communication.
        date (Union[Unset, str]): The date for the Communication. (Expects an ISO-8601 date.)
        external_properties (Union[Unset, list['CommunicationcreateDataBodyDataExternalPropertiesItem']]):
        matter (Union[Unset, CommunicationcreateDataBodyDataMatter]):
        notification_event_subscribers (Union[Unset,
            list['CommunicationcreateDataBodyDataNotificationEventSubscribersItem']]):
        received_at (Union[Unset, str]): The date-time for the Communication. (Expects an ISO-8601 date-time.)
        receivers (Union[Unset, list['CommunicationcreateDataBodyDataReceiversItem']]):
        senders (Union[Unset, list['CommunicationcreateDataBodyDataSendersItem']]):
    """

    body: str
    subject: str
    type_: CommunicationcreateDataBodyDataType
    date: Union[Unset, str] = UNSET
    external_properties: Union[Unset, list["CommunicationcreateDataBodyDataExternalPropertiesItem"]] = UNSET
    matter: Union[Unset, "CommunicationcreateDataBodyDataMatter"] = UNSET
    notification_event_subscribers: Union[
        Unset, list["CommunicationcreateDataBodyDataNotificationEventSubscribersItem"]
    ] = UNSET
    received_at: Union[Unset, str] = UNSET
    receivers: Union[Unset, list["CommunicationcreateDataBodyDataReceiversItem"]] = UNSET
    senders: Union[Unset, list["CommunicationcreateDataBodyDataSendersItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CommunicationcreateDataBodyDataType(d.pop("type"))
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = CommunicationcreateDataBodyDataExternalPropertiesItem.from_dict(
        ...
        if isinstance(_matter, Unset):
            ...
            matter = CommunicationcreateDataBodyDataMatter.from_dict(_matter)
        ...
        for notification_event_subscribers_item_data in _notification_event_subscribers or []:
            notification_event_subscribers_item = (
                CommunicationcreateDataBodyDataNotificationEventSubscribersItem.from_dict(
        ...
        for receivers_item_data in _receivers or []:
            receivers_item = CommunicationcreateDataBodyDataReceiversItem.from_dict(receivers_item_data)
        ...
        for senders_item_data in _senders or []:
            senders_item = CommunicationcreateDataBodyDataSendersItem.from_dict(senders_item_data)

            senders.append(senders_item)

        communicationcreate_data_body_data = cls(
            body=body,
            subject=subject,
            type_=type_,
            date=date,
        ...
        communicationcreate_data_body_data.additional_properties = d
        return communicationcreate_data_body_data
