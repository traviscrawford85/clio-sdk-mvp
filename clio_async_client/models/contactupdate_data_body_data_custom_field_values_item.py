...
class ContactupdateDataBodyDataCustomFieldValuesItem:
    ...
    custom_field: Union[Unset, "ContactupdateDataBodyDataCustomFieldValuesItemCustomField"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_field, Unset):
            ...
            custom_field = ContactupdateDataBodyDataCustomFieldValuesItemCustomField.from_dict(_custom_field)
