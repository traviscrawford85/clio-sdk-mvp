...
from ..models.report_scheduleupdate_json_body_data_frequency import (
    ReportScheduleupdateJsonBodyDataFrequency,
)
from ..models.report_scheduleupdate_json_body_data_time_zone import (
    ReportScheduleupdateJsonBodyDataTimeZone,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReportScheduleupdateJsonBodyData")


@_attrs_define
class ReportScheduleupdateJsonBodyData:
    """
    Attributes:
        ...
        every_no_of_months (Union[Unset, int]): If the frequency is monthly, how many months between each run of the
            Report Schedule.
        frequency (Union[Unset, ReportScheduleupdateJsonBodyDataFrequency]): How often to run the Report Schedule.
        ...
        time_zone (Union[Unset, ReportScheduleupdateJsonBodyDataTimeZone]): Used in conjunction with `time_of_day` to
    ...
    frequency: Union[Unset, ReportScheduleupdateJsonBodyDataFrequency] = UNSET
    report_preset_id: Union[Unset, int] = UNSET
    time_of_day: Union[Unset, str] = UNSET
    time_zone: Union[Unset, ReportScheduleupdateJsonBodyDataTimeZone] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        frequency: Union[Unset, ReportScheduleupdateJsonBodyDataFrequency]
        if isinstance(_frequency, Unset):
            frequency = UNSET
        else:
            frequency = ReportScheduleupdateJsonBodyDataFrequency(_frequency)
        ...
        time_zone: Union[Unset, ReportScheduleupdateJsonBodyDataTimeZone]
        if isinstance(_time_zone, Unset):
            time_zone = UNSET
        else:
            time_zone = ReportScheduleupdateJsonBodyDataTimeZone(_time_zone)

        report_scheduleupdate_json_body_data = cls(
        ...
        report_scheduleupdate_json_body_data.additional_properties = d
        return report_scheduleupdate_json_body_data
