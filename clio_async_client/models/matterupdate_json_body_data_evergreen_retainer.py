...
class MatterupdateJsonBodyDataEvergreenRetainer:
    ...
    recipients: Union[Unset, list["MatterupdateJsonBodyDataEvergreenRetainerRecipientsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for recipients_item_data in _recipients or []:
            recipients_item = MatterupdateJsonBodyDataEvergreenRetainerRecipientsItem.from_dict(recipients_item_data)
