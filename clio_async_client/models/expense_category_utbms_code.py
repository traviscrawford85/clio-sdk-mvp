...
T = TypeVar("T", bound="ExpenseCategoryUtbmsCode")


@_attrs_define
class ExpenseCategoryUtbmsCode:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        expense_category_utbms_code = cls(
            code=code,
        ...
        expense_category_utbms_code.additional_properties = d
        return expense_category_utbms_code
