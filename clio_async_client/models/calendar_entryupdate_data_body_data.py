...
class CalendarEntryupdateDataBodyData:
    ...
    field_deleted: Union[Unset, CalendarEntryupdateDataBodyDataDeleted] = UNSET
    all_day: Union[Unset, bool] = UNSET
    attendees: Union[Unset, list["CalendarEntryupdateDataBodyDataAttendeesItem"]] = UNSET
    calendar_entry_event_type: Union[Unset, "CalendarEntryupdateDataBodyDataCalendarEntryEventType"] = UNSET
    calendar_owner: Union[Unset, "CalendarEntryupdateDataBodyDataCalendarOwner"] = UNSET
    conference_meeting: Union[Unset, "CalendarEntryupdateDataBodyDataConferenceMeeting"] = UNSET
    description: Union[Unset, str] = UNSET
    end_at: Union[Unset, str] = UNSET
    external_properties: Union[Unset, list["CalendarEntryupdateDataBodyDataExternalPropertiesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_deleted: Union[Unset, CalendarEntryupdateDataBodyDataDeleted]
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntryupdateDataBodyDataAttendeesItem.from_dict(attendees_item_data)
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = CalendarEntryupdateDataBodyDataCalendarEntryEventType.from_dict(
        ...
        if isinstance(_calendar_owner, Unset):
            ...
            calendar_owner = CalendarEntryupdateDataBodyDataCalendarOwner.from_dict(_calendar_owner)
        ...
        if isinstance(_conference_meeting, Unset):
            ...
            conference_meeting = CalendarEntryupdateDataBodyDataConferenceMeeting.from_dict(_conference_meeting)
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = CalendarEntryupdateDataBodyDataExternalPropertiesItem.from_dict(
