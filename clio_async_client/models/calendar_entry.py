...
class CalendarEntry:
    ...
    calendar_entry_event_type: Union[Unset, "CalendarEntryCalendarEntryEventType"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = CalendarEntryCalendarEntryEventType.from_dict(_calendar_entry_event_type)
        ...
        if isinstance(_conference_meeting, Unset):
            ...
            conference_meeting = CalendarEntryConferenceMeeting.from_dict(_conference_meeting)
        ...
        if isinstance(_parent_calendar_entry, Unset):
            ...
            parent_calendar_entry = CalendarEntryParentCalendarEntry.from_dict(_parent_calendar_entry)
