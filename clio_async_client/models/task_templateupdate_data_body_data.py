...
class TaskTemplateupdateDataBodyData:
    ...
    cascading_offset_polarity: Union[Unset, TaskTemplateupdateDataBodyDataCascadingOffsetPolarity] = UNSET
    cascading_offset_type: Union[Unset, TaskTemplateupdateDataBodyDataCascadingOffsetType] = UNSET
    cascading_source: Union[Unset, "TaskTemplateupdateDataBodyDataCascadingSource"] = UNSET
    description: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    priority: Union[Unset, TaskTemplateupdateDataBodyDataPriority] = TaskTemplateupdateDataBodyDataPriority.NORMAL
    private: Union[Unset, bool] = UNSET
    reminder_templates: Union[Unset, list["TaskTemplateupdateDataBodyDataReminderTemplatesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cascading_offset_polarity: Union[Unset, TaskTemplateupdateDataBodyDataCascadingOffsetPolarity]
        if isinstance(_cascading_offset_polarity, Unset):
            cascading_offset_polarity = UNSET
        else:
            cascading_offset_polarity = TaskTemplateupdateDataBodyDataCascadingOffsetPolarity(
                _cascading_offset_polarity
            )

        _cascading_offset_type = d.pop("cascading_offset_type", UNSET)
        cascading_offset_type: Union[Unset, TaskTemplateupdateDataBodyDataCascadingOffsetType]
        if isinstance(_cascading_offset_type, Unset):
            cascading_offset_type = UNSET
        else:
            cascading_offset_type = TaskTemplateupdateDataBodyDataCascadingOffsetType(_cascading_offset_type)
        ...
        if isinstance(_cascading_source, Unset):
            ...
            cascading_source = TaskTemplateupdateDataBodyDataCascadingSource.from_dict(_cascading_source)
        ...
        priority: Union[Unset, TaskTemplateupdateDataBodyDataPriority]
        ...
        for reminder_templates_item_data in _reminder_templates or []:
            reminder_templates_item = TaskTemplateupdateDataBodyDataReminderTemplatesItem.from_dict(
