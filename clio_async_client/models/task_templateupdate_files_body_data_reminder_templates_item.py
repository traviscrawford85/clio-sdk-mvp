...
from ..models.task_templateupdate_files_body_data_reminder_templates_item_notification_type import (
    TaskTemplateupdateFilesBodyDataReminderTemplatesItemNotificationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="TaskTemplateupdateFilesBodyDataReminderTemplatesItem")


@_attrs_define
class TaskTemplateupdateFilesBodyDataReminderTemplatesItem:
    """
    Attributes:
        ...
        notification_type (Union[Unset, TaskTemplateupdateFilesBodyDataReminderTemplatesItemNotificationType]):
            Notification method.
    """
    ...
    notification_type: Union[Unset, TaskTemplateupdateFilesBodyDataReminderTemplatesItemNotificationType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_notification_type, Unset):
            ...
            notification_type = TaskTemplateupdateFilesBodyDataReminderTemplatesItemNotificationType(_notification_type)

        task_templateupdate_files_body_data_reminder_templates_item = cls(
        ...
        task_templateupdate_files_body_data_reminder_templates_item.additional_properties = d
        return task_templateupdate_files_body_data_reminder_templates_item
