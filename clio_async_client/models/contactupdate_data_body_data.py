...
class ContactupdateDataBodyData:
    ...
    addresses: Union[Unset, list["ContactupdateDataBodyDataAddressesItem"]] = UNSET
    ...
    custom_field_set_associations: Union[Unset, list["ContactupdateDataBodyDataCustomFieldSetAssociationsItem"]] = UNSET
    custom_field_values: Union[Unset, list["ContactupdateDataBodyDataCustomFieldValuesItem"]] = UNSET
    date_of_birth: Union[Unset, str] = UNSET
    email_addresses: Union[Unset, list["ContactupdateDataBodyDataEmailAddressesItem"]] = UNSET
    first_name: Union[Unset, str] = UNSET
    instant_messengers: Union[Unset, list["ContactupdateDataBodyDataInstantMessengersItem"]] = UNSET
    last_name: Union[Unset, str] = UNSET
    ledes_client_id: Union[Unset, str] = UNSET
    middle_name: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    phone_numbers: Union[Unset, list["ContactupdateDataBodyDataPhoneNumbersItem"]] = UNSET
    prefix: Union[Unset, str] = UNSET
    sales_tax_number: Union[Unset, str] = UNSET
    title: Union[Unset, str] = UNSET
    type_: Union[Unset, ContactupdateDataBodyDataType] = UNSET
    web_sites: Union[Unset, list["ContactupdateDataBodyDataWebSitesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for addresses_item_data in _addresses or []:
            addresses_item = ContactupdateDataBodyDataAddressesItem.from_dict(addresses_item_data)
        ...
        if isinstance(_co_counsel_rate, Unset):
            ...
            co_counsel_rate = ContactupdateDataBodyDataCoCounselRate.from_dict(_co_counsel_rate)
        ...
        for custom_field_set_associations_item_data in _custom_field_set_associations or []:
            custom_field_set_associations_item = ContactupdateDataBodyDataCustomFieldSetAssociationsItem.from_dict(
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = ContactupdateDataBodyDataCustomFieldValuesItem.from_dict(
        ...
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = ContactupdateDataBodyDataEmailAddressesItem.from_dict(email_addresses_item_data)
        ...
        for instant_messengers_item_data in _instant_messengers or []:
            instant_messengers_item = ContactupdateDataBodyDataInstantMessengersItem.from_dict(
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = ContactupdateDataBodyDataPhoneNumbersItem.from_dict(phone_numbers_item_data)
        ...
        type_: Union[Unset, ContactupdateDataBodyDataType]
        ...
        for web_sites_item_data in _web_sites or []:
            web_sites_item = ContactupdateDataBodyDataWebSitesItem.from_dict(web_sites_item_data)
