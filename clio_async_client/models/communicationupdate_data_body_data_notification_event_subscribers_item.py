...
T = TypeVar("T", bound="CommunicationupdateDataBodyDataNotificationEventSubscribersItem")


@_attrs_define
class CommunicationupdateDataBodyDataNotificationEventSubscribersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        communicationupdate_data_body_data_notification_event_subscribers_item = cls(
            field_destroy=field_destroy,
            id=id,
            user_id=user_id,
        )

        communicationupdate_data_body_data_notification_event_subscribers_item.additional_properties = d
        return communicationupdate_data_body_data_notification_event_subscribers_item
