...
T = TypeVar("T", bound="CalendarEntryupdateDataBodyDataAttendeesItem")


@_attrs_define
class CalendarEntryupdateDataBodyDataAttendeesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calendar_entryupdate_data_body_data_attendees_item = cls(
            field_destroy=field_destroy,
            id=id,
            type_=type_,
        )

        calendar_entryupdate_data_body_data_attendees_item.additional_properties = d
        return calendar_entryupdate_data_body_data_attendees_item
