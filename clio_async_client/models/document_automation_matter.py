...
T = TypeVar("T", bound="DocumentAutomationMatter")


@_attrs_define
class DocumentAutomationMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_automation_matter = cls(
            billable=billable,
        ...
        document_automation_matter.additional_properties = d
        return document_automation_matter
