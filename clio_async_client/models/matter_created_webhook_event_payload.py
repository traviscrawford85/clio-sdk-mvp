...
class MatterCreatedWebhookEventPayload:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_fields: Union[Unset, MatterCreatedWebhookEventPayloadCustomFields]
        if isinstance(_custom_fields, Unset):
            custom_fields = UNSET
        else:
            custom_fields = MatterCreatedWebhookEventPayloadCustomFields.from_dict(_custom_fields)
