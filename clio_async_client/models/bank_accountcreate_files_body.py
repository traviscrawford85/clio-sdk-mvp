...
@_attrs_define
class BankAccountcreateFilesBody:
    """
    Attributes:
        data (BankAccountcreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_accountcreate_files_body = cls(
            data=data,
        )

        bank_accountcreate_files_body.additional_properties = d
        return bank_accountcreate_files_body
