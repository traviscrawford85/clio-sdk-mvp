...
@_attrs_define
class MedicalRecordsRequestcreateJsonBodyData:
    """
    Attributes:
        bills_status (MedicalRecordsRequestcreateJsonBodyDataBillsStatus): Current status for the Medical Bills.
        ...
        medical_provider_id (int): The unique identifier for a single Medical Provider associated with this Medical
            Records Detail.
        records_status (MedicalRecordsRequestcreateJsonBodyDataRecordsStatus): Current status for the Medical Records.
        ...
        medical_bills (Union[Unset, list['MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItem']]):
        medical_records (Union[Unset, list['MedicalRecordsRequestcreateJsonBodyDataMedicalRecordsItem']]):
    ...
    bills_status: MedicalRecordsRequestcreateJsonBodyDataBillsStatus
    in_treatment: bool
    matter_id: int
    medical_provider_id: int
    records_status: MedicalRecordsRequestcreateJsonBodyDataRecordsStatus
    bills_follow_up_date: Union[Unset, str] = UNSET
    bills_request_date: Union[Unset, str] = UNSET
    description: Union[Unset, str] = UNSET
    medical_bills: Union[Unset, list["MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItem"]] = UNSET
    medical_records: Union[Unset, list["MedicalRecordsRequestcreateJsonBodyDataMedicalRecordsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        bills_status = MedicalRecordsRequestcreateJsonBodyDataBillsStatus(d.pop("bills_status"))
        ...
        records_status = MedicalRecordsRequestcreateJsonBodyDataRecordsStatus(d.pop("records_status"))
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = MedicalRecordsRequestcreateJsonBodyDataMedicalRecordsItem.from_dict(
        ...
        medical_records_requestcreate_json_body_data = cls(
            bills_status=bills_status,
            in_treatment=in_treatment,
            matter_id=matter_id,
            medical_provider_id=medical_provider_id,
        ...
        medical_records_requestcreate_json_body_data.additional_properties = d
        return medical_records_requestcreate_json_body_data
