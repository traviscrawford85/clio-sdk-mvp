...
T = TypeVar("T", bound="TrustLineItemBill")


@_attrs_define
class TrustLineItemBill:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trust_line_item_bill.additional_properties = d
        return trust_line_item_bill
