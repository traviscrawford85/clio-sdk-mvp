...
T = TypeVar("T", bound="LaukExpenseCategory")


@_attrs_define
class LaukExpenseCategory:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lauk_expense_category.additional_properties = d
        return lauk_expense_category
