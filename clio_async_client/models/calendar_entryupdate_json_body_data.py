...
class CalendarEntryupdateJsonBodyData:
    ...
    field_deleted: Union[Unset, CalendarEntryupdateJsonBodyDataDeleted] = UNSET
    all_day: Union[Unset, bool] = UNSET
    attendees: Union[Unset, list["CalendarEntryupdateJsonBodyDataAttendeesItem"]] = UNSET
    calendar_entry_event_type: Union[Unset, "CalendarEntryupdateJsonBodyDataCalendarEntryEventType"] = UNSET
    calendar_owner: Union[Unset, "CalendarEntryupdateJsonBodyDataCalendarOwner"] = UNSET
    conference_meeting: Union[Unset, "CalendarEntryupdateJsonBodyDataConferenceMeeting"] = UNSET
    description: Union[Unset, str] = UNSET
    end_at: Union[Unset, str] = UNSET
    external_properties: Union[Unset, list["CalendarEntryupdateJsonBodyDataExternalPropertiesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_deleted: Union[Unset, CalendarEntryupdateJsonBodyDataDeleted]
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntryupdateJsonBodyDataAttendeesItem.from_dict(attendees_item_data)
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = CalendarEntryupdateJsonBodyDataCalendarEntryEventType.from_dict(
        ...
        if isinstance(_calendar_owner, Unset):
            ...
            calendar_owner = CalendarEntryupdateJsonBodyDataCalendarOwner.from_dict(_calendar_owner)
        ...
        if isinstance(_conference_meeting, Unset):
            ...
            conference_meeting = CalendarEntryupdateJsonBodyDataConferenceMeeting.from_dict(_conference_meeting)
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = CalendarEntryupdateJsonBodyDataExternalPropertiesItem.from_dict(
