...
T = TypeVar("T", bound="MedicalRecordsRequestMatter")


@_attrs_define
class MedicalRecordsRequestMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        medical_records_request_matter = cls(
            billable=billable,
        ...
        medical_records_request_matter.additional_properties = d
        return medical_records_request_matter
