...
T = TypeVar("T", bound="ContactcreateFilesBodyDataAvatar")


@_attrs_define
class ContactcreateFilesBodyDataAvatar:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contactcreate_files_body_data_avatar = cls(
            field_destroy=field_destroy,
            image=image,
        )

        contactcreate_files_body_data_avatar.additional_properties = d
        return contactcreate_files_body_data_avatar
