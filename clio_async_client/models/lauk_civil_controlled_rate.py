...
T = TypeVar("T", bound="LaukCivilControlledRate")


@_attrs_define
class LaukCivilControlledRate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lauk_civil_controlled_rate = cls(
            activity=activity,
        ...
        lauk_civil_controlled_rate.additional_properties = d
        return lauk_civil_controlled_rate
