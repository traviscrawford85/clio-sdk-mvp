...
class ReportSchedulecreateFilesBodyData:
    ...
    Attributes:
        ...
        time_of_day (str): What time the Report Schedule should run. Although the entire datetime is sent, only the time
            information is used.
        time_zone (ReportSchedulecreateFilesBodyDataTimeZone): Used in conjunction with `time_of_day` to determine when
    ...
    time_of_day: str
    time_zone: ReportSchedulecreateFilesBodyDataTimeZone
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_zone = ReportSchedulecreateFilesBodyDataTimeZone(d.pop("time_zone"))
