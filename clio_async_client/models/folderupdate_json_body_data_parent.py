...
from ..models.folderupdate_json_body_data_parent_type import (
    FolderupdateJsonBodyDataParentType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FolderupdateJsonBodyDataParent")


@_attrs_define
class FolderupdateJsonBodyDataParent:
    """
    Attributes:
        id (Union[Unset, int]): The unique identifier of the parent object.
        type_ (Union[Unset, FolderupdateJsonBodyDataParentType]): Type of parent object:
    ...
    type_: Union[Unset, FolderupdateJsonBodyDataParentType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, FolderupdateJsonBodyDataParentType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = FolderupdateJsonBodyDataParentType(_type_)

        folderupdate_json_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        folderupdate_json_body_data_parent.additional_properties = d
        return folderupdate_json_body_data_parent
