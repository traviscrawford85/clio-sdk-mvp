...
class CalendarEntrycreateDataBodyData:
    ...
    start_at: str
    summary: str
    field_deleted: Union[Unset, CalendarEntrycreateDataBodyDataDeleted] = UNSET
    all_day: Union[Unset, bool] = UNSET
    attendees: Union[Unset, list["CalendarEntrycreateDataBodyDataAttendeesItem"]] = UNSET
    calendar_entry_event_type: Union[Unset, "CalendarEntrycreateDataBodyDataCalendarEntryEventType"] = UNSET
    conference_meeting: Union[Unset, "CalendarEntrycreateDataBodyDataConferenceMeeting"] = UNSET
    description: Union[Unset, str] = UNSET
    external_properties: Union[Unset, list["CalendarEntrycreateDataBodyDataExternalPropertiesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_deleted: Union[Unset, CalendarEntrycreateDataBodyDataDeleted]
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntrycreateDataBodyDataAttendeesItem.from_dict(attendees_item_data)
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = CalendarEntrycreateDataBodyDataCalendarEntryEventType.from_dict(
        ...
        if isinstance(_conference_meeting, Unset):
            ...
            conference_meeting = CalendarEntrycreateDataBodyDataConferenceMeeting.from_dict(_conference_meeting)
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = CalendarEntrycreateDataBodyDataExternalPropertiesItem.from_dict(
