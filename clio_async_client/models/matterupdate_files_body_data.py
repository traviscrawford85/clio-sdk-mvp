...
class MatterupdateFilesBodyData:
    ...
    custom_field_set_associations: Union[Unset, list["MatterupdateFilesBodyDataCustomFieldSetAssociationsItem"]] = UNSET
    custom_field_values: Union[Unset, list["MatterupdateFilesBodyDataCustomFieldValuesItem"]] = UNSET
    custom_rate: Union[Unset, "MatterupdateFilesBodyDataCustomRate"] = UNSET
    description: Union[Unset, str] = UNSET
    display_number: Union[Unset, str] = UNSET
    evergreen_retainer: Union[Unset, "MatterupdateFilesBodyDataEvergreenRetainer"] = UNSET
    ...
    originating_attorney: Union[Unset, "MatterupdateFilesBodyDataOriginatingAttorney"] = UNSET
    pending_date: Union[Unset, str] = UNSET
    practice_area: Union[Unset, "MatterupdateFilesBodyDataPracticeArea"] = UNSET
    relationships: Union[Unset, list["MatterupdateFilesBodyDataRelationshipsItem"]] = UNSET
    reset_matter_number: Union[Unset, bool] = False
    responsible_attorney: Union[Unset, "MatterupdateFilesBodyDataResponsibleAttorney"] = UNSET
    split_invoice_payers: Union[Unset, list["MatterupdateFilesBodyDataSplitInvoicePayersItem"]] = UNSET
    status: Union[Unset, MatterupdateFilesBodyDataStatus] = UNSET
    statute_of_limitations: Union[Unset, "MatterupdateFilesBodyDataStatuteOfLimitations"] = UNSET
    task_template_list_instances: Union[Unset, list["MatterupdateFilesBodyDataTaskTemplateListInstancesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for custom_field_set_associations_item_data in _custom_field_set_associations or []:
            custom_field_set_associations_item = MatterupdateFilesBodyDataCustomFieldSetAssociationsItem.from_dict(
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = MatterupdateFilesBodyDataCustomFieldValuesItem.from_dict(
        ...
        if isinstance(_evergreen_retainer, Unset):
            ...
            evergreen_retainer = MatterupdateFilesBodyDataEvergreenRetainer.from_dict(_evergreen_retainer)
        ...
        if isinstance(_matter_budget, Unset):
            ...
            matter_budget = MatterupdateFilesBodyDataMatterBudget.from_dict(_matter_budget)
        ...
        if isinstance(_originating_attorney, Unset):
            ...
            originating_attorney = MatterupdateFilesBodyDataOriginatingAttorney.from_dict(_originating_attorney)
        ...
        if isinstance(_practice_area, Unset):
            ...
            practice_area = MatterupdateFilesBodyDataPracticeArea.from_dict(_practice_area)

        relationships = []
        _relationships = d.pop("relationships", UNSET)
        for relationships_item_data in _relationships or []:
            relationships_item = MatterupdateFilesBodyDataRelationshipsItem.from_dict(relationships_item_data)
        ...
        if isinstance(_responsible_attorney, Unset):
            ...
            responsible_attorney = MatterupdateFilesBodyDataResponsibleAttorney.from_dict(_responsible_attorney)

        split_invoice_payers = []
        _split_invoice_payers = d.pop("split_invoice_payers", UNSET)
        for split_invoice_payers_item_data in _split_invoice_payers or []:
            split_invoice_payers_item = MatterupdateFilesBodyDataSplitInvoicePayersItem.from_dict(
        ...
        status: Union[Unset, MatterupdateFilesBodyDataStatus]
        ...
        if isinstance(_statute_of_limitations, Unset):
            ...
            statute_of_limitations = MatterupdateFilesBodyDataStatuteOfLimitations.from_dict(_statute_of_limitations)
        ...
        for task_template_list_instances_item_data in _task_template_list_instances or []:
            task_template_list_instances_item = MatterupdateFilesBodyDataTaskTemplateListInstancesItem.from_dict(
