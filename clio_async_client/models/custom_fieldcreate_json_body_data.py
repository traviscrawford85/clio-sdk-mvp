...
@_attrs_define
class CustomFieldcreateJsonBodyData:
    """
    Attributes:
        field_type (CustomFieldcreateJsonBodyDataFieldType): Field type of the CustomField.
        name (str): CustomField name.
        parent_type (CustomFieldcreateJsonBodyDataParentType): Type of object the CustomField is for.
        ...
        picklist_options (Union[Unset, list['CustomFieldcreateJsonBodyDataPicklistOptionsItem']]):
        required (Union[Unset, bool]): Whether or not the CustomField should require a value. Default: False.
    """

    field_type: CustomFieldcreateJsonBodyDataFieldType
    name: str
    parent_type: CustomFieldcreateJsonBodyDataParentType
    display_order: Union[Unset, int] = UNSET
    displayed: Union[Unset, bool] = True
    picklist_options: Union[Unset, list["CustomFieldcreateJsonBodyDataPicklistOptionsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        field_type = CustomFieldcreateJsonBodyDataFieldType(d.pop("field_type"))

        name = d.pop("name")

        parent_type = CustomFieldcreateJsonBodyDataParentType(d.pop("parent_type"))
        ...
        for picklist_options_item_data in _picklist_options or []:
            picklist_options_item = CustomFieldcreateJsonBodyDataPicklistOptionsItem.from_dict(
        ...
        custom_fieldcreate_json_body_data = cls(
            field_type=field_type,
            name=name,
            parent_type=parent_type,
        ...
        custom_fieldcreate_json_body_data.additional_properties = d
        return custom_fieldcreate_json_body_data
