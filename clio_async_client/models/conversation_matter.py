...
T = TypeVar("T", bound="ConversationMatter")


@_attrs_define
class ConversationMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversation_matter.additional_properties = d
        return conversation_matter
