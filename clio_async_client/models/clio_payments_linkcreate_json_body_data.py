...
class ClioPaymentsLinkcreateJsonBodyData:
    ...
    destination_contact: Union[Unset, "ClioPaymentsLinkcreateJsonBodyDataDestinationContact"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        destination_account = ClioPaymentsLinkcreateJsonBodyDataDestinationAccount.from_dict(
        ...
        if isinstance(_destination_contact, Unset):
            ...
            destination_contact = ClioPaymentsLinkcreateJsonBodyDataDestinationContact.from_dict(_destination_contact)
