...
@_attrs_define
class FoldercreateJsonBodyDataParent:
    """
    Attributes:
        id (int): The unique identifier of the parent object.
        type_ (FoldercreateJsonBodyDataParentType): Type of parent object:
    ...
    id: int
    type_: FoldercreateJsonBodyDataParentType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = FoldercreateJsonBodyDataParentType(d.pop("type"))

        foldercreate_json_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        foldercreate_json_body_data_parent.additional_properties = d
        return foldercreate_json_body_data_parent
