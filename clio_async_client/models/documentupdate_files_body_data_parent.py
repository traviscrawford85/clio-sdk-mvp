...
from ..models.documentupdate_files_body_data_parent_type import (
    DocumentupdateFilesBodyDataParentType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="DocumentupdateFilesBodyDataParent")


@_attrs_define
class DocumentupdateFilesBodyDataParent:
    """
    Attributes:
        id (Union[Unset, int]): The unique identifier of the parent object.
        type_ (Union[Unset, DocumentupdateFilesBodyDataParentType]): Type of parent object:
    ...
    type_: Union[Unset, DocumentupdateFilesBodyDataParentType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, DocumentupdateFilesBodyDataParentType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = DocumentupdateFilesBodyDataParentType(_type_)

        documentupdate_files_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        documentupdate_files_body_data_parent.additional_properties = d
        return documentupdate_files_body_data_parent
