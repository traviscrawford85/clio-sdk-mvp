...
class ClioPaymentsLinkcreateFilesBodyData:
    ...
    destination_contact: Union[Unset, "ClioPaymentsLinkcreateFilesBodyDataDestinationContact"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        destination_account = ClioPaymentsLinkcreateFilesBodyDataDestinationAccount.from_dict(
        ...
        if isinstance(_destination_contact, Unset):
            ...
            destination_contact = ClioPaymentsLinkcreateFilesBodyDataDestinationContact.from_dict(_destination_contact)
