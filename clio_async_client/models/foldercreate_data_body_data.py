...
@_attrs_define
class FoldercreateDataBodyData:
    """
    Attributes:
        name (str): Name of the Folder
        parent (FoldercreateDataBodyDataParent):
        document_category (Union[Unset, FoldercreateDataBodyDataDocumentCategory]):
        external_properties (Union[Unset, list['FoldercreateDataBodyDataExternalPropertiesItem']]):
        restore (Union[Unset, bool]): Whether or not a trashed Folder should be restored.
    """

    name: str
    parent: "FoldercreateDataBodyDataParent"
    document_category: Union[Unset, "FoldercreateDataBodyDataDocumentCategory"] = UNSET
    external_properties: Union[Unset, list["FoldercreateDataBodyDataExternalPropertiesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parent = FoldercreateDataBodyDataParent.from_dict(d.pop("parent"))
        ...
        if isinstance(_document_category, Unset):
            ...
            document_category = FoldercreateDataBodyDataDocumentCategory.from_dict(_document_category)

        external_properties = []
        _external_properties = d.pop("external_properties", UNSET)
        for external_properties_item_data in _external_properties or []:
            external_properties_item = FoldercreateDataBodyDataExternalPropertiesItem.from_dict(
        ...
        foldercreate_data_body_data = cls(
            name=name,
            parent=parent,
        ...
        foldercreate_data_body_data.additional_properties = d
        return foldercreate_data_body_data
