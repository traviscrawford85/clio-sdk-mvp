...
@_attrs_define
class FoldercreateJsonBodyData:
    """
    Attributes:
        name (str): Name of the Folder
        parent (FoldercreateJsonBodyDataParent):
        document_category (Union[Unset, FoldercreateJsonBodyDataDocumentCategory]):
        external_properties (Union[Unset, list['FoldercreateJsonBodyDataExternalPropertiesItem']]):
        restore (Union[Unset, bool]): Whether or not a trashed Folder should be restored.
    """

    name: str
    parent: "FoldercreateJsonBodyDataParent"
    document_category: Union[Unset, "FoldercreateJsonBodyDataDocumentCategory"] = UNSET
    external_properties: Union[Unset, list["FoldercreateJsonBodyDataExternalPropertiesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parent = FoldercreateJsonBodyDataParent.from_dict(d.pop("parent"))
        ...
        if isinstance(_document_category, Unset):
            ...
            document_category = FoldercreateJsonBodyDataDocumentCategory.from_dict(_document_category)

        external_properties = []
        _external_properties = d.pop("external_properties", UNSET)
        for external_properties_item_data in _external_properties or []:
            external_properties_item = FoldercreateJsonBodyDataExternalPropertiesItem.from_dict(
        ...
        foldercreate_json_body_data = cls(
            name=name,
            parent=parent,
        ...
        foldercreate_json_body_data.additional_properties = d
        return foldercreate_json_body_data
