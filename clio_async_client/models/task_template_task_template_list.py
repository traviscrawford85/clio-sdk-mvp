...
T = TypeVar("T", bound="TaskTemplateTaskTemplateList")


@_attrs_define
class TaskTemplateTaskTemplateList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_template_task_template_list = cls(
        ...
        task_template_task_template_list.additional_properties = d
        return task_template_task_template_list
