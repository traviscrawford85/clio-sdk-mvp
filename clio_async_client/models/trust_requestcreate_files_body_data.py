...
class TrustRequestcreateFilesBodyData:
    ...
    matter: Union[Unset, list["TrustRequestcreateFilesBodyDataMatterItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for matter_item_data in _matter or []:
            matter_item = TrustRequestcreateFilesBodyDataMatterItem.from_dict(matter_item_data)
