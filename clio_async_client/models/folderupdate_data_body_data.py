...
class FolderupdateDataBodyData:
    ...
    external_properties: Union[Unset, list["FolderupdateDataBodyDataExternalPropertiesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document_category, Unset):
            ...
            document_category = FolderupdateDataBodyDataDocumentCategory.from_dict(_document_category)

        external_properties = []
        _external_properties = d.pop("external_properties", UNSET)
        for external_properties_item_data in _external_properties or []:
            external_properties_item = FolderupdateDataBodyDataExternalPropertiesItem.from_dict(
