...
if TYPE_CHECKING:
    from ..models.matterupdate_files_body_data_statute_of_limitations_reminders_item_notification_method import (
        MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItemNotificationMethod,
    )


T = TypeVar("T", bound="MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItem")


@_attrs_define
class MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItem:
    """
    Attributes:
        ...
        notification_method (Union[Unset,
            MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItemNotificationMethod]):
    """
    ...
    notification_method: Union[
        Unset, "MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItemNotificationMethod"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        notification_method: Union[Unset, MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItemNotificationMethod]
        if isinstance(_notification_method, Unset):
            notification_method = UNSET
        else:
            notification_method = (
                MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItemNotificationMethod.from_dict(
                    _notification_method
                )
            )

        matterupdate_files_body_data_statute_of_limitations_reminders_item = cls(
        ...
        matterupdate_files_body_data_statute_of_limitations_reminders_item.additional_properties = d
        return matterupdate_files_body_data_statute_of_limitations_reminders_item
