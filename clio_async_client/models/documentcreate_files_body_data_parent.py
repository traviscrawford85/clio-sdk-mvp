...
from ..models.documentcreate_files_body_data_parent_type import (
    DocumentcreateFilesBodyDataParentType,
)

T = TypeVar("T", bound="DocumentcreateFilesBodyDataParent")


@_attrs_define
class DocumentcreateFilesBodyDataParent:
    """
    Attributes:
        id (int): The unique identifier of the parent object.
        type_ (DocumentcreateFilesBodyDataParentType): Type of parent object:
    ...
    id: int
    type_: DocumentcreateFilesBodyDataParentType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DocumentcreateFilesBodyDataParentType(d.pop("type"))

        documentcreate_files_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        documentcreate_files_body_data_parent.additional_properties = d
        return documentcreate_files_body_data_parent
