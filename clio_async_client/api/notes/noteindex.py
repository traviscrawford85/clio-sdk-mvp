...
from ...models.noteindex_order import NoteindexOrder
from ...models.noteindex_type import NoteindexType
...
def _get_kwargs(
    *,
    ...
    has_time_entries: Union[Unset, bool] = UNSET,
    ids: Union[Unset, int] = UNSET,
    limit: Union[Unset, int] = UNSET,
    matter_id: Union[Unset, int] = UNSET,
    order: Union[Unset, NoteindexOrder] = UNSET,
    ...
    params["has_time_entries"] = has_time_entries
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        has_time_entries (Union[Unset, bool]):
        ids (Union[Unset, int]):
        limit (Union[Unset, int]):
        matter_id (Union[Unset, int]):
        order (Union[Unset, NoteindexOrder]):
