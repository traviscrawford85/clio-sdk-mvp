...
def _get_kwargs(
    *,
    ...
    last_paid_end_date: Union[Unset, str] = UNSET,
    last_paid_start_date: Union[Unset, str] = UNSET,
    limit: Union[Unset, int] = UNSET,
    newest_bill_due_end_date: Union[Unset, str] = UNSET,
    newest_bill_due_start_date: Union[Unset, str] = UNSET,
