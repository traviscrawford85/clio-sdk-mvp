...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, GrantFundingSourcedestroyJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, GrantFundingSourcedestroyDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, GrantFundingSourcedestroyFilesBody):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (GrantFundingSourcedestroyJsonBody):
        body (GrantFundingSourcedestroyDataBody):
        body (GrantFundingSourcedestroyFilesBody):
