...
def _get_kwargs(
    *,
    activity_description_id: Union[Unset, int] = UNSET,
    calendar_entry_id: Union[Unset, int] = UNSET,
    communication_id: Union[Unset, int] = UNSET,
    contact_note_id: Union[Unset, int] = UNSET,
    created_since: Union[Unset, str] = UNSET,
    end_date: Union[Unset, str] = UNSET,
    expense_category_id: Union[Unset, int] = UNSET,
    fields: Union[Unset, str] = UNSET,
    flat_rate: Union[Unset, bool] = UNSET,
    grant_transaction_id: Union[Unset, int] = UNSET,
    ids: Union[Unset, int] = UNSET,
    limit: Union[Unset, int] = UNSET,
    matter_id: Union[Unset, int] = UNSET,
    matter_note_id: Union[Unset, int] = UNSET,
    only_unaccounted_for: Union[Unset, bool] = UNSET,
    order: Union[Unset, ActivityindexOrder] = UNSET,
    page_token: Union[Unset, str] = UNSET,
    query: Union[Unset, str] = UNSET,
    start_date: Union[Unset, str] = UNSET,
    status: Union[Unset, ActivityindexStatus] = UNSET,
    task_id: Union[Unset, int] = UNSET,
    type_: Union[Unset, ActivityindexType] = UNSET,
...
) -> Optional[Union[ActivityList, Error]]:
