...
def _get_kwargs(
    *,
    ...
    field_type: Union[Unset, CustomFieldindexFieldType] = UNSET,
    fields: Union[Unset, str] = UNSET,
    ids: Union[Unset, int] = UNSET,
    limit: Union[Unset, int] = UNSET,
    order: Union[Unset, CustomFieldindexOrder] = UNSET,
    page_token: Union[Unset, str] = UNSET,
    parent_type: Union[Unset, CustomFieldindexParentType] = UNSET,
    query: Union[Unset, str] = UNSET,
    updated_since: Union[Unset, str] = UNSET,
    visible_and_required: Union[Unset, bool] = UNSET,
    ...
    json_field_type: Union[Unset, str] = UNSET
...
) -> Optional[Union[CustomFieldList, Error]]:
