...
def _get_kwargs(
    *,
    ...
    due_after: Union[Unset, str] = UNSET,
    due_at: Union[Unset, str] = UNSET,
    due_before: Union[Unset, str] = UNSET,
    fields: Union[Unset, str] = UNSET,
    ids: Union[Unset, int] = UNSET,
    issued_after: Union[Unset, str] = UNSET,
    issued_before: Union[Unset, str] = UNSET,
    last_sent_end_date: Union[Unset, str] = UNSET,
    last_sent_start_date: Union[Unset, str] = UNSET,
