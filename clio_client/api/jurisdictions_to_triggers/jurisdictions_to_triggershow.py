...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/court_rules/jurisdictions/{jurisdiction_id}/triggers/{id}.json",
        "params": params,
    }
...
) -> Any | Error | JurisdictionsToTriggerShow | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | JurisdictionsToTriggerShow]:
    return Response(
