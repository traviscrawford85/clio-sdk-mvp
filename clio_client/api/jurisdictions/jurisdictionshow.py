...
from ...models.jurisdiction_show import JurisdictionShow
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/court_rules/jurisdictions/{id}.json",
        "params": params,
    }
...
) -> Any | Error | JurisdictionShow | None:
    if response.status_code == 200:
        response_200 = JurisdictionShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | JurisdictionShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, Error, JurisdictionShow]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, Error, JurisdictionShow]
    """
