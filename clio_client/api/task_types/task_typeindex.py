...
from ...models.task_type_list import TaskTypeList
from ...models.task_typeindex_order import TaskTypeindexOrder
...
def _get_kwargs(
    *,
    ...
    order: Unset | TaskTypeindexOrder = UNSET,
...
) -> Error | TaskTypeList | None:
    if response.status_code == 200:
        response_200 = TaskTypeList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, TaskTypeindexOrder]):
    ...
    Returns:
        Response[Union[Error, TaskTypeList]]
    """
