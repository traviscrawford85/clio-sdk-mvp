...
def _get_kwargs(
    *,
    client_only: Unset | bool = UNSET,
    clio_connect_only: Unset | bool = UNSET,
    created_since: Unset | str = UNSET,
    custom_field_ids: Unset | int = UNSET,
    custom_field_values: Unset | ContactindexCustomFieldValues = UNSET,
    email_only: Unset | bool = UNSET,
    exclude_ids: Unset | int = UNSET,
    fields: Unset | str = UNSET,
    ids: Unset | int = UNSET,
    initial: Unset | ContactindexInitial = UNSET,
    limit: Unset | int = UNSET,
    order: Unset | ContactindexOrder = UNSET,
    page_token: Unset | str = UNSET,
    query: Unset | str = UNSET,
    shared_resource_id: Unset | int = UNSET,
    type_: Unset | ContactindexType = UNSET,
