...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/conversation_messages/{id}.json",
        "params": params,
    }
...
) -> Any | ConversationMessageShow | Error | None:
    if response.status_code == 200:
        response_200 = ConversationMessageShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ConversationMessageShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, ConversationMessageShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ConversationMessageShow, Error]
    """
