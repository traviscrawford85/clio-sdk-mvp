...
from ...models.damage_list import DamageList
...
) -> DamageList | Error | None:
    if response.status_code == 200:
        response_200 = DamageList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[DamageList, Error]]
    """
