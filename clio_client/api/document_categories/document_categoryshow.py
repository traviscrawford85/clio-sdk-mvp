...
) -> Any | DocumentCategoryShow | Error | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | DocumentCategoryShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, DocumentCategoryShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, DocumentCategoryShow, Error]
    """
