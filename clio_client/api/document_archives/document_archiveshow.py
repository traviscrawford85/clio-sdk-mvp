...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/document_archives/{id}.json",
        "params": params,
    }
...
) -> Any | DocumentArchiveShow | Error | None:
    if response.status_code == 200:
        response_200 = DocumentArchiveShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | DocumentArchiveShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, DocumentArchiveShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, DocumentArchiveShow, Error]
    """
