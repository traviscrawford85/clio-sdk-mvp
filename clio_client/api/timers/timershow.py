...
) -> Any | Error | TimerShow | None:
    if response.status_code == 200:
        response_200 = TimerShow.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, Error, TimerShow]]
    """
