...
from ...models.grant_funding_source_list import GrantFundingSourceList
...
) -> Error | GrantFundingSourceList | None:
    if response.status_code == 200:
        response_200 = GrantFundingSourceList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | GrantFundingSourceList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error, GrantFundingSourceList]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error, GrantFundingSourceList]
    """
