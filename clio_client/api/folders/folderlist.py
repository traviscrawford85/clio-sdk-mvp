...
from ...models.folderlist_order import FolderlistOrder
from ...models.folderlist_scope import FolderlistScope
...
def _get_kwargs(
    *,
    ...
    order: Unset | FolderlistOrder = UNSET,
    page_token: Unset | str = UNSET,
    parent_id: Unset | int = UNSET,
    query: Unset | str = UNSET,
    scope: Unset | FolderlistScope = UNSET,
    show_uncompleted: Unset | bool = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, FolderlistOrder]):
        page_token (Union[Unset, str]):
        parent_id (Union[Unset, int]):
        query (Union[Unset, str]):
        scope (Union[Unset, FolderlistScope]):
