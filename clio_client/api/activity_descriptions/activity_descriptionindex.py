...
def _get_kwargs(
    *,
    ...
    rate_formatter_id: Unset | int = UNSET,
    rate_foruser_id: Unset | int = UNSET,
    type_: Unset | ActivityDescriptionindexType = UNSET,
...
) -> ActivityDescriptionList | Error | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ActivityDescriptionList | Error]:
    return Response(
