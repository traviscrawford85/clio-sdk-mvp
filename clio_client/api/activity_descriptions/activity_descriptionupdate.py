...
def _get_kwargs(
    id: int,
    *,
    body: ActivityDescriptionupdateJsonBody
    | ActivityDescriptionupdateDataBody
    | ActivityDescriptionupdateFilesBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/activity_descriptions/{id}.json",
        "params": params,
    }

    if isinstance(body, ActivityDescriptionupdateJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, ActivityDescriptionupdateDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, ActivityDescriptionupdateFilesBody):
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ActivityDescriptionShow.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ActivityDescriptionupdateJsonBody):
        body (ActivityDescriptionupdateDataBody):
        body (ActivityDescriptionupdateFilesBody):
