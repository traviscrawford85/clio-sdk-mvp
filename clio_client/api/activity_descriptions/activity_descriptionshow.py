...
) -> ActivityDescriptionShow | Any | Error | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ActivityDescriptionShow | Any | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[ActivityDescriptionShow, Any, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ActivityDescriptionShow, Any, Error]
    """
