...
from ...models.trust_line_item_list import TrustLineItemList
from ...models.trust_line_itemindex_order import TrustLineItemindexOrder
...
def _get_kwargs(
    *,
    ...
    order: Unset | TrustLineItemindexOrder = UNSET,
...
) -> Error | TrustLineItemList | None:
    if response.status_code == 200:
        response_200 = TrustLineItemList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | TrustLineItemList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, TrustLineItemindexOrder]):
    ...
    Returns:
        Response[Union[Error, TrustLineItemList]]
    """
