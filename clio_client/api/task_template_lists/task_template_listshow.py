...
) -> Any | Error | TaskTemplateListShow | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | TaskTemplateListShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, Error, TaskTemplateListShow]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, Error, TaskTemplateListShow]
    """
