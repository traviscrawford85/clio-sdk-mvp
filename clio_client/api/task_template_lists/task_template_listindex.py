...
from ...models.task_template_list_list import TaskTemplateListList
from ...models.task_template_listindex_order import TaskTemplateListindexOrder
...
def _get_kwargs(
    *,
    ...
    order: Unset | TaskTemplateListindexOrder = UNSET,
...
) -> Error | TaskTemplateListList | None:
    if response.status_code == 200:
        response_200 = TaskTemplateListList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | TaskTemplateListList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, TaskTemplateListindexOrder]):
    ...
    Returns:
        Response[Union[Error, TaskTemplateListList]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error, TaskTemplateListList]
    """
