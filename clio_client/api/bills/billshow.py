...
def _get_kwargs(
    ...
    *,
    ...
    navigation_next: Unset | int = UNSET,
    navigation_previous: Unset | int = UNSET,
    ...
    params["navigation.next"] = navigation_next

    params["navigation.previous"] = navigation_previous
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        navigation_next (Union[Unset, int]):
        navigation_previous (Union[Unset, int]):
    ...
    Returns:
        Response[Union[Any, BillShow, Error]]
    """
