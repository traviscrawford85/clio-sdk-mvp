...
from ...models.utbms_set_list import UtbmsSetList
from ...models.utbms_setindex_order import UtbmsSetindexOrder
...
def _get_kwargs(
    *,
    ...
    order: Unset | UtbmsSetindexOrder = UNSET,
...
) -> Error | UtbmsSetList | None:
    if response.status_code == 200:
        response_200 = UtbmsSetList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, UtbmsSetindexOrder]):
    ...
    Returns:
        Response[Union[Error, UtbmsSetList]]
    """
