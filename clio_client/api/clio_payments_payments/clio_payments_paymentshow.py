...
from ...models.clio_payments_payment_show import ClioPaymentsPaymentShow
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/clio_payments/payments/{id}.json",
        "params": params,
    }
...
) -> Any | ClioPaymentsPaymentShow | Error | None:
    if response.status_code == 200:
        response_200 = ClioPaymentsPaymentShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ClioPaymentsPaymentShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, ClioPaymentsPaymentShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ClioPaymentsPaymentShow, Error]
    """
