...
from ...models.bill_theme_list import BillThemeList
...
) -> BillThemeList | Error | None:
    if response.status_code == 200:
        response_200 = BillThemeList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[BillThemeList, Error]]
    """
