...
def _get_kwargs(
    ...
    *,
    ...
    order: Unset | RelatedContactsindexOrder = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/matters/{matter_id}/related_contacts.json",
        "params": params,
    }
...
) -> Error | RelatedContactsList | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | RelatedContactsList]:
    return Response(
