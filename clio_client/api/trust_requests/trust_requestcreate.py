...
def _get_kwargs(
    *,
    body: TrustRequestcreateJsonBody
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/trust_requests.json",
        "params": params,
    }

    if isinstance(body, TrustRequestcreateJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, TrustRequestcreateDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, TrustRequestcreateFilesBody):
...
) -> Error | TrustRequestShow | None:
    if response.status_code == 201:
        response_201 = TrustRequestShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | TrustRequestShow]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (TrustRequestcreateJsonBody):
        body (TrustRequestcreateDataBody):
        body (TrustRequestcreateFilesBody):
    ...
    Returns:
        Response[Union[Error, TrustRequestShow]]
    """
