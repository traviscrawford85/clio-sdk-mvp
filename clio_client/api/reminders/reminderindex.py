...
def _get_kwargs(
    *,
    ...
    notification_method_id: Unset | int = UNSET,
    order: Unset | ReminderindexOrder = UNSET,
    page_token: Unset | str = UNSET,
    state: Unset | ReminderindexState = UNSET,
    subject_id: Unset | int = UNSET,
    subject_type: Unset | ReminderindexSubjectType = UNSET,
