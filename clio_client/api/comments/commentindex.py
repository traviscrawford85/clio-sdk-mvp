...
from ...models.comment_list import CommentList
...
) -> CommentList | Error | None:
    if response.status_code == 200:
        response_200 = CommentList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[CommentList, Error]]
    """
