...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/court_rules/matter_dockets/{id}.json",
        "params": params,
    }
...
) -> Any | Error | MatterDocketShow | None:
    if response.status_code == 200:
        response_200 = MatterDocketShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | MatterDocketShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, Error, MatterDocketShow]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, Error, MatterDocketShow]
    """
