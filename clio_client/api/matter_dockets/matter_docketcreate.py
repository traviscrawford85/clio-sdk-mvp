...
def _get_kwargs(
    *,
    body: MatterDocketcreateJsonBody
    ...
    if isinstance(body, MatterDocketcreateJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, MatterDocketcreateDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, MatterDocketcreateFilesBody):
...
) -> Error | MatterDocketShow | None:
    if response.status_code == 201:
        response_201 = MatterDocketShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | MatterDocketShow]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (MatterDocketcreateJsonBody):
        body (MatterDocketcreateDataBody):
        body (MatterDocketcreateFilesBody):
    ...
    Returns:
        Response[Union[Error, MatterDocketShow]]
    """
