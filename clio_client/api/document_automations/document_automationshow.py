...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/document_automations/{id}.json",
        "params": params,
    }
...
) -> Any | DocumentAutomationShow | Error | None:
    if response.status_code == 200:
        response_200 = DocumentAutomationShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | DocumentAutomationShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, DocumentAutomationShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, DocumentAutomationShow, Error]
    """
