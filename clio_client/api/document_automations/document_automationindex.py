...
def _get_kwargs(
    *,
    ...
    order: Unset | DocumentAutomationindexOrder = UNSET,
...
) -> DocumentAutomationList | Error | None:
    if response.status_code == 200:
        response_200 = DocumentAutomationList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DocumentAutomationList | Error]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, DocumentAutomationindexOrder]):
    ...
    Returns:
        Response[Union[DocumentAutomationList, Error]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[DocumentAutomationList, Error]
    """
