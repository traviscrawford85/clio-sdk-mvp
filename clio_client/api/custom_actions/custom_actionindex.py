...
from ...models.custom_action_list import CustomActionList
...
) -> CustomActionList | Error | None:
    if response.status_code == 200:
        response_200 = CustomActionList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CustomActionList | Error]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[CustomActionList, Error]]
    """
