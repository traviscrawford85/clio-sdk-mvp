...
) -> CurrencyList | Error | None:
    if response.status_code == 200:
        response_200 = CurrencyList.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[CurrencyList, Error]]
    """
