...
from ...models.activity_rate_list import ActivityRateList
...
def _get_kwargs(
    *,
    co_counsel_contact_id: Unset | int = UNSET,
    ...
    params["co_counsel_contact_id"] = co_counsel_contact_id
...
) -> ActivityRateList | Error | None:
    if response.status_code == 200:
        response_200 = ActivityRateList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ActivityRateList | Error]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        co_counsel_contact_id (Union[Unset, int]):
    ...
    Returns:
        Response[Union[ActivityRateList, Error]]
    """
