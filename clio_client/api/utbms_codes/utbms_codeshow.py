...
from ...models.utbms_code_show import UtbmsCodeShow
...
) -> Any | Error | UtbmsCodeShow | None:
    if response.status_code == 200:
        response_200 = UtbmsCodeShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | UtbmsCodeShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, Error, UtbmsCodeShow]]
    """
