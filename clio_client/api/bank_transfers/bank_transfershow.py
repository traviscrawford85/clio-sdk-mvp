...
from ...models.bank_transfer_show import BankTransferShow
...
) -> Any | BankTransferShow | Error | None:
    if response.status_code == 200:
        response_200 = BankTransferShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | BankTransferShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, BankTransferShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, BankTransferShow, Error]
    """
