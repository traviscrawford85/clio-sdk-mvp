...
def _get_kwargs(
    id: int,
    *,
    body: CommunicationupdateJsonBody
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/communications/{id}.json",
        "params": params,
    }

    if isinstance(body, CommunicationupdateJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, CommunicationupdateDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, CommunicationupdateFilesBody):
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CommunicationShow.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CommunicationupdateJsonBody):
        body (CommunicationupdateDataBody):
        body (CommunicationupdateFilesBody):
