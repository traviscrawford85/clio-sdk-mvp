...
from ...models.bank_transaction_show import BankTransactionShow
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/bank_transactions/{id}.json",
        "params": params,
    }
...
) -> Any | BankTransactionShow | Error | None:
    if response.status_code == 200:
        response_200 = BankTransactionShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | BankTransactionShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, BankTransactionShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, BankTransactionShow, Error]
    """
