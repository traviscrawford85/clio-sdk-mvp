...
from ...models.credit_memo_show import CreditMemoShow
...
) -> Any | CreditMemoShow | Error | None:
    if response.status_code == 200:
        response_200 = CreditMemoShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | CreditMemoShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, CreditMemoShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CreditMemoShow, Error]
    """
