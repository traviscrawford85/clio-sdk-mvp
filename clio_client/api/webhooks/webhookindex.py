...
from ...models.webhookindex_order import WebhookindexOrder
...
def _get_kwargs(
    *,
    ...
    order: Unset | WebhookindexOrder = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, WebhookindexOrder]):
    ...
    Returns:
        Response[Union[Error, WebhookList]]
    """
