...
def _get_kwargs(
    *,
    ...
    filter_inactive_users: Unset | bool = UNSET,
    ids: Unset | int = UNSET,
    limit: Unset | int = UNSET,
    order: Unset | CalendarindexOrder = UNSET,
    owner: Unset | bool = UNSET,
    page_token: Unset | str = UNSET,
    source: Unset | CalendarindexSource = UNSET,
    type_: Unset | CalendarindexType = UNSET,
    updated_since: Unset | str = UNSET,
    visible: Unset | bool = UNSET,
    writeable: Unset | bool = UNSET,
