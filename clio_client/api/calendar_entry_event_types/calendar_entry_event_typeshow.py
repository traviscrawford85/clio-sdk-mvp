...
) -> Any | CalendarEntryEventType | Error | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | CalendarEntryEventType | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, CalendarEntryEventType, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CalendarEntryEventType, Error]
    """
