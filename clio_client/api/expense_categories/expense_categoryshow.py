...
) -> Any | Error | ExpenseCategoryShow | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | ExpenseCategoryShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, Error, ExpenseCategoryShow]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, Error, ExpenseCategoryShow]
    """
