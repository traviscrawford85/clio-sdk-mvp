...
from ...models.calendar_visibility_list import CalendarVisibilityList
...
) -> CalendarVisibilityList | Error | None:
    if response.status_code == 200:
        response_200 = CalendarVisibilityList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CalendarVisibilityList | Error]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[CalendarVisibilityList, Error]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[CalendarVisibilityList, Error]
    """
