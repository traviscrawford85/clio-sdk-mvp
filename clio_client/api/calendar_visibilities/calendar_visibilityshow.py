...
) -> Any | CalendarVisibilityShow | Error | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | CalendarVisibilityShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, CalendarVisibilityShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CalendarVisibilityShow, Error]
    """
