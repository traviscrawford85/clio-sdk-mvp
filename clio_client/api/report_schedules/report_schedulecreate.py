...
def _get_kwargs(
    *,
    body: ReportSchedulecreateJsonBody
    ...
    if isinstance(body, ReportSchedulecreateJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, ReportSchedulecreateDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, ReportSchedulecreateFilesBody):
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ReportScheduleShow.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ReportSchedulecreateJsonBody):
        body (ReportSchedulecreateDataBody):
        body (ReportSchedulecreateFilesBody):
