...
def _get_kwargs(
    *,
    ...
    order: Unset | CustomFieldSetindexOrder = UNSET,
    page_token: Unset | str = UNSET,
    parent_type: Unset | CustomFieldSetindexParentType = UNSET,
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CustomFieldSetList | Error]:
    return Response(
