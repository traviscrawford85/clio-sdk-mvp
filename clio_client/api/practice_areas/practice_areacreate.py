...
def _get_kwargs(
    *,
    body: PracticeAreacreateJsonBody
    ...
    if isinstance(body, PracticeAreacreateJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, PracticeAreacreateDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, PracticeAreacreateFilesBody):
...
) -> Error | PracticeAreaShow | None:
    if response.status_code == 201:
        response_201 = PracticeAreaShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | PracticeAreaShow]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (PracticeAreacreateJsonBody):
        body (PracticeAreacreateDataBody):
        body (PracticeAreacreateFilesBody):
