...
from ...models.practice_area_list import PracticeAreaList
from ...models.practice_areaindex_order import PracticeAreaindexOrder
...
def _get_kwargs(
    *,
    ...
    order: Unset | PracticeAreaindexOrder = UNSET,
...
) -> Error | PracticeAreaList | None:
    if response.status_code == 200:
        response_200 = PracticeAreaList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | PracticeAreaList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, PracticeAreaindexOrder]):
    ...
    Returns:
        Response[Union[Error, PracticeAreaList]]
    """
