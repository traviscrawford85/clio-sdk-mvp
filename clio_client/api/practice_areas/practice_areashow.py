...
) -> Any | Error | PracticeAreaShow | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | PracticeAreaShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, Error, PracticeAreaShow]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, Error, PracticeAreaShow]
    """
