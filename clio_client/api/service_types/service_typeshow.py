...
from ...models.service_type_show import ServiceTypeShow
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/court_rules/service_types/{id}.json",
        "params": params,
    }
...
) -> Any | Error | ServiceTypeShow | None:
    if response.status_code == 200:
        response_200 = ServiceTypeShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | ServiceTypeShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, Error, ServiceTypeShow]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, Error, ServiceTypeShow]
    """
