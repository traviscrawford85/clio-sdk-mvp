...
def _get_kwargs(
    *,
    category: Unset | ReportPresetindexCategory = UNSET,
    created_since: Unset | str = UNSET,
    fields: Unset | str = UNSET,
    has_schedule: Unset | bool = UNSET,
    ids: Unset | int = UNSET,
    limit: Unset | int = UNSET,
    order: Unset | ReportPresetindexOrder = UNSET,
    output_format: Unset | str = UNSET,
    page_token: Unset | str = UNSET,
    query: Unset | str = UNSET,
    schedule_frequency: Unset | ReportPresetindexScheduleFrequency = UNSET,
    ...
    json_schedule_frequency: Unset | str = UNSET
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | ReportPresetList]:
    return Response(
