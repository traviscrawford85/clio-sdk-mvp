...
def _get_kwargs(
    id: int,
    *,
    body: ReportPresetupdateJsonBody
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/report_presets/{id}.json",
        "params": params,
    }

    if isinstance(body, ReportPresetupdateJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, ReportPresetupdateDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, ReportPresetupdateFilesBody):
...
) -> Error | ReportPresetShow | None:
    if response.status_code == 200:
        response_200 = ReportPresetShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | ReportPresetShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ReportPresetupdateJsonBody):
        body (ReportPresetupdateDataBody):
        body (ReportPresetupdateFilesBody):
