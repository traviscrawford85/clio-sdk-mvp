...
from ...models.billable_clientindex_custom_field_values import (
...
def _get_kwargs(
    *,
    ...
    custom_field_values: Unset | BillableClientindexCustomFieldValues = UNSET,
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BillableClientList | Error]:
    return Response(
