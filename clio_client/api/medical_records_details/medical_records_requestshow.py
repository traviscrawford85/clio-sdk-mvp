...
) -> Any | Error | MedicalRecordsRequestShow | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Error | MedicalRecordsRequestShow]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Return the data for a single Medical Records Detail
     ...
     Outlines the parameters, optional and required, used when requesting the data for a single Medical
    Records Details
    ...
    Returns:
        Response[Union[Any, Error, MedicalRecordsRequestShow]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, Error, MedicalRecordsRequestShow]
    """
