...
from ...models.client_show import ClientShow
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/matters/{matter_id}/client.json",
        "params": params,
    }
...
) -> Any | ClientShow | Error | None:
    if response.status_code == 200:
        response_200 = ClientShow.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, ClientShow, Error]]
    """
