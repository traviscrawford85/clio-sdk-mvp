...
def _get_kwargs(
    *,
    body: TaskTemplatecreateJsonBody
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/task_templates.json",
        "params": params,
    }

    if isinstance(body, TaskTemplatecreateJsonBody):
        _json_body = body.to_dict()

        _kwargs["json"] = _json_body
        headers["Content-Type"] = "application/json"
    if isinstance(body, TaskTemplatecreateDataBody):
        _data_body = body.to_dict()

        _kwargs["data"] = _data_body
        headers["Content-Type"] = "application/x-www-form-urlencoded"
    if isinstance(body, TaskTemplatecreateFilesBody):
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = TaskTemplateShow.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (TaskTemplatecreateJsonBody):
        body (TaskTemplatecreateDataBody):
        body (TaskTemplatecreateFilesBody):
