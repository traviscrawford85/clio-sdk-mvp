...
def _get_kwargs(
    *,
    ...
    order: Unset | AllocationindexOrder = UNSET,
    page_token: Unset | str = UNSET,
    parent_id: Unset | int = UNSET,
    parent_type: Unset | int = UNSET,
    status: Unset | AllocationindexStatus = UNSET,
