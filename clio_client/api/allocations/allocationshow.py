...
from ...models.allocation_show import AllocationShow
...
) -> AllocationShow | Any | Error | None:
    if response.status_code == 200:
        response_200 = AllocationShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AllocationShow | Any | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[AllocationShow, Any, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AllocationShow, Any, Error]
    """
