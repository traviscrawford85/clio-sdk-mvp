...
) -> Any | ClioPaymentsLinkShow | Error | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ClioPaymentsLinkShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, ClioPaymentsLinkShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ClioPaymentsLinkShow, Error]
    """
