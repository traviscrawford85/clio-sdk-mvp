...
from ...models.clio_payments_link_list import ClioPaymentsLinkList
...
) -> ClioPaymentsLinkList | Error | None:
    if response.status_code == 200:
        response_200 = ClioPaymentsLinkList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClioPaymentsLinkList | Error]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[ClioPaymentsLinkList, Error]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[ClioPaymentsLinkList, Error]
    """
