...
from ...models.matter_stage_list import MatterStageList
...
) -> Error | MatterStageList | None:
    if response.status_code == 200:
        response_200 = MatterStageList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | MatterStageList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error, MatterStageList]]
    """
