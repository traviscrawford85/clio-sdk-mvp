...
from ...models.billing_setting_show import BillingSettingShow
...
) -> Any | BillingSettingShow | Error | None:
    if response.status_code == 200:
        response_200 = BillingSettingShow.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | BillingSettingShow | Error]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, BillingSettingShow, Error]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Any, BillingSettingShow, Error]
    """
