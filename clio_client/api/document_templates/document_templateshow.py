...
) -> Any | DocumentTemplateShow | Error | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | DocumentTemplateShow | Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, DocumentTemplateShow, Error]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, DocumentTemplateShow, Error]
    """
