...
from ...models.text_snippet_list import TextSnippetList
from ...models.text_snippetindex_order import TextSnippetindexOrder
...
def _get_kwargs(
    *,
    ...
    order: Unset | TextSnippetindexOrder = UNSET,
...
) -> Error | TextSnippetList | None:
    if response.status_code == 200:
        response_200 = TextSnippetList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | TextSnippetList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order (Union[Unset, TextSnippetindexOrder]):
    ...
    Returns:
        Response[Union[Error, TextSnippetList]]
    """
