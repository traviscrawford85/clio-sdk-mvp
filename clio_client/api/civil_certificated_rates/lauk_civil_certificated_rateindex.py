...
def _get_kwargs(
    *,
    ...
    params["attended_several_hearings_for_multiple_clients"] = (
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/lauk_civil_certificated_rates.json",
        "params": params,
    }
...
) -> Error | LaukCivilCertificatedRateList | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | LaukCivilCertificatedRateList]:
    return Response(
