...
class CommunicationcreateJsonBodyData:
    ...
    external_properties: (
        Unset | list["CommunicationcreateJsonBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    receivers: Unset | list["CommunicationcreateJsonBodyDataReceiversItem"] = UNSET
    senders: Unset | list["CommunicationcreateJsonBodyDataSendersItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CommunicationcreateJsonBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CommunicationcreateJsonBodyDataMatter
        ...
        for notification_event_subscribers_item_data in (
            ...
            notification_event_subscribers_item = CommunicationcreateJsonBodyDataNotificationEventSubscribersItem.from_dict(
                notification_event_subscribers_item_data
            )
        ...
        for receivers_item_data in _receivers or []:
            receivers_item = CommunicationcreateJsonBodyDataReceiversItem.from_dict(
                receivers_item_data
            )
        ...
        for senders_item_data in _senders or []:
            senders_item = CommunicationcreateJsonBodyDataSendersItem.from_dict(
                senders_item_data
            )
