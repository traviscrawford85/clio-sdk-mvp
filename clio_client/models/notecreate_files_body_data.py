...
from ..models.notecreate_files_body_data_type import NotecreateFilesBodyDataType
...
@_attrs_define
class NotecreateFilesBodyData:
    """
    Attributes:
        contact (NotecreateFilesBodyDataContact):
        matter (NotecreateFilesBodyDataMatter):
        type_ (NotecreateFilesBodyDataType): Note type.
        date (Union[Unset, str]): Date for the Note. (Expects an ISO-8601 date).
        detail (Union[Unset, str]): Note body.
        notification_event_subscribers (Union[Unset, list['NotecreateFilesBodyDataNotificationEventSubscribersItem']]):
        subject (Union[Unset, str]): Note subject.
    """

    contact: "NotecreateFilesBodyDataContact"
    matter: "NotecreateFilesBodyDataMatter"
    type_: NotecreateFilesBodyDataType
    date: Unset | str = UNSET
    detail: Unset | str = UNSET
    notification_event_subscribers: (
        Unset | list["NotecreateFilesBodyDataNotificationEventSubscribersItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter = NotecreateFilesBodyDataMatter.from_dict(d.pop("matter"))

        type_ = NotecreateFilesBodyDataType(d.pop("type"))
        ...
        for notification_event_subscribers_item_data in (
            ...
            notification_event_subscribers_item = (
                NotecreateFilesBodyDataNotificationEventSubscribersItem.from_dict(
                    notification_event_subscribers_item_data
                )
            )
        ...
        notecreate_files_body_data = cls(
            contact=contact,
            matter=matter,
            type_=type_,
            date=date,
        ...
        notecreate_files_body_data.additional_properties = d
        return notecreate_files_body_data
