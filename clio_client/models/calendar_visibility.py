...
class CalendarVisibility:
    ...
    color: Unset | CalendarVisibilityBaseColor = UNSET
    created_at: Unset | str = UNSET
    etag: Unset | str = UNSET
    id: Unset | int = UNSET
    light_color: Unset | CalendarVisibilityBaseLightColor = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: Unset | CalendarVisibilityBaseColor
        ...
        light_color: Unset | CalendarVisibilityBaseLightColor
