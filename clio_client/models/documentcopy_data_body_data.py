...
class DocumentcopyDataBodyData:
    ...
    external_properties: (
        Unset | list["DocumentcopyDataBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentcopyDataBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentcopyDataBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                DocumentcopyDataBodyDataExternalPropertiesItem.from_dict(
