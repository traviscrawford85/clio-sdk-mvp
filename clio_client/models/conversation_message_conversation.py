...
T = TypeVar("T", bound="ConversationMessageConversation")


@_attrs_define
class ConversationMessageConversation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversation_message_conversation = cls(
            archived=archived,
        ...
        conversation_message_conversation.additional_properties = d
        return conversation_message_conversation
