...
class ClioPaymentsLink:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        clio_payments_payment: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_account: Unset | ClioPaymentsLinkBankAccount
        ...
        bill: Unset | ClioPaymentsLinkBill
        ...
        clio_payments_payment: Unset | ClioPaymentsLinkClioPaymentsPayment
        if isinstance(_clio_payments_payment, Unset):
            clio_payments_payment = UNSET
        else:
            clio_payments_payment = ClioPaymentsLinkClioPaymentsPayment.from_dict(
                _clio_payments_payment
            )

        _contact = d.pop("contact", UNSET)
        contact: Unset | ClioPaymentsLinkContact
        ...
        destination_account: Unset | ClioPaymentsLinkDestinationAccount
        if isinstance(_destination_account, Unset):
            destination_account = UNSET
        else:
            destination_account = ClioPaymentsLinkDestinationAccount.from_dict(
                _destination_account
            )

        _destination_contact = d.pop("destination_contact", UNSET)
        destination_contact: Unset | ClioPaymentsLinkDestinationContact
        if isinstance(_destination_contact, Unset):
            destination_contact = UNSET
        else:
            destination_contact = ClioPaymentsLinkDestinationContact.from_dict(
