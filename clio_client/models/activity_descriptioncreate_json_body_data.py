...
if TYPE_CHECKING:
    ...
    from ..models.activity_descriptioncreate_json_body_data_rate import (
...
class ActivityDescriptioncreateJsonBodyData:
    ...
    groups: Unset | list["ActivityDescriptioncreateJsonBodyDataGroupsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for groups_item_data in _groups or []:
            groups_item = ActivityDescriptioncreateJsonBodyDataGroupsItem.from_dict(
                groups_item_data
            )
        ...
        rate: Unset | ActivityDescriptioncreateJsonBodyDataRate
