...
T = TypeVar("T", bound="DocumentcreateDataBodyDataMultipartsItem")


@_attrs_define
class DocumentcreateDataBodyDataMultipartsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documentcreate_data_body_data_multiparts_item = cls(
            content_length=content_length,
            part_number=part_number,
            content_md5=content_md5,
        )

        documentcreate_data_body_data_multiparts_item.additional_properties = d
        return documentcreate_data_body_data_multiparts_item
