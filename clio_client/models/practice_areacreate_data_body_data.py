...
from ..models.practice_areacreate_data_body_data_category import (
...
class PracticeAreacreateDataBodyData:
    ...
    name: str
    category: Unset | PracticeAreacreateDataBodyDataCategory = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category: Unset | PracticeAreacreateDataBodyDataCategory
