...
if TYPE_CHECKING:
    from ..models.matterupdate_data_body_data_custom_field_values_item_custom_field import (
        MatterupdateDataBodyDataCustomFieldValuesItemCustomField,
    )


T = TypeVar("T", bound="MatterupdateDataBodyDataCustomFieldValuesItem")


@_attrs_define
class MatterupdateDataBodyDataCustomFieldValuesItem:
    """
    Attributes:
        ...
        custom_field (Union[Unset, MatterupdateDataBodyDataCustomFieldValuesItemCustomField]):
    ...
    custom_field: Union[
        Unset, "MatterupdateDataBodyDataCustomFieldValuesItemCustomField"
    ] = UNSET
    id: Unset | int = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field: Unset | MatterupdateDataBodyDataCustomFieldValuesItemCustomField
        if isinstance(_custom_field, Unset):
            custom_field = UNSET
        else:
            custom_field = (
                MatterupdateDataBodyDataCustomFieldValuesItemCustomField.from_dict(
                    _custom_field
                )
            )
        ...
        matterupdate_data_body_data_custom_field_values_item = cls(
        ...
        matterupdate_data_body_data_custom_field_values_item.additional_properties = d
        return matterupdate_data_body_data_custom_field_values_item
