...
T = TypeVar("T", bound="RelatedContactsSecondaryWebSite")


@_attrs_define
class RelatedContactsSecondaryWebSite:
    """
    Attributes:
    ...
    id: Unset | int = UNSET
    name: Unset | WebSiteBaseName = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_contacts_secondary_web_site = cls(
            address=address,
        ...
        related_contacts_secondary_web_site.additional_properties = d
        return related_contacts_secondary_web_site
