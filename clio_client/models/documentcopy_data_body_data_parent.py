...
from ..models.documentcopy_data_body_data_parent_type import (
    DocumentcopyDataBodyDataParentType,
)

T = TypeVar("T", bound="DocumentcopyDataBodyDataParent")


@_attrs_define
class DocumentcopyDataBodyDataParent:
    """
    Attributes:
        id (int): The unique identifier of the parent object.
        type_ (DocumentcopyDataBodyDataParentType): Type of parent object:
    ...
    id: int
    type_: DocumentcopyDataBodyDataParentType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DocumentcopyDataBodyDataParentType(d.pop("type"))

        documentcopy_data_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        documentcopy_data_body_data_parent.additional_properties = d
        return documentcopy_data_body_data_parent
