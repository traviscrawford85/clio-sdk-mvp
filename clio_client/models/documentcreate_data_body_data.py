...
class DocumentcreateDataBodyData:
    ...
    external_properties: (
        Unset | list["DocumentcreateDataBodyDataExternalPropertiesItem"]
    ) = UNSET
    filename: Unset | str = "name"
    multiparts: Unset | list["DocumentcreateDataBodyDataMultipartsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentcreateDataBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentcreateDataBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                DocumentcreateDataBodyDataExternalPropertiesItem.from_dict(
        ...
        for multiparts_item_data in _multiparts or []:
            multiparts_item = DocumentcreateDataBodyDataMultipartsItem.from_dict(
