...
T = TypeVar("T", bound="ClioPaymentsLinkBankAccount")


@_attrs_define
class ClioPaymentsLinkBankAccount:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_link_bank_account = cls(
        ...
        clio_payments_link_bank_account.additional_properties = d
        return clio_payments_link_bank_account
