...
T = TypeVar("T", bound="ItemLatestDocumentVersion")


@_attrs_define
class ItemLatestDocumentVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        item_latest_document_version = cls(
        ...
        item_latest_document_version.additional_properties = d
        return item_latest_document_version
