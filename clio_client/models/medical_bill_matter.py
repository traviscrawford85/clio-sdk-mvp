...
T = TypeVar("T", bound="MedicalBillMatter")


@_attrs_define
class MedicalBillMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        medical_bill_matter.additional_properties = d
        return medical_bill_matter
