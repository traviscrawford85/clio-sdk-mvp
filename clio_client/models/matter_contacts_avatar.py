...
T = TypeVar("T", bound="MatterContactsAvatar")


@_attrs_define
class MatterContactsAvatar:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_contacts_avatar.additional_properties = d
        return matter_contacts_avatar
