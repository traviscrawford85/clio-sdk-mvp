...
from ..models.activityupdate_files_body_data_type import ActivityupdateFilesBodyDataType
...
@_attrs_define
class ActivityupdateFilesBodyData:
    """
    Attributes:
        activity_description (Union[Unset, ActivityupdateFilesBodyDataActivityDescription]):
        calendar_entry (Union[Unset, ActivityupdateFilesBodyDataCalendarEntry]):
        client_portal (Union[Unset, ActivityupdateFilesBodyDataClientPortal]):
        communication (Union[Unset, ActivityupdateFilesBodyDataCommunication]):
        contact_note (Union[Unset, ActivityupdateFilesBodyDataContactNote]):
        date (Union[Unset, str]): The date the Activity was performed. (Expects an ISO-8601 date).
        expense_category (Union[Unset, ActivityupdateFilesBodyDataExpenseCategory]):
        matter (Union[Unset, ActivityupdateFilesBodyDataMatter]):
        matter_note (Union[Unset, ActivityupdateFilesBodyDataMatterNote]):
        ...
        task (Union[Unset, ActivityupdateFilesBodyDataTask]):
        tax_setting (Union[Unset, ActivityupdateFilesBodyDataTaxSetting]): The option denoting whether primary tax,
            secondary tax, or both is applied to an expense entry.
        text_message_conversation (Union[Unset, ActivityupdateFilesBodyDataTextMessageConversation]):
        type_ (Union[Unset, ActivityupdateFilesBodyDataType]): The type of the Activity.
        user (Union[Unset, ActivityupdateFilesBodyDataUser]):
        utbms_expense (Union[Unset, ActivityupdateFilesBodyDataUtbmsExpense]):
        vendor (Union[Unset, ActivityupdateFilesBodyDataVendor]):
    """

    activity_description: Union[
        Unset, "ActivityupdateFilesBodyDataActivityDescription"
    ] = UNSET
    calendar_entry: Union[Unset, "ActivityupdateFilesBodyDataCalendarEntry"] = UNSET
    client_portal: Union[Unset, "ActivityupdateFilesBodyDataClientPortal"] = UNSET
    communication: Union[Unset, "ActivityupdateFilesBodyDataCommunication"] = UNSET
    contact_note: Union[Unset, "ActivityupdateFilesBodyDataContactNote"] = UNSET
    date: Unset | str = UNSET
    expense_category: Union[Unset, "ActivityupdateFilesBodyDataExpenseCategory"] = UNSET
    matter: Union[Unset, "ActivityupdateFilesBodyDataMatter"] = UNSET
    matter_note: Union[Unset, "ActivityupdateFilesBodyDataMatterNote"] = UNSET
    ...
    task: Union[Unset, "ActivityupdateFilesBodyDataTask"] = UNSET
    tax_setting: Unset | ActivityupdateFilesBodyDataTaxSetting = UNSET
    text_message_conversation: Union[
        Unset, "ActivityupdateFilesBodyDataTextMessageConversation"
    ] = UNSET
    type_: Unset | ActivityupdateFilesBodyDataType = UNSET
    user: Union[Unset, "ActivityupdateFilesBodyDataUser"] = UNSET
    utbms_expense: Union[Unset, "ActivityupdateFilesBodyDataUtbmsExpense"] = UNSET
    vendor: Union[Unset, "ActivityupdateFilesBodyDataVendor"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_description: Unset | ActivityupdateFilesBodyDataActivityDescription
        if isinstance(_activity_description, Unset):
            activity_description = UNSET
        else:
            activity_description = (
                ActivityupdateFilesBodyDataActivityDescription.from_dict(
                    _activity_description
                )
            )

        _calendar_entry = d.pop("calendar_entry", UNSET)
        calendar_entry: Unset | ActivityupdateFilesBodyDataCalendarEntry
        if isinstance(_calendar_entry, Unset):
            calendar_entry = UNSET
        else:
            calendar_entry = ActivityupdateFilesBodyDataCalendarEntry.from_dict(
                _calendar_entry
            )

        _client_portal = d.pop("client_portal", UNSET)
        client_portal: Unset | ActivityupdateFilesBodyDataClientPortal
        if isinstance(_client_portal, Unset):
            client_portal = UNSET
        else:
            client_portal = ActivityupdateFilesBodyDataClientPortal.from_dict(
                _client_portal
            )

        _communication = d.pop("communication", UNSET)
        communication: Unset | ActivityupdateFilesBodyDataCommunication
        if isinstance(_communication, Unset):
            communication = UNSET
        else:
            communication = ActivityupdateFilesBodyDataCommunication.from_dict(
                _communication
            )

        _contact_note = d.pop("contact_note", UNSET)
        contact_note: Unset | ActivityupdateFilesBodyDataContactNote
        if isinstance(_contact_note, Unset):
            contact_note = UNSET
        else:
            contact_note = ActivityupdateFilesBodyDataContactNote.from_dict(
                _contact_note
            )
        ...
        expense_category: Unset | ActivityupdateFilesBodyDataExpenseCategory
        if isinstance(_expense_category, Unset):
            expense_category = UNSET
        else:
            expense_category = ActivityupdateFilesBodyDataExpenseCategory.from_dict(
                _expense_category
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ActivityupdateFilesBodyDataMatter
        if isinstance(_matter, Unset):
            matter = UNSET
        else:
            matter = ActivityupdateFilesBodyDataMatter.from_dict(_matter)

        _matter_note = d.pop("matter_note", UNSET)
        matter_note: Unset | ActivityupdateFilesBodyDataMatterNote
        if isinstance(_matter_note, Unset):
            matter_note = UNSET
        else:
            matter_note = ActivityupdateFilesBodyDataMatterNote.from_dict(_matter_note)
        ...
        task: Unset | ActivityupdateFilesBodyDataTask
        if isinstance(_task, Unset):
            task = UNSET
        else:
            task = ActivityupdateFilesBodyDataTask.from_dict(_task)

        _tax_setting = d.pop("tax_setting", UNSET)
        tax_setting: Unset | ActivityupdateFilesBodyDataTaxSetting
        if isinstance(_tax_setting, Unset):
            tax_setting = UNSET
        else:
            tax_setting = ActivityupdateFilesBodyDataTaxSetting(_tax_setting)
        ...
        if isinstance(_text_message_conversation, Unset):
            ...
            text_message_conversation = (
                ActivityupdateFilesBodyDataTextMessageConversation.from_dict(
                    _text_message_conversation
                )
            )

        _type_ = d.pop("type", UNSET)
        type_: Unset | ActivityupdateFilesBodyDataType
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = ActivityupdateFilesBodyDataType(_type_)

        _user = d.pop("user", UNSET)
        user: Unset | ActivityupdateFilesBodyDataUser
        if isinstance(_user, Unset):
            user = UNSET
        else:
            user = ActivityupdateFilesBodyDataUser.from_dict(_user)

        _utbms_expense = d.pop("utbms_expense", UNSET)
        utbms_expense: Unset | ActivityupdateFilesBodyDataUtbmsExpense
        if isinstance(_utbms_expense, Unset):
            utbms_expense = UNSET
        else:
            utbms_expense = ActivityupdateFilesBodyDataUtbmsExpense.from_dict(
                _utbms_expense
            )

        _vendor = d.pop("vendor", UNSET)
        vendor: Unset | ActivityupdateFilesBodyDataVendor
        if isinstance(_vendor, Unset):
            vendor = UNSET
        else:
            vendor = ActivityupdateFilesBodyDataVendor.from_dict(_vendor)

        activityupdate_files_body_data = cls(
        ...
        activityupdate_files_body_data.additional_properties = d
        return activityupdate_files_body_data
