...
class OutstandingClientBalance:
    ...
    outstanding_bills: Unset | list["BillBase"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        outstanding_bills: Unset | list[dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact: Unset | OutstandingClientBalanceContact
        ...
        currency: Unset | OutstandingClientBalanceCurrency
