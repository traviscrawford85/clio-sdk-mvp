...
T = TypeVar("T", bound="CalendarEntryCalendarOwner")


@_attrs_define
class CalendarEntryCalendarOwner:
    """
    Attributes:
    ...
    color: Unset | CalendarBaseColor = UNSET
    court_rules_default_calendar: Unset | bool = UNSET
    created_at: Unset | str = UNSET
    etag: Unset | str = UNSET
    id: Unset | int = UNSET
    light_color: Unset | CalendarBaseLightColor = UNSET
    name: Unset | str = UNSET
    permission: Unset | CalendarBasePermission = UNSET
    source: Unset | CalendarBaseSource = UNSET
    type_: Unset | CalendarBaseType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        light_color: Unset | CalendarBaseLightColor
        ...
        permission: Unset | CalendarBasePermission
        ...
        source: Unset | CalendarBaseSource
        ...
        calendar_entry_calendar_owner = cls(
            color=color,
        ...
        calendar_entry_calendar_owner.additional_properties = d
        return calendar_entry_calendar_owner
