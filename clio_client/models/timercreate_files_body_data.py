...
@_attrs_define
class TimercreateFilesBodyData:
    """
    Attributes:
        activity (TimercreateFilesBodyDataActivity):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        timercreate_files_body_data = cls(
            activity=activity,
        )

        timercreate_files_body_data.additional_properties = d
        return timercreate_files_body_data
