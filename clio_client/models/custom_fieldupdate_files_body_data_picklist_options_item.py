...
T = TypeVar("T", bound="CustomFieldupdateFilesBodyDataPicklistOptionsItem")


@_attrs_define
class CustomFieldupdateFilesBodyDataPicklistOptionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_fieldupdate_files_body_data_picklist_options_item = cls(
            field_deleted=field_deleted,
            id=id,
            option=option,
        )

        custom_fieldupdate_files_body_data_picklist_options_item.additional_properties = d
        return custom_fieldupdate_files_body_data_picklist_options_item
