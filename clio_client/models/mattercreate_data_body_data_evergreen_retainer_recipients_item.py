...
T = TypeVar("T", bound="MattercreateDataBodyDataEvergreenRetainerRecipientsItem")


@_attrs_define
class MattercreateDataBodyDataEvergreenRetainerRecipientsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mattercreate_data_body_data_evergreen_retainer_recipients_item = cls(
            field_destroy=field_destroy,
            id=id,
        )

        mattercreate_data_body_data_evergreen_retainer_recipients_item.additional_properties = d
        return mattercreate_data_body_data_evergreen_retainer_recipients_item
