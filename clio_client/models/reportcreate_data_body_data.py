...
class ReportcreateDataBodyData:
    ...
    originating_attorney: Union[
        Unset, "ReportcreateDataBodyDataOriginatingAttorney"
    ] = UNSET
    practice_area: Union[Unset, "ReportcreateDataBodyDataPracticeArea"] = UNSET
    responsible_attorney: Union[
        Unset, "ReportcreateDataBodyDataResponsibleAttorney"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        client: Unset | ReportcreateDataBodyDataClient
        ...
        matter: Unset | ReportcreateDataBodyDataMatter
        ...
        originating_attorney: Unset | ReportcreateDataBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                ReportcreateDataBodyDataOriginatingAttorney.from_dict(
                    _originating_attorney
                )
            )

        _practice_area = d.pop("practice_area", UNSET)
        practice_area: Unset | ReportcreateDataBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = ReportcreateDataBodyDataPracticeArea.from_dict(
                _practice_area
            )

        _responsible_attorney = d.pop("responsible_attorney", UNSET)
        responsible_attorney: Unset | ReportcreateDataBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                ReportcreateDataBodyDataResponsibleAttorney.from_dict(
        ...
        user: Unset | ReportcreateDataBodyDataUser
