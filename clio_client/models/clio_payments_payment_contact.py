...
T = TypeVar("T", bound="ClioPaymentsPaymentContact")


@_attrs_define
class ClioPaymentsPaymentContact:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_payment_contact = cls(
        ...
        clio_payments_payment_contact.additional_properties = d
        return clio_payments_payment_contact
