...
@_attrs_define
class DocumentcopyFilesBodyDataParent:
    """
    Attributes:
        id (int): The unique identifier of the parent object.
        type_ (DocumentcopyFilesBodyDataParentType): Type of parent object:
    ...
    id: int
    type_: DocumentcopyFilesBodyDataParentType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DocumentcopyFilesBodyDataParentType(d.pop("type"))

        documentcopy_files_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        documentcopy_files_body_data_parent.additional_properties = d
        return documentcopy_files_body_data_parent
