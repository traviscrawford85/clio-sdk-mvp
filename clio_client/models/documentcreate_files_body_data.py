...
class DocumentcreateFilesBodyData:
    ...
    external_properties: (
        Unset | list["DocumentcreateFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    filename: Unset | str = "name"
    multiparts: Unset | list["DocumentcreateFilesBodyDataMultipartsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentcreateFilesBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentcreateFilesBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                DocumentcreateFilesBodyDataExternalPropertiesItem.from_dict(
        ...
        for multiparts_item_data in _multiparts or []:
            multiparts_item = DocumentcreateFilesBodyDataMultipartsItem.from_dict(
