...
@_attrs_define
class CommentcreateFilesBodyData:
    """
    Attributes:
        item (CommentcreateFilesBodyDataItem):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        commentcreate_files_body_data = cls(
            item=item,
            message=message,
        )

        commentcreate_files_body_data.additional_properties = d
        return commentcreate_files_body_data
