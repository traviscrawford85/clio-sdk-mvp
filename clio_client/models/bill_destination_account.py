...
T = TypeVar("T", bound="BillDestinationAccount")


@_attrs_define
class BillDestinationAccount:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bill_destination_account.additional_properties = d
        return bill_destination_account
