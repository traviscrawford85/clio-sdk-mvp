...
T = TypeVar("T", bound="TextSnippetcreateJsonBodyData")


@_attrs_define
class TextSnippetcreateJsonBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_snippetcreate_json_body_data = cls(
            phrase=phrase,
            snippet=snippet,
            whole_word=whole_word,
        )

        text_snippetcreate_json_body_data.additional_properties = d
        return text_snippetcreate_json_body_data
