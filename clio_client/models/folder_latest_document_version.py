...
T = TypeVar("T", bound="FolderLatestDocumentVersion")


@_attrs_define
class FolderLatestDocumentVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        folder_latest_document_version = cls(
        ...
        folder_latest_document_version.additional_properties = d
        return folder_latest_document_version
