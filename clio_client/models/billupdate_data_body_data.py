...
class BillupdateDataBodyData:
    ...
    state: Unset | BillupdateDataBodyDataState = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bill_theme: Unset | BillupdateDataBodyDataBillTheme
        ...
        discount: Unset | BillupdateDataBodyDataDiscount
        ...
        interest: Unset | BillupdateDataBodyDataInterest
        ...
        state: Unset | BillupdateDataBodyDataState
