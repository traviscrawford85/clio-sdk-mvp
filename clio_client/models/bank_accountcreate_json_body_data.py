...
@_attrs_define
class BankAccountcreateJsonBodyData:
    """
    Attributes:
        currency (str): Currency the BankAccount is in.
        type_ (BankAccountcreateJsonBodyDataType): Type of BankAccount.
    ...
    currency: str
    type_: BankAccountcreateJsonBodyDataType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = BankAccountcreateJsonBodyDataType(d.pop("type"))
        ...
        bank_accountcreate_json_body_data = cls(
            currency=currency,
            type_=type_,
        ...
        bank_accountcreate_json_body_data.additional_properties = d
        return bank_accountcreate_json_body_data
