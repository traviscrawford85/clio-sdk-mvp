...
T = TypeVar("T", bound="BankTransactionBankAccount")


@_attrs_define
class BankTransactionBankAccount:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_transaction_bank_account = cls(
        ...
        bank_transaction_bank_account.additional_properties = d
        return bank_transaction_bank_account
