...
from ..models.folderupdate_data_body_data_parent_type import (
...
class FolderupdateDataBodyDataParent:
    ...
    id: Unset | int = UNSET
    type_: Unset | FolderupdateDataBodyDataParentType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | FolderupdateDataBodyDataParentType
