...
@_attrs_define
class DocumentupdateDataBodyData:
    """
    Attributes:
        ...
        document_category (Union[Unset, DocumentupdateDataBodyDataDocumentCategory]):
        external_properties (Union[Unset, list['DocumentupdateDataBodyDataExternalPropertiesItem']]):
        ...
        multiparts (Union[Unset, list['DocumentupdateDataBodyDataMultipartsItem']]):
        name (Union[Unset, str]): Document name.
        parent (Union[Unset, DocumentupdateDataBodyDataParent]):
    ...
    external_properties: (
        Unset | list["DocumentupdateDataBodyDataExternalPropertiesItem"]
    ) = UNSET
    fully_uploaded: Unset | bool = UNSET
    multiparts: Unset | list["DocumentupdateDataBodyDataMultipartsItem"] = UNSET
    name: Unset | str = UNSET
    parent: Union[Unset, "DocumentupdateDataBodyDataParent"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentupdateDataBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentupdateDataBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                DocumentupdateDataBodyDataExternalPropertiesItem.from_dict(
        ...
        for multiparts_item_data in _multiparts or []:
            multiparts_item = DocumentupdateDataBodyDataMultipartsItem.from_dict(
        ...
        parent: Unset | DocumentupdateDataBodyDataParent
        if isinstance(_parent, Unset):
            parent = UNSET
        else:
            parent = DocumentupdateDataBodyDataParent.from_dict(_parent)
        ...
        documentupdate_data_body_data = cls(
        ...
        documentupdate_data_body_data.additional_properties = d
        return documentupdate_data_body_data
