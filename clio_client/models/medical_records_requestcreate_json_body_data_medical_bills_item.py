...
class MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItem:
    ...
    payers: (
        Unset
        | list["MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItemPayersItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for payers_item_data in _payers or []:
            payers_item = MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItemPayersItem.from_dict(
                payers_item_data
            )
