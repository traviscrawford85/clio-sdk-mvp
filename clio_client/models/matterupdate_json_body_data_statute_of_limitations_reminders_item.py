...
if TYPE_CHECKING:
    from ..models.matterupdate_json_body_data_statute_of_limitations_reminders_item_notification_method import (
        MatterupdateJsonBodyDataStatuteOfLimitationsRemindersItemNotificationMethod,
    )


T = TypeVar("T", bound="MatterupdateJsonBodyDataStatuteOfLimitationsRemindersItem")


@_attrs_define
class MatterupdateJsonBodyDataStatuteOfLimitationsRemindersItem:
    """
    Attributes:
        ...
        notification_method (Union[Unset, MatterupdateJsonBodyDataStatuteOfLimitationsRemindersItemNotificationMethod]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_notification_method, Unset):
            ...
            notification_method = MatterupdateJsonBodyDataStatuteOfLimitationsRemindersItemNotificationMethod.from_dict(
                _notification_method
            )

        matterupdate_json_body_data_statute_of_limitations_reminders_item = cls(
        ...
        matterupdate_json_body_data_statute_of_limitations_reminders_item.additional_properties = d
        return matterupdate_json_body_data_statute_of_limitations_reminders_item
