...
from ..models.expense_categorycreate_files_body_data_entry_type import (
...
class ExpenseCategorycreateFilesBodyData:
    ...
    name: str
    entry_type: Unset | ExpenseCategorycreateFilesBodyDataEntryType = UNSET
    groups: Unset | list["ExpenseCategorycreateFilesBodyDataGroupsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entry_type: Unset | ExpenseCategorycreateFilesBodyDataEntryType
        ...
        for groups_item_data in _groups or []:
            groups_item = ExpenseCategorycreateFilesBodyDataGroupsItem.from_dict(
                groups_item_data
            )
        ...
        utbms_code: Unset | ExpenseCategorycreateFilesBodyDataUtbmsCode
        if isinstance(_utbms_code, Unset):
            utbms_code = UNSET
        else:
            utbms_code = ExpenseCategorycreateFilesBodyDataUtbmsCode.from_dict(
                _utbms_code
            )
