...
class TaskcreateFilesBodyData:
    ...
    cascading_offset_polarity: (
        Unset | TaskcreateFilesBodyDataCascadingOffsetPolarity
    ) = UNSET
    cascading_offset_type: Unset | TaskcreateFilesBodyDataCascadingOffsetType = UNSET
    ...
    permission: Unset | TaskcreateFilesBodyDataPermission = (
        TaskcreateFilesBodyDataPermission.PUBLIC
    )
    priority: Unset | TaskcreateFilesBodyDataPriority = (
        TaskcreateFilesBodyDataPriority.NORMAL
    )
    status: Unset | TaskcreateFilesBodyDataStatus = (
        TaskcreateFilesBodyDataStatus.PENDING
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = TaskcreateFilesBodyDataCascadingOffsetPolarity(
                _cascading_offset_polarity
            )

        _cascading_offset_type = d.pop("cascading_offset_type", UNSET)
        cascading_offset_type: Unset | TaskcreateFilesBodyDataCascadingOffsetType
        if isinstance(_cascading_offset_type, Unset):
            cascading_offset_type = UNSET
        else:
            cascading_offset_type = TaskcreateFilesBodyDataCascadingOffsetType(
        ...
        matter: Unset | TaskcreateFilesBodyDataMatter
        ...
        task_type: Unset | TaskcreateFilesBodyDataTaskType
