...
class TaskTemplatecreateDataBodyData:
    ...
    cascading_offset_polarity: (
        Unset | TaskTemplatecreateDataBodyDataCascadingOffsetPolarity
    ) = UNSET
    cascading_offset_type: Unset | TaskTemplatecreateDataBodyDataCascadingOffsetType = (
        UNSET
    )
    cascading_source: Union[Unset, "TaskTemplatecreateDataBodyDataCascadingSource"] = (
        UNSET
    ...
    priority: Unset | TaskTemplatecreateDataBodyDataPriority = (
        TaskTemplatecreateDataBodyDataPriority.NORMAL
    )
    private: Unset | bool = UNSET
    reminder_templates: (
        Unset | list["TaskTemplatecreateDataBodyDataReminderTemplatesItem"]
    ) = UNSET
    task_template_list: Union[
        Unset, "TaskTemplatecreateDataBodyDataTaskTemplateList"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = TaskTemplatecreateDataBodyDataCascadingOffsetType(
                _cascading_offset_type
            )

        _cascading_source = d.pop("cascading_source", UNSET)
        cascading_source: Unset | TaskTemplatecreateDataBodyDataCascadingSource
        if isinstance(_cascading_source, Unset):
            cascading_source = UNSET
        else:
            cascading_source = TaskTemplatecreateDataBodyDataCascadingSource.from_dict(
                _cascading_source
            )
        ...
        for reminder_templates_item_data in _reminder_templates or []:
            reminder_templates_item = (
                TaskTemplatecreateDataBodyDataReminderTemplatesItem.from_dict(
        ...
        task_template_list: Unset | TaskTemplatecreateDataBodyDataTaskTemplateList
        if isinstance(_task_template_list, Unset):
            task_template_list = UNSET
        else:
            task_template_list = (
                TaskTemplatecreateDataBodyDataTaskTemplateList.from_dict(
                    _task_template_list
                )
            )
