...
if TYPE_CHECKING:
    from ..models.relationshipcreate_data_body_data_contact import (
        RelationshipcreateDataBodyDataContact,
    )
    from ..models.relationshipcreate_data_body_data_matter import (
...
class RelationshipcreateDataBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact: Unset | RelationshipcreateDataBodyDataContact
        ...
        matter: Unset | RelationshipcreateDataBodyDataMatter
