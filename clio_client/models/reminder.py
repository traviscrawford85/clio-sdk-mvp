...
class Reminder:
    ...
    id: Unset | int = UNSET
    next_delivery_at: Unset | str = UNSET
    state: Unset | ReminderBaseState = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        subject: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        notification_method: Unset | ReminderNotificationMethod
        if isinstance(_notification_method, Unset):
            notification_method = UNSET
        else:
            notification_method = ReminderNotificationMethod.from_dict(
                _notification_method
            )

        _subject = d.pop("subject", UNSET)
        subject: Unset | ReminderSubject
