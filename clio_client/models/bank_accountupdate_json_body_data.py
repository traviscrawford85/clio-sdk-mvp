...
T = TypeVar("T", bound="BankAccountupdateJsonBodyData")


@_attrs_define
class BankAccountupdateJsonBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_accountupdate_json_body_data = cls(
        ...
        bank_accountupdate_json_body_data.additional_properties = d
        return bank_accountupdate_json_body_data
