...
from ..models.billupdate_data_body_data_discount_type import (
...
class BillupdateDataBodyDataDiscount:
    ...
    type_: Unset | BillupdateDataBodyDataDiscountType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | BillupdateDataBodyDataDiscountType
