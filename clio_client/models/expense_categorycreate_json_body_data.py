...
from ..models.expense_categorycreate_json_body_data_entry_type import (
...
if TYPE_CHECKING:
    ...
    from ..models.expense_categorycreate_json_body_data_utbms_code import (
...
class ExpenseCategorycreateJsonBodyData:
    ...
    name: str
    entry_type: Unset | ExpenseCategorycreateJsonBodyDataEntryType = UNSET
    groups: Unset | list["ExpenseCategorycreateJsonBodyDataGroupsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entry_type: Unset | ExpenseCategorycreateJsonBodyDataEntryType
        ...
        for groups_item_data in _groups or []:
            groups_item = ExpenseCategorycreateJsonBodyDataGroupsItem.from_dict(
                groups_item_data
            )
        ...
        utbms_code: Unset | ExpenseCategorycreateJsonBodyDataUtbmsCode
        if isinstance(_utbms_code, Unset):
            utbms_code = UNSET
        else:
            utbms_code = ExpenseCategorycreateJsonBodyDataUtbmsCode.from_dict(
                _utbms_code
            )
