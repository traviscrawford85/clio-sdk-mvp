...
class MatterupdateJsonBodyDataCustomRateRatesItem:
    ...
    activity_description: Union[
        Unset, "MatterupdateJsonBodyDataCustomRateRatesItemActivityDescription"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group: Unset | MatterupdateJsonBodyDataCustomRateRatesItemGroup
        ...
        user: Unset | MatterupdateJsonBodyDataCustomRateRatesItemUser
