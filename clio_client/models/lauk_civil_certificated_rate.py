...
T = TypeVar("T", bound="LaukCivilCertificatedRate")


@_attrs_define
class LaukCivilCertificatedRate:
    """
    Attributes:
    ...
    activity_sub_category: Unset | str = UNSET
    activity_type: Unset | str = UNSET
    attended_several_hearings_for_multiple_clients: Unset | bool = UNSET
    category_of_law: Unset | str = UNSET
    change_of_solicitor: Unset | bool = UNSET
    court: Unset | str = UNSET
    created_at: Unset | str = UNSET
    eligible_for_sqm: Unset | bool = UNSET
    etag: Unset | str = UNSET
    exceptional: Unset | float = UNSET
    exceptional_warning: Unset | str = UNSET
    fee: Unset | float = UNSET
    fee_scheme: Unset | str = UNSET
    first_conducting_solicitor: Unset | bool = UNSET
    id: Unset | int = UNSET
    key: Unset | str = UNSET
    number_of_clients: Unset | str = UNSET
    party: Unset | str = UNSET
    post_transfer_clients_represented: Unset | str = UNSET
    rate_type: Unset | str = UNSET
    region: Unset | str = UNSET
    session_type: Unset | str = UNSET
    updated_at: Unset | str = UNSET
    user_type: Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        attended_several_hearings_for_multiple_clients = (
            self.attended_several_hearings_for_multiple_clients
        )
        ...
        if post_transfer_clients_represented is not UNSET:
            field_dict["post_transfer_clients_represented"] = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attended_several_hearings_for_multiple_clients = d.pop(
            "attended_several_hearings_for_multiple_clients", UNSET
        )
        ...
        post_transfer_clients_represented = d.pop(
            "post_transfer_clients_represented", UNSET
        )
        ...
        lauk_civil_certificated_rate = cls(
            activity=activity,
        ...
        lauk_civil_certificated_rate.additional_properties = d
        return lauk_civil_certificated_rate
