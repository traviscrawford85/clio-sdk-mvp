...
T = TypeVar("T", bound="RelatedContactsAvatar")


@_attrs_define
class RelatedContactsAvatar:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_contacts_avatar.additional_properties = d
        return related_contacts_avatar
