...
class RelatedContacts:
    ...
    addresses: Unset | list["AddressBase"] = UNSET
    avatar: Union[Unset, "RelatedContactsAvatar"] = UNSET
    company: Union[Unset, "RelatedContactsCompany"] = UNSET
    custom_field_values: Unset | list["CustomFieldValueBase"] = UNSET
    email_addresses: Unset | list["EmailAddressBase"] = UNSET
    phone_numbers: Unset | list["PhoneNumberBase"] = UNSET
    ...
    web_sites: Unset | list["WebSiteBase"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        avatar: Unset | RelatedContactsAvatar
        ...
        company: Unset | RelatedContactsCompany
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = CustomFieldValueBase.from_dict(
        ...
        primary_address: Unset | RelatedContactsPrimaryAddress
        ...
        primary_web_site: Unset | RelatedContactsPrimaryWebSite
        if isinstance(_primary_web_site, Unset):
            primary_web_site = UNSET
        else:
            primary_web_site = RelatedContactsPrimaryWebSite.from_dict(
                _primary_web_site
            )

        _relationship = d.pop("relationship", UNSET)
        relationship: Unset | RelatedContactsRelationship
        ...
        secondary_address: Unset | RelatedContactsSecondaryAddress
        if isinstance(_secondary_address, Unset):
            secondary_address = UNSET
        else:
            secondary_address = RelatedContactsSecondaryAddress.from_dict(
                _secondary_address
            )

        _secondary_web_site = d.pop("secondary_web_site", UNSET)
        secondary_web_site: Unset | RelatedContactsSecondaryWebSite
        if isinstance(_secondary_web_site, Unset):
            secondary_web_site = UNSET
        else:
            secondary_web_site = RelatedContactsSecondaryWebSite.from_dict(
                _secondary_web_site
            )
