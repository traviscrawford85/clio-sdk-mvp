...
@_attrs_define
class CalendarEntryupdateDataBodyData:
    """
    Attributes:
        field_deleted (Union[Unset, CalendarEntryupdateDataBodyDataDeleted]): Flag to delete a specific instance of a
            recurring event.
        all_day (Union[Unset, bool]): Whether or not the CalendarEntry is for all day.
        attendees (Union[Unset, list['CalendarEntryupdateDataBodyDataAttendeesItem']]):
        calendar_entry_event_type (Union[Unset, CalendarEntryupdateDataBodyDataCalendarEntryEventType]):
        calendar_owner (Union[Unset, CalendarEntryupdateDataBodyDataCalendarOwner]):
        conference_meeting (Union[Unset, CalendarEntryupdateDataBodyDataConferenceMeeting]):
        ...
        external_properties (Union[Unset, list['CalendarEntryupdateDataBodyDataExternalPropertiesItem']]):
        location (Union[Unset, str]): The geographic location of the CalendarEntry.
        matter (Union[Unset, CalendarEntryupdateDataBodyDataMatter]):
    ...
    field_deleted: Unset | CalendarEntryupdateDataBodyDataDeleted = UNSET
    all_day: Unset | bool = UNSET
    attendees: Unset | list["CalendarEntryupdateDataBodyDataAttendeesItem"] = UNSET
    calendar_entry_event_type: Union[
        Unset, "CalendarEntryupdateDataBodyDataCalendarEntryEventType"
    ] = UNSET
    calendar_owner: Union[Unset, "CalendarEntryupdateDataBodyDataCalendarOwner"] = UNSET
    conference_meeting: Union[
        Unset, "CalendarEntryupdateDataBodyDataConferenceMeeting"
    ] = UNSET
    description: Unset | str = UNSET
    end_at: Unset | str = UNSET
    external_properties: (
        Unset | list["CalendarEntryupdateDataBodyDataExternalPropertiesItem"]
    ) = UNSET
    location: Unset | str = UNSET
    matter: Union[Unset, "CalendarEntryupdateDataBodyDataMatter"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_deleted: Unset | CalendarEntryupdateDataBodyDataDeleted
        if isinstance(_field_deleted, Unset):
            field_deleted = UNSET
        else:
            field_deleted = CalendarEntryupdateDataBodyDataDeleted(_field_deleted)
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntryupdateDataBodyDataAttendeesItem.from_dict(
                attendees_item_data
            )
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = (
                CalendarEntryupdateDataBodyDataCalendarEntryEventType.from_dict(
                    _calendar_entry_event_type
                )
            )

        _calendar_owner = d.pop("calendar_owner", UNSET)
        calendar_owner: Unset | CalendarEntryupdateDataBodyDataCalendarOwner
        if isinstance(_calendar_owner, Unset):
            calendar_owner = UNSET
        else:
            calendar_owner = CalendarEntryupdateDataBodyDataCalendarOwner.from_dict(
                _calendar_owner
            )

        _conference_meeting = d.pop("conference_meeting", UNSET)
        conference_meeting: Unset | CalendarEntryupdateDataBodyDataConferenceMeeting
        if isinstance(_conference_meeting, Unset):
            conference_meeting = UNSET
        else:
            conference_meeting = (
                CalendarEntryupdateDataBodyDataConferenceMeeting.from_dict(
                    _conference_meeting
                )
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CalendarEntryupdateDataBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CalendarEntryupdateDataBodyDataMatter
        if isinstance(_matter, Unset):
            matter = UNSET
        else:
            matter = CalendarEntryupdateDataBodyDataMatter.from_dict(_matter)
        ...
        calendar_entryupdate_data_body_data = cls(
        ...
        calendar_entryupdate_data_body_data.additional_properties = d
        return calendar_entryupdate_data_body_data
