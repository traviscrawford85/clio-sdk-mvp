...
T = TypeVar("T", bound="OutstandingClientBalanceContact")


@_attrs_define
class OutstandingClientBalanceContact:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        outstanding_client_balance_contact = cls(
        ...
        outstanding_client_balance_contact.additional_properties = d
        return outstanding_client_balance_contact
