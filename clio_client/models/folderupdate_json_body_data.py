...
if TYPE_CHECKING:
    from ..models.folderupdate_json_body_data_document_category import (
        FolderupdateJsonBodyDataDocumentCategory,
    )
    from ..models.folderupdate_json_body_data_external_properties_item import (
        FolderupdateJsonBodyDataExternalPropertiesItem,
    )
    from ..models.folderupdate_json_body_data_parent import (
        FolderupdateJsonBodyDataParent,
    )


T = TypeVar("T", bound="FolderupdateJsonBodyData")


@_attrs_define
class FolderupdateJsonBodyData:
    """
    Attributes:
        document_category (Union[Unset, FolderupdateJsonBodyDataDocumentCategory]):
        external_properties (Union[Unset, list['FolderupdateJsonBodyDataExternalPropertiesItem']]):
        name (Union[Unset, str]): Name of the Folder
        parent (Union[Unset, FolderupdateJsonBodyDataParent]):
        restore (Union[Unset, bool]): Whether or not a trashed Folder should be restored.
    """

    document_category: Union[Unset, "FolderupdateJsonBodyDataDocumentCategory"] = UNSET
    external_properties: (
        Unset | list["FolderupdateJsonBodyDataExternalPropertiesItem"]
    ) = UNSET
    name: Unset | str = UNSET
    parent: Union[Unset, "FolderupdateJsonBodyDataParent"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | FolderupdateJsonBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = FolderupdateJsonBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                FolderupdateJsonBodyDataExternalPropertiesItem.from_dict(
        ...
        parent: Unset | FolderupdateJsonBodyDataParent
        if isinstance(_parent, Unset):
            parent = UNSET
        else:
            parent = FolderupdateJsonBodyDataParent.from_dict(_parent)

        restore = d.pop("restore", UNSET)

        folderupdate_json_body_data = cls(
        ...
        folderupdate_json_body_data.additional_properties = d
        return folderupdate_json_body_data
