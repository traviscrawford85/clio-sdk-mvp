...
T = TypeVar("T", bound="BillThemeupdateJsonBodyData")


@_attrs_define
class BillThemeupdateJsonBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bill_themeupdate_json_body_data = cls(
            config=config,
            name=name,
        )

        bill_themeupdate_json_body_data.additional_properties = d
        return bill_themeupdate_json_body_data
