...
T = TypeVar("T", bound="LineItemDiscount")
...
class LineItemDiscount:
    ...
    early_payment_period: Unset | int = UNSET
    early_payment_rate: Unset | int = UNSET
    note: Unset | str = UNSET
    rate: Unset | float = UNSET
    type_: Unset | DiscountBaseType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | DiscountBaseType
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = DiscountBaseType(_type_)

        line_item_discount = cls(
        ...
        line_item_discount.additional_properties = d
        return line_item_discount
