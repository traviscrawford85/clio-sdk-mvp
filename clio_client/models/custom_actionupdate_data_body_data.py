...
from ..models.custom_actionupdate_data_body_data_ui_reference import (
...
class CustomActionupdateDataBodyData:
    ...
    ui_reference: Unset | CustomActionupdateDataBodyDataUiReference = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ui_reference: Unset | CustomActionupdateDataBodyDataUiReference
