...
class ExpenseCategorycreateDataBodyData:
    ...
    name: str
    entry_type: Unset | ExpenseCategorycreateDataBodyDataEntryType = UNSET
    groups: Unset | list["ExpenseCategorycreateDataBodyDataGroupsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entry_type: Unset | ExpenseCategorycreateDataBodyDataEntryType
        ...
        for groups_item_data in _groups or []:
            groups_item = ExpenseCategorycreateDataBodyDataGroupsItem.from_dict(
                groups_item_data
            )
        ...
        utbms_code: Unset | ExpenseCategorycreateDataBodyDataUtbmsCode
        if isinstance(_utbms_code, Unset):
            utbms_code = UNSET
        else:
            utbms_code = ExpenseCategorycreateDataBodyDataUtbmsCode.from_dict(
                _utbms_code
            )
