...
@_attrs_define
class ActivityDescriptionupdateDataBodyDataRate:
    """
    Attributes:
        ...
        type_ (Union[Unset, ActivityDescriptionupdateDataBodyDataRateType]): What kind of rate it will be.
    """

    amount: Unset | float = 0.0
    non_billable_amount: Unset | float = 0.0
    type_: Unset | ActivityDescriptionupdateDataBodyDataRateType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | ActivityDescriptionupdateDataBodyDataRateType
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = ActivityDescriptionupdateDataBodyDataRateType(_type_)

        activity_descriptionupdate_data_body_data_rate = cls(
            amount=amount,
            non_billable_amount=non_billable_amount,
            type_=type_,
        )

        activity_descriptionupdate_data_body_data_rate.additional_properties = d
        return activity_descriptionupdate_data_body_data_rate
