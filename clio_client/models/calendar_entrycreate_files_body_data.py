...
class CalendarEntrycreateFilesBodyData:
    ...
    start_at: str
    summary: str
    field_deleted: Unset | CalendarEntrycreateFilesBodyDataDeleted = UNSET
    all_day: Unset | bool = UNSET
    attendees: Unset | list["CalendarEntrycreateFilesBodyDataAttendeesItem"] = UNSET
    calendar_entry_event_type: Union[
        Unset, "CalendarEntrycreateFilesBodyDataCalendarEntryEventType"
    ] = UNSET
    conference_meeting: Union[
        Unset, "CalendarEntrycreateFilesBodyDataConferenceMeeting"
    ] = UNSET
    description: Unset | str = UNSET
    external_properties: (
        Unset | list["CalendarEntrycreateFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        calendar_owner = CalendarEntrycreateFilesBodyDataCalendarOwner.from_dict(
        ...
        field_deleted: Unset | CalendarEntrycreateFilesBodyDataDeleted
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntrycreateFilesBodyDataAttendeesItem.from_dict(
                attendees_item_data
            )
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = (
                CalendarEntrycreateFilesBodyDataCalendarEntryEventType.from_dict(
                    _calendar_entry_event_type
                )
            )

        _conference_meeting = d.pop("conference_meeting", UNSET)
        conference_meeting: Unset | CalendarEntrycreateFilesBodyDataConferenceMeeting
        if isinstance(_conference_meeting, Unset):
            conference_meeting = UNSET
        else:
            conference_meeting = (
                CalendarEntrycreateFilesBodyDataConferenceMeeting.from_dict(
                    _conference_meeting
                )
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CalendarEntrycreateFilesBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CalendarEntrycreateFilesBodyDataMatter
