...
T = TypeVar("T", bound="DocumentcreateJsonBodyDataMultipartsItem")


@_attrs_define
class DocumentcreateJsonBodyDataMultipartsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documentcreate_json_body_data_multiparts_item = cls(
            content_length=content_length,
            part_number=part_number,
            content_md5=content_md5,
        )

        documentcreate_json_body_data_multiparts_item.additional_properties = d
        return documentcreate_json_body_data_multiparts_item
