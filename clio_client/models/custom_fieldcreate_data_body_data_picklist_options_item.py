...
T = TypeVar("T", bound="CustomFieldcreateDataBodyDataPicklistOptionsItem")


@_attrs_define
class CustomFieldcreateDataBodyDataPicklistOptionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_fieldcreate_data_body_data_picklist_options_item = cls(
            field_deleted=field_deleted,
            id=id,
            option=option,
        )

        custom_fieldcreate_data_body_data_picklist_options_item.additional_properties = d
        return custom_fieldcreate_data_body_data_picklist_options_item
