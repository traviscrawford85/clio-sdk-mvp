...
if TYPE_CHECKING:
    from ..models.documentupdate_files_body_data_document_category import (
        DocumentupdateFilesBodyDataDocumentCategory,
    )
    from ..models.documentupdate_files_body_data_external_properties_item import (
        DocumentupdateFilesBodyDataExternalPropertiesItem,
    )
    from ..models.documentupdate_files_body_data_multiparts_item import (
        DocumentupdateFilesBodyDataMultipartsItem,
    )
    from ..models.documentupdate_files_body_data_parent import (
        DocumentupdateFilesBodyDataParent,
    )


T = TypeVar("T", bound="DocumentupdateFilesBodyData")


@_attrs_define
class DocumentupdateFilesBodyData:
    """
    Attributes:
        ...
        document_category (Union[Unset, DocumentupdateFilesBodyDataDocumentCategory]):
        external_properties (Union[Unset, list['DocumentupdateFilesBodyDataExternalPropertiesItem']]):
        ...
        multiparts (Union[Unset, list['DocumentupdateFilesBodyDataMultipartsItem']]):
        name (Union[Unset, str]): Document name.
        parent (Union[Unset, DocumentupdateFilesBodyDataParent]):
    ...
    copy_version: Unset | bool = UNSET
    document_category: Union[Unset, "DocumentupdateFilesBodyDataDocumentCategory"] = (
        UNSET
    )
    external_properties: (
        Unset | list["DocumentupdateFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    fully_uploaded: Unset | bool = UNSET
    multiparts: Unset | list["DocumentupdateFilesBodyDataMultipartsItem"] = UNSET
    name: Unset | str = UNSET
    parent: Union[Unset, "DocumentupdateFilesBodyDataParent"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        multiparts: Unset | list[dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentupdateFilesBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentupdateFilesBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                DocumentupdateFilesBodyDataExternalPropertiesItem.from_dict(
        ...
        for multiparts_item_data in _multiparts or []:
            multiparts_item = DocumentupdateFilesBodyDataMultipartsItem.from_dict(
                multiparts_item_data
            )
        ...
        parent: Unset | DocumentupdateFilesBodyDataParent
        if isinstance(_parent, Unset):
            parent = UNSET
        else:
            parent = DocumentupdateFilesBodyDataParent.from_dict(_parent)
        ...
        documentupdate_files_body_data = cls(
        ...
        documentupdate_files_body_data.additional_properties = d
        return documentupdate_files_body_data
