...
from ..models.task_templateupdate_files_body_data_priority import (
...
class TaskTemplateupdateFilesBodyData:
    ...
    cascading_offset_polarity: (
        Unset | TaskTemplateupdateFilesBodyDataCascadingOffsetPolarity
    ) = UNSET
    cascading_offset_type: (
        Unset | TaskTemplateupdateFilesBodyDataCascadingOffsetType
    ) = UNSET
    cascading_source: Union[Unset, "TaskTemplateupdateFilesBodyDataCascadingSource"] = (
        UNSET
    )
    ...
    priority: Unset | TaskTemplateupdateFilesBodyDataPriority = (
        TaskTemplateupdateFilesBodyDataPriority.NORMAL
    )
    private: Unset | bool = UNSET
    reminder_templates: (
        Unset | list["TaskTemplateupdateFilesBodyDataReminderTemplatesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = TaskTemplateupdateFilesBodyDataCascadingOffsetType(
                _cascading_offset_type
            )

        _cascading_source = d.pop("cascading_source", UNSET)
        cascading_source: Unset | TaskTemplateupdateFilesBodyDataCascadingSource
        if isinstance(_cascading_source, Unset):
            cascading_source = UNSET
        else:
            cascading_source = TaskTemplateupdateFilesBodyDataCascadingSource.from_dict(
                _cascading_source
            )
        ...
        for reminder_templates_item_data in _reminder_templates or []:
            reminder_templates_item = (
                TaskTemplateupdateFilesBodyDataReminderTemplatesItem.from_dict(
