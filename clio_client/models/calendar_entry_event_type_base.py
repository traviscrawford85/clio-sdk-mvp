...
T = TypeVar("T", bound="CalendarEntryEventTypeBase")


@_attrs_define
class CalendarEntryEventTypeBase:
    """
    Attributes:
    ...
    color: Unset | CalendarEntryEventTypeBaseColor = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: Unset | CalendarEntryEventTypeBaseColor
        ...
        calendar_entry_event_type_base = cls(
            color=color,
        ...
        calendar_entry_event_type_base.additional_properties = d
        return calendar_entry_event_type_base
