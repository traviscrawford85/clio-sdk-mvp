...
from ..models.billupdate_json_body_data_discount_type import (
...
class BillupdateJsonBodyDataDiscount:
    ...
    type_: Unset | BillupdateJsonBodyDataDiscountType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | BillupdateJsonBodyDataDiscountType
