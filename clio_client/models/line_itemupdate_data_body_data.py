...
class LineItemupdateDataBodyData:
    ...
    kind: Unset | LineItemupdateDataBodyDataKind = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity: Unset | LineItemupdateDataBodyDataActivity
        ...
        bill: Unset | LineItemupdateDataBodyDataBill
        ...
        discount: Unset | LineItemupdateDataBodyDataDiscount
        ...
        kind: Unset | LineItemupdateDataBodyDataKind
        ...
        matter: Unset | LineItemupdateDataBodyDataMatter
