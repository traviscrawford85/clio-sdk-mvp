...
T = TypeVar("T", bound="CalendarEntrycreateDataBodyDataAttendeesItem")


@_attrs_define
class CalendarEntrycreateDataBodyDataAttendeesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calendar_entrycreate_data_body_data_attendees_item = cls(
            field_destroy=field_destroy,
            id=id,
            type_=type_,
        )

        calendar_entrycreate_data_body_data_attendees_item.additional_properties = d
        return calendar_entrycreate_data_body_data_attendees_item
