...
from ..models.taskcreate_data_body_data_cascading_offset_polarity import (
    TaskcreateDataBodyDataCascadingOffsetPolarity,
)
from ..models.taskcreate_data_body_data_cascading_offset_type import (
    TaskcreateDataBodyDataCascadingOffsetType,
)
from ..models.taskcreate_data_body_data_permission import (
...
class TaskcreateDataBodyData:
    ...
    cascading_offset_polarity: Unset | TaskcreateDataBodyDataCascadingOffsetPolarity = (
        UNSET
    )
    cascading_offset_type: Unset | TaskcreateDataBodyDataCascadingOffsetType = UNSET
    ...
    permission: Unset | TaskcreateDataBodyDataPermission = (
        TaskcreateDataBodyDataPermission.PUBLIC
    )
    priority: Unset | TaskcreateDataBodyDataPriority = (
        TaskcreateDataBodyDataPriority.NORMAL
    )
    status: Unset | TaskcreateDataBodyDataStatus = TaskcreateDataBodyDataStatus.PENDING
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.taskcreate_data_body_data_matter import (
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = TaskcreateDataBodyDataCascadingOffsetPolarity(
                _cascading_offset_polarity
            )

        _cascading_offset_type = d.pop("cascading_offset_type", UNSET)
        cascading_offset_type: Unset | TaskcreateDataBodyDataCascadingOffsetType
        if isinstance(_cascading_offset_type, Unset):
            cascading_offset_type = UNSET
        else:
            cascading_offset_type = TaskcreateDataBodyDataCascadingOffsetType(
        ...
        matter: Unset | TaskcreateDataBodyDataMatter
        ...
        status: Unset | TaskcreateDataBodyDataStatus
        ...
        task_type: Unset | TaskcreateDataBodyDataTaskType
