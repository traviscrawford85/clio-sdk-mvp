...
class ClioPaymentsPayment:
    ...
    confirmation_number: Unset | str = UNSET
    created_at: Unset | str = UNSET
    currency: Unset | str = UNSET
    deposit_as_revenue: Unset | bool = UNSET
    description: Unset | str = UNSET
    email_address: Unset | str = UNSET
    id: Unset | int = UNSET
    state: Unset | ClioPaymentsPaymentBaseState = UNSET
    updated_at: Unset | str = UNSET
    allocations: Unset | list["AllocationBase"] = UNSET
    bank_transaction: Union[Unset, "ClioPaymentsPaymentBankTransaction"] = UNSET
    bills: Unset | list["BillBase"] = UNSET
    ...
    matters: Unset | list["MatterBase"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        allocations: Unset | list[dict[str, Any]] = UNSET
        ...
        clio_payments_link: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state: Unset | ClioPaymentsPaymentBaseState
        ...
        bank_transaction: Unset | ClioPaymentsPaymentBankTransaction
        if isinstance(_bank_transaction, Unset):
            bank_transaction = UNSET
        else:
            bank_transaction = ClioPaymentsPaymentBankTransaction.from_dict(
                _bank_transaction
            )
        ...
        clio_payments_link: Unset | ClioPaymentsPaymentClioPaymentsLink
        if isinstance(_clio_payments_link, Unset):
            clio_payments_link = UNSET
        else:
            clio_payments_link = ClioPaymentsPaymentClioPaymentsLink.from_dict(
                _clio_payments_link
            )

        _contact = d.pop("contact", UNSET)
        contact: Unset | ClioPaymentsPaymentContact
        ...
        destination_account: Unset | ClioPaymentsPaymentDestinationAccount
        if isinstance(_destination_account, Unset):
            destination_account = UNSET
        else:
            destination_account = ClioPaymentsPaymentDestinationAccount.from_dict(
        ...
        user: Unset | ClioPaymentsPaymentUser
