...
from ..models.calendar_entrycreate_json_body_data_deleted import (
...
if TYPE_CHECKING:
    ...
    from ..models.calendar_entrycreate_json_body_data_matter import (
...
class CalendarEntrycreateJsonBodyData:
    ...
    start_at: str
    summary: str
    field_deleted: Unset | CalendarEntrycreateJsonBodyDataDeleted = UNSET
    all_day: Unset | bool = UNSET
    attendees: Unset | list["CalendarEntrycreateJsonBodyDataAttendeesItem"] = UNSET
    calendar_entry_event_type: Union[
        Unset, "CalendarEntrycreateJsonBodyDataCalendarEntryEventType"
    ] = UNSET
    conference_meeting: Union[
        Unset, "CalendarEntrycreateJsonBodyDataConferenceMeeting"
    ] = UNSET
    description: Unset | str = UNSET
    external_properties: (
        Unset | list["CalendarEntrycreateJsonBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        calendar_owner = CalendarEntrycreateJsonBodyDataCalendarOwner.from_dict(
        ...
        field_deleted: Unset | CalendarEntrycreateJsonBodyDataDeleted
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntrycreateJsonBodyDataAttendeesItem.from_dict(
                attendees_item_data
            )
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = (
                CalendarEntrycreateJsonBodyDataCalendarEntryEventType.from_dict(
                    _calendar_entry_event_type
                )
            )

        _conference_meeting = d.pop("conference_meeting", UNSET)
        conference_meeting: Unset | CalendarEntrycreateJsonBodyDataConferenceMeeting
        if isinstance(_conference_meeting, Unset):
            conference_meeting = UNSET
        else:
            conference_meeting = (
                CalendarEntrycreateJsonBodyDataConferenceMeeting.from_dict(
                    _conference_meeting
                )
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CalendarEntrycreateJsonBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CalendarEntrycreateJsonBodyDataMatter
