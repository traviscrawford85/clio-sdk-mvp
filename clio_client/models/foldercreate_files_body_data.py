...
if TYPE_CHECKING:
    from ..models.foldercreate_files_body_data_document_category import (
    ...
    from ..models.foldercreate_files_body_data_parent import (
...
class FoldercreateFilesBodyData:
    ...
    external_properties: (
        Unset | list["FoldercreateFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | FoldercreateFilesBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = FoldercreateFilesBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                FoldercreateFilesBodyDataExternalPropertiesItem.from_dict(
