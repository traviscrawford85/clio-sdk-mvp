...
from ..models.calendar_entry_event_typeupdate_json_body_data_color import (
...
class CalendarEntryEventTypeupdateJsonBodyData:
    ...
    color: Unset | CalendarEntryEventTypeupdateJsonBodyDataColor = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: Unset | CalendarEntryEventTypeupdateJsonBodyDataColor
