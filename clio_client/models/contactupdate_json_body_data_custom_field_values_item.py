...
class ContactupdateJsonBodyDataCustomFieldValuesItem:
    ...
    custom_field: Union[
        Unset, "ContactupdateJsonBodyDataCustomFieldValuesItemCustomField"
    ] = UNSET
    id: Unset | int = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field: Unset | ContactupdateJsonBodyDataCustomFieldValuesItemCustomField
        if isinstance(_custom_field, Unset):
            custom_field = UNSET
        else:
            custom_field = (
                ContactupdateJsonBodyDataCustomFieldValuesItemCustomField.from_dict(
                    _custom_field
                )
            )
