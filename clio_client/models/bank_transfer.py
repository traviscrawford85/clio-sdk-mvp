...
class BankTransfer:
    ...
    id: Unset | int = UNSET
    primary_authorizer: Unset | str = UNSET
    secondary_authorizer: Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        source_account: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        client: Unset | BankTransferClient
        ...
        destination_account: Unset | BankTransferDestinationAccount
        if isinstance(_destination_account, Unset):
            destination_account = UNSET
        else:
            destination_account = BankTransferDestinationAccount.from_dict(
                _destination_account
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | BankTransferMatter
        ...
        source_account: Unset | BankTransferSourceAccount
