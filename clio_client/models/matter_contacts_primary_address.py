...
T = TypeVar("T", bound="MatterContactsPrimaryAddress")


@_attrs_define
class MatterContactsPrimaryAddress:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_contacts_primary_address = cls(
            city=city,
            country=country,
        ...
        matter_contacts_primary_address.additional_properties = d
        return matter_contacts_primary_address
