...
@_attrs_define
class CommentcreateJsonBodyData:
    """
    Attributes:
        item (CommentcreateJsonBodyDataItem):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        commentcreate_json_body_data = cls(
            item=item,
            message=message,
        )

        commentcreate_json_body_data.additional_properties = d
        return commentcreate_json_body_data
