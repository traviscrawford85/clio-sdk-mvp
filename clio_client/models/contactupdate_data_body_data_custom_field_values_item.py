...
if TYPE_CHECKING:
    from ..models.contactupdate_data_body_data_custom_field_values_item_custom_field import (
        ContactupdateDataBodyDataCustomFieldValuesItemCustomField,
    )


T = TypeVar("T", bound="ContactupdateDataBodyDataCustomFieldValuesItem")


@_attrs_define
class ContactupdateDataBodyDataCustomFieldValuesItem:
    """
    Attributes:
        ...
        custom_field (Union[Unset, ContactupdateDataBodyDataCustomFieldValuesItemCustomField]):
    ...
    custom_field: Union[
        Unset, "ContactupdateDataBodyDataCustomFieldValuesItemCustomField"
    ] = UNSET
    id: Unset | int = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field: Unset | ContactupdateDataBodyDataCustomFieldValuesItemCustomField
        if isinstance(_custom_field, Unset):
            custom_field = UNSET
        else:
            custom_field = (
                ContactupdateDataBodyDataCustomFieldValuesItemCustomField.from_dict(
                    _custom_field
                )
            )
        ...
        contactupdate_data_body_data_custom_field_values_item = cls(
        ...
        contactupdate_data_body_data_custom_field_values_item.additional_properties = d
        return contactupdate_data_body_data_custom_field_values_item
