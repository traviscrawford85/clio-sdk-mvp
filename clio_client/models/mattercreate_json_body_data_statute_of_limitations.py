...
class MattercreateJsonBodyDataStatuteOfLimitations:
    ...
    reminders: (
        Unset | list["MattercreateJsonBodyDataStatuteOfLimitationsRemindersItem"]
    ) = UNSET
    status: Unset | MattercreateJsonBodyDataStatuteOfLimitationsStatus = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for reminders_item_data in _reminders or []:
            reminders_item = (
                MattercreateJsonBodyDataStatuteOfLimitationsRemindersItem.from_dict(
                    reminders_item_data
                )
            )
        ...
        status: Unset | MattercreateJsonBodyDataStatuteOfLimitationsStatus
