...
T = TypeVar("T", bound="BillBillingSetting")


@_attrs_define
class BillBillingSetting:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bill_billing_setting.additional_properties = d
        return bill_billing_setting
