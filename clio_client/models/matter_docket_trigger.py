...
T = TypeVar("T", bound="MatterDocketTrigger")


@_attrs_define
class MatterDocketTrigger:
    """
    Attributes:
    ...
    do_not_recalculate: Unset | bool = UNSET
    etag: Unset | str = UNSET
    id: Unset | int = UNSET
    is_requirements_required: Unset | bool = UNSET
    is_served: Unset | bool = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_docket_trigger.additional_properties = d
        return matter_docket_trigger
