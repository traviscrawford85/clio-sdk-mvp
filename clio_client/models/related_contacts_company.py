...
T = TypeVar("T", bound="RelatedContactsCompany")


@_attrs_define
class RelatedContactsCompany:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_contacts_company.additional_properties = d
        return related_contacts_company
