...
if TYPE_CHECKING:
    from ..models.billupdate_files_body_data_bill_theme import (
        BillupdateFilesBodyDataBillTheme,
    )
    from ..models.billupdate_files_body_data_discount import (
        BillupdateFilesBodyDataDiscount,
    )
    from ..models.billupdate_files_body_data_interest import (
...
class BillupdateFilesBodyData:
    ...
    state: Unset | BillupdateFilesBodyDataState = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bill_theme: Unset | BillupdateFilesBodyDataBillTheme
        ...
        discount: Unset | BillupdateFilesBodyDataDiscount
        ...
        interest: Unset | BillupdateFilesBodyDataInterest
        ...
        state: Unset | BillupdateFilesBodyDataState
