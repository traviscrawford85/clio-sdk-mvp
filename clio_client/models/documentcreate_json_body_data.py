...
if TYPE_CHECKING:
    from ..models.documentcreate_json_body_data_document_category import (
    ...
    from ..models.documentcreate_json_body_data_multiparts_item import (
        DocumentcreateJsonBodyDataMultipartsItem,
    )
    from ..models.documentcreate_json_body_data_parent import (
...
class DocumentcreateJsonBodyData:
    ...
    external_properties: (
        Unset | list["DocumentcreateJsonBodyDataExternalPropertiesItem"]
    ) = UNSET
    filename: Unset | str = "name"
    multiparts: Unset | list["DocumentcreateJsonBodyDataMultipartsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentcreateJsonBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentcreateJsonBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                DocumentcreateJsonBodyDataExternalPropertiesItem.from_dict(
        ...
        for multiparts_item_data in _multiparts or []:
            multiparts_item = DocumentcreateJsonBodyDataMultipartsItem.from_dict(
