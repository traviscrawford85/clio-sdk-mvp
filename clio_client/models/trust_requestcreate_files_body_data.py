...
@_attrs_define
class TrustRequestcreateFilesBodyData:
    """
    Attributes:
        ...
        trust_type (TrustRequestcreateFilesBodyDataTrustType): The type of TrustRequest
        matter (Union[Unset, list['TrustRequestcreateFilesBodyDataMatterItem']]):
    ...
    issue_date: str
    trust_amount: float
    trust_type: TrustRequestcreateFilesBodyDataTrustType
    matter: Unset | list["TrustRequestcreateFilesBodyDataMatterItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trust_type = TrustRequestcreateFilesBodyDataTrustType(d.pop("trust_type"))

        matter = []
        _matter = d.pop("matter", UNSET)
        for matter_item_data in _matter or []:
            matter_item = TrustRequestcreateFilesBodyDataMatterItem.from_dict(
                matter_item_data
            )
        ...
        trust_requestcreate_files_body_data = cls(
            approved=approved,
            client_id=client_id,
            due_date=due_date,
            issue_date=issue_date,
        ...
        trust_requestcreate_files_body_data.additional_properties = d
        return trust_requestcreate_files_body_data
