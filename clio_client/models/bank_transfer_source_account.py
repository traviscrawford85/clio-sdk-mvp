...
T = TypeVar("T", bound="BankTransferSourceAccount")


@_attrs_define
class BankTransferSourceAccount:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_transfer_source_account = cls(
        ...
        bank_transfer_source_account.additional_properties = d
        return bank_transfer_source_account
