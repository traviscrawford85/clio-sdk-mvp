...
@_attrs_define
class RelatedContactsPrimaryWebSite:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_contacts_primary_web_site = cls(
            address=address,
        ...
        related_contacts_primary_web_site.additional_properties = d
        return related_contacts_primary_web_site
