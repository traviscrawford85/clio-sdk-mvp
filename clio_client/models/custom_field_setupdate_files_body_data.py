...
from ..models.custom_field_setupdate_files_body_data_parent_type import (
...
class CustomFieldSetupdateFilesBodyData:
    ...
    parent_type: Unset | CustomFieldSetupdateFilesBodyDataParentType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parent_type: Unset | CustomFieldSetupdateFilesBodyDataParentType
