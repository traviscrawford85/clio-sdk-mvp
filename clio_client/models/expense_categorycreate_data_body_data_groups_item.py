...
T = TypeVar("T", bound="ExpenseCategorycreateDataBodyDataGroupsItem")


@_attrs_define
class ExpenseCategorycreateDataBodyDataGroupsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        expense_categorycreate_data_body_data_groups_item = cls(
            field_deleted=field_deleted,
            id=id,
        )

        expense_categorycreate_data_body_data_groups_item.additional_properties = d
        return expense_categorycreate_data_body_data_groups_item
