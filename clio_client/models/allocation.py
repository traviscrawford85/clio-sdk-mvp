...
class Allocation:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        destination_bank_account: Unset | dict[str, Any] = UNSET
        ...
        source_bank_account: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact: Unset | AllocationContact
        ...
        destination_bank_account: Unset | AllocationDestinationBankAccount
        if isinstance(_destination_bank_account, Unset):
            destination_bank_account = UNSET
        else:
            destination_bank_account = AllocationDestinationBankAccount.from_dict(
                _destination_bank_account
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | AllocationMatter
        ...
        source_bank_account: Unset | AllocationSourceBankAccount
        if isinstance(_source_bank_account, Unset):
            source_bank_account = UNSET
        else:
            source_bank_account = AllocationSourceBankAccount.from_dict(
                _source_bank_account
            )
