...
from ..models.report_presetupdate_data_body_data_format import (
    ReportPresetupdateDataBodyDataFormat,
)
from ..models.report_presetupdate_data_body_data_kind import (
...
class ReportPresetupdateDataBodyData:
    ...
    format_: Unset | ReportPresetupdateDataBodyDataFormat = UNSET
    kind: Unset | ReportPresetupdateDataBodyDataKind = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        format_: Unset | ReportPresetupdateDataBodyDataFormat
        ...
        kind: Unset | ReportPresetupdateDataBodyDataKind
