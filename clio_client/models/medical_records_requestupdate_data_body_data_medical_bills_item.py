...
class MedicalRecordsRequestupdateDataBodyDataMedicalBillsItem:
    ...
    payers: (
        Unset
        | list["MedicalRecordsRequestupdateDataBodyDataMedicalBillsItemPayersItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for payers_item_data in _payers or []:
            payers_item = MedicalRecordsRequestupdateDataBodyDataMedicalBillsItemPayersItem.from_dict(
                payers_item_data
            )
