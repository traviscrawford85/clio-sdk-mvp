...
if TYPE_CHECKING:
    from ..models.contactupdate_files_body_data_addresses_item import (
        ContactupdateFilesBodyDataAddressesItem,
    )
    from ..models.contactupdate_files_body_data_avatar import (
        ContactupdateFilesBodyDataAvatar,
    )
    from ..models.contactupdate_files_body_data_co_counsel_rate import (
        ContactupdateFilesBodyDataCoCounselRate,
    )
    from ..models.contactupdate_files_body_data_company import (
    ...
    from ..models.contactupdate_files_body_data_phone_numbers_item import (
        ContactupdateFilesBodyDataPhoneNumbersItem,
    )
    from ..models.contactupdate_files_body_data_web_sites_item import (
...
class ContactupdateFilesBodyData:
    ...
    addresses: Unset | list["ContactupdateFilesBodyDataAddressesItem"] = UNSET
    ...
    custom_field_set_associations: (
        Unset | list["ContactupdateFilesBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["ContactupdateFilesBodyDataCustomFieldValuesItem"]
    ) = UNSET
    date_of_birth: Unset | str = UNSET
    email_addresses: Unset | list["ContactupdateFilesBodyDataEmailAddressesItem"] = (
        UNSET
    )
    first_name: Unset | str = UNSET
    instant_messengers: (
        Unset | list["ContactupdateFilesBodyDataInstantMessengersItem"]
    ) = UNSET
    last_name: Unset | str = UNSET
    ledes_client_id: Unset | str = UNSET
    middle_name: Unset | str = UNSET
    name: Unset | str = UNSET
    phone_numbers: Unset | list["ContactupdateFilesBodyDataPhoneNumbersItem"] = UNSET
    prefix: Unset | str = UNSET
    sales_tax_number: Unset | str = UNSET
    title: Unset | str = UNSET
    type_: Unset | ContactupdateFilesBodyDataType = UNSET
    web_sites: Unset | list["ContactupdateFilesBodyDataWebSitesItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for addresses_item_data in _addresses or []:
            addresses_item = ContactupdateFilesBodyDataAddressesItem.from_dict(
                addresses_item_data
            )
        ...
        avatar: Unset | ContactupdateFilesBodyDataAvatar
        ...
        co_counsel_rate: Unset | ContactupdateFilesBodyDataCoCounselRate
        if isinstance(_co_counsel_rate, Unset):
            co_counsel_rate = UNSET
        else:
            co_counsel_rate = ContactupdateFilesBodyDataCoCounselRate.from_dict(
                _co_counsel_rate
            )

        _company = d.pop("company", UNSET)
        company: Unset | ContactupdateFilesBodyDataCompany
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                ContactupdateFilesBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                ContactupdateFilesBodyDataCustomFieldValuesItem.from_dict(
        ...
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = (
                ContactupdateFilesBodyDataEmailAddressesItem.from_dict(
        ...
        for instant_messengers_item_data in _instant_messengers or []:
            instant_messengers_item = (
                ContactupdateFilesBodyDataInstantMessengersItem.from_dict(
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = ContactupdateFilesBodyDataPhoneNumbersItem.from_dict(
        ...
        type_: Unset | ContactupdateFilesBodyDataType
        ...
        for web_sites_item_data in _web_sites or []:
            web_sites_item = ContactupdateFilesBodyDataWebSitesItem.from_dict(
                web_sites_item_data
            )
