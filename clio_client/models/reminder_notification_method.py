...
T = TypeVar("T", bound="ReminderNotificationMethod")


@_attrs_define
class ReminderNotificationMethod:
    """
    Attributes:
    ...
    id: Unset | int = UNSET
    is_default_email_address: Unset | bool = UNSET
    type_: Unset | NotificationMethodBaseType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | NotificationMethodBaseType
        ...
        reminder_notification_method = cls(
        ...
        reminder_notification_method.additional_properties = d
        return reminder_notification_method
