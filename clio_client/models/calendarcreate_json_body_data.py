...
from ..models.calendarcreate_json_body_data_source import (
...
class CalendarcreateJsonBodyData:
    ...
    name: str
    color: Unset | CalendarcreateJsonBodyDataColor = UNSET
    source: Unset | CalendarcreateJsonBodyDataSource = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: Unset | CalendarcreateJsonBodyDataColor
        ...
        source: Unset | CalendarcreateJsonBodyDataSource
