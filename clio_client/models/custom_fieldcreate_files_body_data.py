...
from ..models.custom_fieldcreate_files_body_data_field_type import (
    CustomFieldcreateFilesBodyDataFieldType,
)
from ..models.custom_fieldcreate_files_body_data_parent_type import (
...
class CustomFieldcreateFilesBodyData:
    ...
    picklist_options: (
        Unset | list["CustomFieldcreateFilesBodyDataPicklistOptionsItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for picklist_options_item_data in _picklist_options or []:
            picklist_options_item = (
                CustomFieldcreateFilesBodyDataPicklistOptionsItem.from_dict(
