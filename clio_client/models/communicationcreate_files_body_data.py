...
class CommunicationcreateFilesBodyData:
    ...
    external_properties: (
        Unset | list["CommunicationcreateFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    receivers: Unset | list["CommunicationcreateFilesBodyDataReceiversItem"] = UNSET
    senders: Unset | list["CommunicationcreateFilesBodyDataSendersItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CommunicationcreateFilesBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CommunicationcreateFilesBodyDataMatter
        ...
        for notification_event_subscribers_item_data in (
            ...
            notification_event_subscribers_item = CommunicationcreateFilesBodyDataNotificationEventSubscribersItem.from_dict(
                notification_event_subscribers_item_data
            )
        ...
        for receivers_item_data in _receivers or []:
            receivers_item = CommunicationcreateFilesBodyDataReceiversItem.from_dict(
                receivers_item_data
            )
        ...
        for senders_item_data in _senders or []:
            senders_item = CommunicationcreateFilesBodyDataSendersItem.from_dict(
                senders_item_data
            )
