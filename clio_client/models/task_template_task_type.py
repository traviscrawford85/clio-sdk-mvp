...
T = TypeVar("T", bound="TaskTemplateTaskType")


@_attrs_define
class TaskTemplateTaskType:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_template_task_type.additional_properties = d
        return task_template_task_type
