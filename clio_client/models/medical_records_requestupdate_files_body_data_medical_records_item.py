...
T = TypeVar("T", bound="MedicalRecordsRequestupdateFilesBodyDataMedicalRecordsItem")


@_attrs_define
class MedicalRecordsRequestupdateFilesBodyDataMedicalRecordsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        medical_records_requestupdate_files_body_data_medical_records_item = cls(
            document_id=document_id,
            end_date=end_date,
            start_date=start_date,
        )

        medical_records_requestupdate_files_body_data_medical_records_item.additional_properties = d
        return medical_records_requestupdate_files_body_data_medical_records_item
