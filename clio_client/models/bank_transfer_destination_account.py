...
T = TypeVar("T", bound="BankTransferDestinationAccount")


@_attrs_define
class BankTransferDestinationAccount:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_transfer_destination_account = cls(
        ...
        bank_transfer_destination_account.additional_properties = d
        return bank_transfer_destination_account
