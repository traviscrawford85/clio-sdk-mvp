...
T = TypeVar("T", bound="MatterupdateFilesBodyDataEvergreenRetainerRecipientsItem")


@_attrs_define
class MatterupdateFilesBodyDataEvergreenRetainerRecipientsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matterupdate_files_body_data_evergreen_retainer_recipients_item = cls(
            field_destroy=field_destroy,
            id=id,
        )

        matterupdate_files_body_data_evergreen_retainer_recipients_item.additional_properties = d
        return matterupdate_files_body_data_evergreen_retainer_recipients_item
