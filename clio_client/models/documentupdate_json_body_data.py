...
if TYPE_CHECKING:
    from ..models.documentupdate_json_body_data_document_category import (
    ...
    from ..models.documentupdate_json_body_data_multiparts_item import (
        DocumentupdateJsonBodyDataMultipartsItem,
    )
    from ..models.documentupdate_json_body_data_parent import (
...
class DocumentupdateJsonBodyData:
    ...
    external_properties: (
        Unset | list["DocumentupdateJsonBodyDataExternalPropertiesItem"]
    ) = UNSET
    fully_uploaded: Unset | bool = UNSET
    multiparts: Unset | list["DocumentupdateJsonBodyDataMultipartsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentupdateJsonBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentupdateJsonBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                DocumentupdateJsonBodyDataExternalPropertiesItem.from_dict(
        ...
        for multiparts_item_data in _multiparts or []:
            multiparts_item = DocumentupdateJsonBodyDataMultipartsItem.from_dict(
        ...
        parent: Unset | DocumentupdateJsonBodyDataParent
