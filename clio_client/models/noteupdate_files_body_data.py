...
@_attrs_define
class NoteupdateFilesBodyData:
    """
    Attributes:
        date (Union[Unset, str]): Date for the Note. (Expects an ISO-8601 date).
        detail (Union[Unset, str]): Note body.
        notification_event_subscribers (Union[Unset, list['NoteupdateFilesBodyDataNotificationEventSubscribersItem']]):
    ...
    notification_event_subscribers: (
        Unset | list["NoteupdateFilesBodyDataNotificationEventSubscribersItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for notification_event_subscribers_item_data in (
            ...
            notification_event_subscribers_item = (
                NoteupdateFilesBodyDataNotificationEventSubscribersItem.from_dict(
                    notification_event_subscribers_item_data
                )
            )
        ...
        noteupdate_files_body_data = cls(
            date=date,
            detail=detail,
        ...
        noteupdate_files_body_data.additional_properties = d
        return noteupdate_files_body_data
