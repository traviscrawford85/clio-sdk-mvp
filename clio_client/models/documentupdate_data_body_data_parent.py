...
from ..models.documentupdate_data_body_data_parent_type import (
...
class DocumentupdateDataBodyDataParent:
    ...
    id: Unset | int = UNSET
    type_: Unset | DocumentupdateDataBodyDataParentType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | DocumentupdateDataBodyDataParentType
