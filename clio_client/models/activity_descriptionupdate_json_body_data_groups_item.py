...
T = TypeVar("T", bound="ActivityDescriptionupdateJsonBodyDataGroupsItem")


@_attrs_define
class ActivityDescriptionupdateJsonBodyDataGroupsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_descriptionupdate_json_body_data_groups_item = cls(
            field_deleted=field_deleted,
            id=id,
        )

        activity_descriptionupdate_json_body_data_groups_item.additional_properties = d
        return activity_descriptionupdate_json_body_data_groups_item
