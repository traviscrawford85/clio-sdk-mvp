...
T = TypeVar("T", bound="ActivityRateupdateDataBodyData")


@_attrs_define
class ActivityRateupdateDataBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_rateupdate_data_body_data = cls(
        ...
        activity_rateupdate_data_body_data.additional_properties = d
        return activity_rateupdate_data_body_data
