...
T = TypeVar("T", bound="FolderupdateJsonBodyDataExternalPropertiesItem")


@_attrs_define
class FolderupdateJsonBodyDataExternalPropertiesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        folderupdate_json_body_data_external_properties_item = cls(
        ...
        folderupdate_json_body_data_external_properties_item.additional_properties = d
        return folderupdate_json_body_data_external_properties_item
