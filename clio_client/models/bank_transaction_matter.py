...
T = TypeVar("T", bound="BankTransactionMatter")


@_attrs_define
class BankTransactionMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_transaction_matter.additional_properties = d
        return bank_transaction_matter
