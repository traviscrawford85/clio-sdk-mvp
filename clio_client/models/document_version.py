...
class DocumentVersion:
    ...
    multiparts: Unset | list["Multipart"] = UNSET
    put_headers: Unset | list["MultipartHeaderBase"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        put_headers: Unset | list[dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        creator: Unset | DocumentVersionCreator
