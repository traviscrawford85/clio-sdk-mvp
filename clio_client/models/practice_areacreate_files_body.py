...
@_attrs_define
class PracticeAreacreateFilesBody:
    """
    Attributes:
        data (PracticeAreacreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        practice_areacreate_files_body = cls(
            data=data,
        )

        practice_areacreate_files_body.additional_properties = d
        return practice_areacreate_files_body
