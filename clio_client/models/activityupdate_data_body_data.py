...
from ..models.activityupdate_data_body_data_tax_setting import (
...
if TYPE_CHECKING:
    ...
    from ..models.activityupdate_data_body_data_calendar_entry import (
        ActivityupdateDataBodyDataCalendarEntry,
    )
    from ..models.activityupdate_data_body_data_client_portal import (
        ActivityupdateDataBodyDataClientPortal,
    )
    from ..models.activityupdate_data_body_data_communication import (
        ActivityupdateDataBodyDataCommunication,
    )
    from ..models.activityupdate_data_body_data_contact_note import (
        ActivityupdateDataBodyDataContactNote,
    )
    from ..models.activityupdate_data_body_data_expense_category import (
        ActivityupdateDataBodyDataExpenseCategory,
    )
    from ..models.activityupdate_data_body_data_matter import (
        ActivityupdateDataBodyDataMatter,
    )
    from ..models.activityupdate_data_body_data_matter_note import (
        ActivityupdateDataBodyDataMatterNote,
    )
    from ..models.activityupdate_data_body_data_task import (
    ...
    from ..models.activityupdate_data_body_data_user import (
        ActivityupdateDataBodyDataUser,
    )
    from ..models.activityupdate_data_body_data_utbms_expense import (
        ActivityupdateDataBodyDataUtbmsExpense,
    )
    from ..models.activityupdate_data_body_data_vendor import (
...
class ActivityupdateDataBodyData:
    ...
    activity_description: Union[
        Unset, "ActivityupdateDataBodyDataActivityDescription"
    ] = UNSET
    ...
    tax_setting: Unset | ActivityupdateDataBodyDataTaxSetting = UNSET
    text_message_conversation: Union[
        Unset, "ActivityupdateDataBodyDataTextMessageConversation"
    ] = UNSET
    type_: Unset | ActivityupdateDataBodyDataType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_description: Unset | ActivityupdateDataBodyDataActivityDescription
        if isinstance(_activity_description, Unset):
            activity_description = UNSET
        else:
            activity_description = (
                ActivityupdateDataBodyDataActivityDescription.from_dict(
                    _activity_description
                )
            )

        _calendar_entry = d.pop("calendar_entry", UNSET)
        calendar_entry: Unset | ActivityupdateDataBodyDataCalendarEntry
        if isinstance(_calendar_entry, Unset):
            calendar_entry = UNSET
        else:
            calendar_entry = ActivityupdateDataBodyDataCalendarEntry.from_dict(
                _calendar_entry
            )

        _client_portal = d.pop("client_portal", UNSET)
        client_portal: Unset | ActivityupdateDataBodyDataClientPortal
        if isinstance(_client_portal, Unset):
            client_portal = UNSET
        else:
            client_portal = ActivityupdateDataBodyDataClientPortal.from_dict(
                _client_portal
            )

        _communication = d.pop("communication", UNSET)
        communication: Unset | ActivityupdateDataBodyDataCommunication
        if isinstance(_communication, Unset):
            communication = UNSET
        else:
            communication = ActivityupdateDataBodyDataCommunication.from_dict(
                _communication
            )

        _contact_note = d.pop("contact_note", UNSET)
        contact_note: Unset | ActivityupdateDataBodyDataContactNote
        if isinstance(_contact_note, Unset):
            contact_note = UNSET
        else:
            contact_note = ActivityupdateDataBodyDataContactNote.from_dict(
                _contact_note
            )
        ...
        expense_category: Unset | ActivityupdateDataBodyDataExpenseCategory
        if isinstance(_expense_category, Unset):
            expense_category = UNSET
        else:
            expense_category = ActivityupdateDataBodyDataExpenseCategory.from_dict(
                _expense_category
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ActivityupdateDataBodyDataMatter
        ...
        matter_note: Unset | ActivityupdateDataBodyDataMatterNote
        ...
        task: Unset | ActivityupdateDataBodyDataTask
        ...
        tax_setting: Unset | ActivityupdateDataBodyDataTaxSetting
        ...
        if isinstance(_text_message_conversation, Unset):
            ...
            text_message_conversation = (
                ActivityupdateDataBodyDataTextMessageConversation.from_dict(
                    _text_message_conversation
                )
            )

        _type_ = d.pop("type", UNSET)
        type_: Unset | ActivityupdateDataBodyDataType
        ...
        user: Unset | ActivityupdateDataBodyDataUser
        ...
        utbms_expense: Unset | ActivityupdateDataBodyDataUtbmsExpense
        if isinstance(_utbms_expense, Unset):
            utbms_expense = UNSET
        else:
            utbms_expense = ActivityupdateDataBodyDataUtbmsExpense.from_dict(
                _utbms_expense
            )

        _vendor = d.pop("vendor", UNSET)
        vendor: Unset | ActivityupdateDataBodyDataVendor
