...
from ..models.custom_field_setcreate_data_body_data_parent_type import (
...
class CustomFieldSetcreateDataBodyData:
    ...
    parent_type: Unset | CustomFieldSetcreateDataBodyDataParentType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parent_type: Unset | CustomFieldSetcreateDataBodyDataParentType
