...
T = TypeVar("T", bound="LineItemActivity")


@_attrs_define
class LineItemActivity:
    """
    Attributes:
    ...
    billed: Unset | bool = UNSET
    contingency_fee: Unset | bool = UNSET
    ...
    non_billable_total: Unset | float = UNSET
    note: Unset | str = UNSET
    on_bill: Unset | bool = UNSET
    price: Unset | float = UNSET
    quantity: Unset | float = UNSET
    quantity_in_hours: Unset | float = UNSET
    quantity_redacted: Unset | bool = UNSET
    reference: Unset | str = UNSET
    rounded_quantity: Unset | float = UNSET
    rounded_quantity_in_hours: Unset | float = UNSET
    tax_setting: Unset | ActivityBaseTaxSetting = UNSET
    total: Unset | float = UNSET
    type_: Unset | ActivityBaseType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tax_setting: Unset | ActivityBaseTaxSetting
        ...
        line_item_activity.additional_properties = d
        return line_item_activity
