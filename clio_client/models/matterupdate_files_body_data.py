...
from ..models.matterupdate_files_body_data_status import MatterupdateFilesBodyDataStatus
...
@_attrs_define
class MatterupdateFilesBodyData:
    """
    Attributes:
        billable (Union[Unset, bool]): Whether or not the matter is billable. Default: True.
        client (Union[Unset, MatterupdateFilesBodyDataClient]):
        ...
        custom_field_set_associations (Union[Unset, list['MatterupdateFilesBodyDataCustomFieldSetAssociationsItem']]):
        custom_field_values (Union[Unset, list['MatterupdateFilesBodyDataCustomFieldValuesItem']]):
        custom_rate (Union[Unset, MatterupdateFilesBodyDataCustomRate]):
        ...
        evergreen_retainer (Union[Unset, MatterupdateFilesBodyDataEvergreenRetainer]):
        group (Union[Unset, MatterupdateFilesBodyDataGroup]):
        location (Union[Unset, str]): Location of the Matter.
        matter_budget (Union[Unset, MatterupdateFilesBodyDataMatterBudget]):
        matter_stage (Union[Unset, MatterupdateFilesBodyDataMatterStage]):
        open_date (Union[Unset, str]): Date the Matter was set to open. (Expects an ISO-8601 date).
        originating_attorney (Union[Unset, MatterupdateFilesBodyDataOriginatingAttorney]):
        pending_date (Union[Unset, str]): Date the Matter was set to pending. (Expects an ISO-8601 date).
        practice_area (Union[Unset, MatterupdateFilesBodyDataPracticeArea]):
        relationships (Union[Unset, list['MatterupdateFilesBodyDataRelationshipsItem']]):
        ...
        responsible_attorney (Union[Unset, MatterupdateFilesBodyDataResponsibleAttorney]):
        split_invoice_payers (Union[Unset, list['MatterupdateFilesBodyDataSplitInvoicePayersItem']]):
        status (Union[Unset, MatterupdateFilesBodyDataStatus]): Matter status.
        statute_of_limitations (Union[Unset, MatterupdateFilesBodyDataStatuteOfLimitations]):
        task_template_list_instances (Union[Unset, list['MatterupdateFilesBodyDataTaskTemplateListInstancesItem']]):
    """

    billable: Unset | bool = True
    client: Union[Unset, "MatterupdateFilesBodyDataClient"] = UNSET
    client_reference: Unset | str = UNSET
    close_date: Unset | str = UNSET
    custom_field_set_associations: (
        Unset | list["MatterupdateFilesBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["MatterupdateFilesBodyDataCustomFieldValuesItem"]
    ) = UNSET
    custom_rate: Union[Unset, "MatterupdateFilesBodyDataCustomRate"] = UNSET
    description: Unset | str = UNSET
    display_number: Unset | str = UNSET
    evergreen_retainer: Union[Unset, "MatterupdateFilesBodyDataEvergreenRetainer"] = (
        UNSET
    )
    group: Union[Unset, "MatterupdateFilesBodyDataGroup"] = UNSET
    location: Unset | str = UNSET
    matter_budget: Union[Unset, "MatterupdateFilesBodyDataMatterBudget"] = UNSET
    matter_stage: Union[Unset, "MatterupdateFilesBodyDataMatterStage"] = UNSET
    open_date: Unset | str = UNSET
    originating_attorney: Union[
        Unset, "MatterupdateFilesBodyDataOriginatingAttorney"
    ] = UNSET
    pending_date: Unset | str = UNSET
    practice_area: Union[Unset, "MatterupdateFilesBodyDataPracticeArea"] = UNSET
    relationships: Unset | list["MatterupdateFilesBodyDataRelationshipsItem"] = UNSET
    reset_matter_number: Unset | bool = False
    responsible_attorney: Union[
        Unset, "MatterupdateFilesBodyDataResponsibleAttorney"
    ] = UNSET
    split_invoice_payers: (
        Unset | list["MatterupdateFilesBodyDataSplitInvoicePayersItem"]
    ) = UNSET
    status: Unset | MatterupdateFilesBodyDataStatus = UNSET
    statute_of_limitations: Union[
        Unset, "MatterupdateFilesBodyDataStatuteOfLimitations"
    ] = UNSET
    task_template_list_instances: (
        Unset | list["MatterupdateFilesBodyDataTaskTemplateListInstancesItem"]
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        custom_field_set_associations: Unset | list[dict[str, Any]] = UNSET
        if not isinstance(self.custom_field_set_associations, Unset):
            custom_field_set_associations = []
            for (
                custom_field_set_associations_item_data
            ) in self.custom_field_set_associations:
                custom_field_set_associations_item = (
                    custom_field_set_associations_item_data.to_dict()
                )
                custom_field_set_associations.append(custom_field_set_associations_item)

        custom_field_values: Unset | list[dict[str, Any]] = UNSET
        ...
        custom_rate: Unset | dict[str, Any] = UNSET
        ...
        evergreen_retainer: Unset | dict[str, Any] = UNSET
        ...
        relationships: Unset | list[dict[str, Any]] = UNSET
        ...
        statute_of_limitations: Unset | dict[str, Any] = UNSET
        if not isinstance(self.statute_of_limitations, Unset):
            statute_of_limitations = self.statute_of_limitations.to_dict()

        task_template_list_instances: Unset | list[dict[str, Any]] = UNSET
        if not isinstance(self.task_template_list_instances, Unset):
            task_template_list_instances = []
            for (
                task_template_list_instances_item_data
            ) in self.task_template_list_instances:
                task_template_list_instances_item = (
                    task_template_list_instances_item_data.to_dict()
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        client: Unset | MatterupdateFilesBodyDataClient
        if isinstance(_client, Unset):
            client = UNSET
        else:
            client = MatterupdateFilesBodyDataClient.from_dict(_client)
        ...
        for custom_field_set_associations_item_data in (
            _custom_field_set_associations or []
        ):
            custom_field_set_associations_item = (
                MatterupdateFilesBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                MatterupdateFilesBodyDataCustomFieldValuesItem.from_dict(
        ...
        custom_rate: Unset | MatterupdateFilesBodyDataCustomRate
        if isinstance(_custom_rate, Unset):
            custom_rate = UNSET
        else:
            custom_rate = MatterupdateFilesBodyDataCustomRate.from_dict(_custom_rate)
        ...
        evergreen_retainer: Unset | MatterupdateFilesBodyDataEvergreenRetainer
        if isinstance(_evergreen_retainer, Unset):
            evergreen_retainer = UNSET
        else:
            evergreen_retainer = MatterupdateFilesBodyDataEvergreenRetainer.from_dict(
                _evergreen_retainer
            )

        _group = d.pop("group", UNSET)
        group: Unset | MatterupdateFilesBodyDataGroup
        if isinstance(_group, Unset):
            group = UNSET
        else:
            group = MatterupdateFilesBodyDataGroup.from_dict(_group)

        location = d.pop("location", UNSET)

        _matter_budget = d.pop("matter_budget", UNSET)
        matter_budget: Unset | MatterupdateFilesBodyDataMatterBudget
        if isinstance(_matter_budget, Unset):
            matter_budget = UNSET
        else:
            matter_budget = MatterupdateFilesBodyDataMatterBudget.from_dict(
                _matter_budget
            )

        _matter_stage = d.pop("matter_stage", UNSET)
        matter_stage: Unset | MatterupdateFilesBodyDataMatterStage
        if isinstance(_matter_stage, Unset):
            matter_stage = UNSET
        else:
            matter_stage = MatterupdateFilesBodyDataMatterStage.from_dict(_matter_stage)

        open_date = d.pop("open_date", UNSET)

        _originating_attorney = d.pop("originating_attorney", UNSET)
        originating_attorney: Unset | MatterupdateFilesBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                MatterupdateFilesBodyDataOriginatingAttorney.from_dict(
                    _originating_attorney
                )
            )
        ...
        practice_area: Unset | MatterupdateFilesBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = MatterupdateFilesBodyDataPracticeArea.from_dict(
                _practice_area
            )
        ...
        for relationships_item_data in _relationships or []:
            relationships_item = MatterupdateFilesBodyDataRelationshipsItem.from_dict(
        ...
        responsible_attorney: Unset | MatterupdateFilesBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                MatterupdateFilesBodyDataResponsibleAttorney.from_dict(
                    _responsible_attorney
                )
            )
        ...
        for split_invoice_payers_item_data in _split_invoice_payers or []:
            split_invoice_payers_item = (
                MatterupdateFilesBodyDataSplitInvoicePayersItem.from_dict(
        ...
        status: Unset | MatterupdateFilesBodyDataStatus
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = MatterupdateFilesBodyDataStatus(_status)

        _statute_of_limitations = d.pop("statute_of_limitations", UNSET)
        statute_of_limitations: Unset | MatterupdateFilesBodyDataStatuteOfLimitations
        if isinstance(_statute_of_limitations, Unset):
            statute_of_limitations = UNSET
        else:
            statute_of_limitations = (
                MatterupdateFilesBodyDataStatuteOfLimitations.from_dict(
                    _statute_of_limitations
                )
            )

        task_template_list_instances = []
        _task_template_list_instances = d.pop("task_template_list_instances", UNSET)
        for task_template_list_instances_item_data in (
            _task_template_list_instances or []
        ):
            task_template_list_instances_item = (
                MatterupdateFilesBodyDataTaskTemplateListInstancesItem.from_dict(
                    task_template_list_instances_item_data
                )
            )
        ...
        matterupdate_files_body_data = cls(
            billable=billable,
            client=client,
        ...
        matterupdate_files_body_data.additional_properties = d
        return matterupdate_files_body_data
