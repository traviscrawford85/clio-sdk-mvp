...
@_attrs_define
class BankAccountcreateJsonBody:
    """
    Attributes:
        data (BankAccountcreateJsonBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_accountcreate_json_body = cls(
            data=data,
        )

        bank_accountcreate_json_body.additional_properties = d
        return bank_accountcreate_json_body
