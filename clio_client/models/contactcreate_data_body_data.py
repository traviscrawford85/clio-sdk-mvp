...
if TYPE_CHECKING:
    from ..models.contactcreate_data_body_data_addresses_item import (
        ContactcreateDataBodyDataAddressesItem,
    )
    from ..models.contactcreate_data_body_data_avatar import (
        ContactcreateDataBodyDataAvatar,
    )
    from ..models.contactcreate_data_body_data_co_counsel_rate import (
        ContactcreateDataBodyDataCoCounselRate,
    )
    from ..models.contactcreate_data_body_data_company import (
    ...
    from ..models.contactcreate_data_body_data_phone_numbers_item import (
        ContactcreateDataBodyDataPhoneNumbersItem,
    )
    from ..models.contactcreate_data_body_data_web_sites_item import (
...
class ContactcreateDataBodyData:
    ...
    addresses: Unset | list["ContactcreateDataBodyDataAddressesItem"] = UNSET
    ...
    custom_field_set_associations: (
        Unset | list["ContactcreateDataBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["ContactcreateDataBodyDataCustomFieldValuesItem"]
    ) = UNSET
    date_of_birth: Unset | str = UNSET
    email_addresses: Unset | list["ContactcreateDataBodyDataEmailAddressesItem"] = UNSET
    first_name: Unset | str = UNSET
    instant_messengers: (
        Unset | list["ContactcreateDataBodyDataInstantMessengersItem"]
    ) = UNSET
    last_name: Unset | str = UNSET
    ledes_client_id: Unset | str = UNSET
    middle_name: Unset | str = UNSET
    phone_numbers: Unset | list["ContactcreateDataBodyDataPhoneNumbersItem"] = UNSET
    prefix: Unset | str = UNSET
    sales_tax_number: Unset | str = UNSET
    title: Unset | str = UNSET
    web_sites: Unset | list["ContactcreateDataBodyDataWebSitesItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for addresses_item_data in _addresses or []:
            addresses_item = ContactcreateDataBodyDataAddressesItem.from_dict(
                addresses_item_data
            )
        ...
        avatar: Unset | ContactcreateDataBodyDataAvatar
        ...
        co_counsel_rate: Unset | ContactcreateDataBodyDataCoCounselRate
        if isinstance(_co_counsel_rate, Unset):
            co_counsel_rate = UNSET
        else:
            co_counsel_rate = ContactcreateDataBodyDataCoCounselRate.from_dict(
                _co_counsel_rate
            )

        _company = d.pop("company", UNSET)
        company: Unset | ContactcreateDataBodyDataCompany
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                ContactcreateDataBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                ContactcreateDataBodyDataCustomFieldValuesItem.from_dict(
        ...
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = (
                ContactcreateDataBodyDataEmailAddressesItem.from_dict(
        ...
        for instant_messengers_item_data in _instant_messengers or []:
            instant_messengers_item = (
                ContactcreateDataBodyDataInstantMessengersItem.from_dict(
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = ContactcreateDataBodyDataPhoneNumbersItem.from_dict(
        ...
        for web_sites_item_data in _web_sites or []:
            web_sites_item = ContactcreateDataBodyDataWebSitesItem.from_dict(
                web_sites_item_data
            )
