...
T = TypeVar("T", bound="MatterContactsCompany")


@_attrs_define
class MatterContactsCompany:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_contacts_company.additional_properties = d
        return matter_contacts_company
