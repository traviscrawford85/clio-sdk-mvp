...
class ActivitycreateDataBodyData:
    ...
    activity_description: Union[
        Unset, "ActivitycreateDataBodyDataActivityDescription"
    ] = UNSET
    ...
    tax_setting: Unset | ActivitycreateDataBodyDataTaxSetting = UNSET
    text_message_conversation: Union[
        Unset, "ActivitycreateDataBodyDataTextMessageConversation"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_description: Unset | ActivitycreateDataBodyDataActivityDescription
        if isinstance(_activity_description, Unset):
            activity_description = UNSET
        else:
            activity_description = (
                ActivitycreateDataBodyDataActivityDescription.from_dict(
                    _activity_description
                )
            )

        _calendar_entry = d.pop("calendar_entry", UNSET)
        calendar_entry: Unset | ActivitycreateDataBodyDataCalendarEntry
        if isinstance(_calendar_entry, Unset):
            calendar_entry = UNSET
        else:
            calendar_entry = ActivitycreateDataBodyDataCalendarEntry.from_dict(
                _calendar_entry
            )

        _client_portal = d.pop("client_portal", UNSET)
        client_portal: Unset | ActivitycreateDataBodyDataClientPortal
        if isinstance(_client_portal, Unset):
            client_portal = UNSET
        else:
            client_portal = ActivitycreateDataBodyDataClientPortal.from_dict(
                _client_portal
            )

        _communication = d.pop("communication", UNSET)
        communication: Unset | ActivitycreateDataBodyDataCommunication
        if isinstance(_communication, Unset):
            communication = UNSET
        else:
            communication = ActivitycreateDataBodyDataCommunication.from_dict(
                _communication
            )

        _contact_note = d.pop("contact_note", UNSET)
        contact_note: Unset | ActivitycreateDataBodyDataContactNote
        if isinstance(_contact_note, Unset):
            contact_note = UNSET
        else:
            contact_note = ActivitycreateDataBodyDataContactNote.from_dict(
                _contact_note
            )

        _expense_category = d.pop("expense_category", UNSET)
        expense_category: Unset | ActivitycreateDataBodyDataExpenseCategory
        if isinstance(_expense_category, Unset):
            expense_category = UNSET
        else:
            expense_category = ActivitycreateDataBodyDataExpenseCategory.from_dict(
                _expense_category
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ActivitycreateDataBodyDataMatter
        ...
        matter_note: Unset | ActivitycreateDataBodyDataMatterNote
        ...
        task: Unset | ActivitycreateDataBodyDataTask
        ...
        tax_setting: Unset | ActivitycreateDataBodyDataTaxSetting
        ...
        if isinstance(_text_message_conversation, Unset):
            ...
            text_message_conversation = (
                ActivitycreateDataBodyDataTextMessageConversation.from_dict(
                    _text_message_conversation
                )
            )

        _user = d.pop("user", UNSET)
        user: Unset | ActivitycreateDataBodyDataUser
        ...
        utbms_expense: Unset | ActivitycreateDataBodyDataUtbmsExpense
        if isinstance(_utbms_expense, Unset):
            utbms_expense = UNSET
        else:
            utbms_expense = ActivitycreateDataBodyDataUtbmsExpense.from_dict(
                _utbms_expense
            )

        _vendor = d.pop("vendor", UNSET)
        vendor: Unset | ActivitycreateDataBodyDataVendor
