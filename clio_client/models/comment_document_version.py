...
T = TypeVar("T", bound="CommentDocumentVersion")


@_attrs_define
class CommentDocumentVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        comment_document_version.additional_properties = d
        return comment_document_version
