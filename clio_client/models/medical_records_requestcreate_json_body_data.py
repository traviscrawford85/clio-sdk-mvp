...
class MedicalRecordsRequestcreateJsonBodyData:
    ...
    medical_bills: (
        Unset | list["MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItem"]
    ) = UNSET
    medical_records: (
        Unset | list["MedicalRecordsRequestcreateJsonBodyDataMedicalRecordsItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = (
                MedicalRecordsRequestcreateJsonBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = (
                MedicalRecordsRequestcreateJsonBodyDataMedicalRecordsItem.from_dict(
