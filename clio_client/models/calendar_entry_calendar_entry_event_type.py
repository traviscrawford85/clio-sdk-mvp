...
@_attrs_define
class CalendarEntryCalendarEntryEventType:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calendar_entry_calendar_entry_event_type = cls(
            color=color,
        ...
        calendar_entry_calendar_entry_event_type.additional_properties = d
        return calendar_entry_calendar_entry_event_type
