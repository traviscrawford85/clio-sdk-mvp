...
class MatterContacts:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        avatar: Unset | MatterContactsAvatar
        ...
        company: Unset | MatterContactsCompany
        ...
        primary_address: Unset | MatterContactsPrimaryAddress
        ...
        primary_web_site: Unset | MatterContactsPrimaryWebSite
        ...
        relationship: Unset | MatterContactsRelationship
        ...
        secondary_address: Unset | MatterContactsSecondaryAddress
        if isinstance(_secondary_address, Unset):
            secondary_address = UNSET
        else:
            secondary_address = MatterContactsSecondaryAddress.from_dict(
                _secondary_address
            )

        _secondary_web_site = d.pop("secondary_web_site", UNSET)
        secondary_web_site: Unset | MatterContactsSecondaryWebSite
        if isinstance(_secondary_web_site, Unset):
            secondary_web_site = UNSET
        else:
            secondary_web_site = MatterContactsSecondaryWebSite.from_dict(
                _secondary_web_site
            )
