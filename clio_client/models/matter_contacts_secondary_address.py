...
T = TypeVar("T", bound="MatterContactsSecondaryAddress")


@_attrs_define
class MatterContactsSecondaryAddress:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_contacts_secondary_address = cls(
            city=city,
            country=country,
        ...
        matter_contacts_secondary_address.additional_properties = d
        return matter_contacts_secondary_address
