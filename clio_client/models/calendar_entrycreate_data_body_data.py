...
@_attrs_define
class CalendarEntrycreateDataBodyData:
    """
    Attributes:
        calendar_owner (CalendarEntrycreateDataBodyDataCalendarOwner):
        end_at (str): The time the CalendarEntry ends (Expects an ISO-8601 timestamp).
        start_at (str): The time the CalendarEntry starts (Expects an ISO-8601 timestamp).
        summary (str): A short summary of the CalendarEntry.
        field_deleted (Union[Unset, CalendarEntrycreateDataBodyDataDeleted]): Flag to delete a specific instance of a
            recurring event.
        all_day (Union[Unset, bool]): Whether or not the CalendarEntry is for all day.
        attendees (Union[Unset, list['CalendarEntrycreateDataBodyDataAttendeesItem']]):
        calendar_entry_event_type (Union[Unset, CalendarEntrycreateDataBodyDataCalendarEntryEventType]):
        conference_meeting (Union[Unset, CalendarEntrycreateDataBodyDataConferenceMeeting]):
        description (Union[Unset, str]): A detailed description of the CalendarEntry.
        external_properties (Union[Unset, list['CalendarEntrycreateDataBodyDataExternalPropertiesItem']]):
        location (Union[Unset, str]): The geographic location of the CalendarEntry.
        matter (Union[Unset, CalendarEntrycreateDataBodyDataMatter]):
    ...
    start_at: str
    summary: str
    field_deleted: Unset | CalendarEntrycreateDataBodyDataDeleted = UNSET
    all_day: Unset | bool = UNSET
    attendees: Unset | list["CalendarEntrycreateDataBodyDataAttendeesItem"] = UNSET
    calendar_entry_event_type: Union[
        Unset, "CalendarEntrycreateDataBodyDataCalendarEntryEventType"
    ] = UNSET
    conference_meeting: Union[
        Unset, "CalendarEntrycreateDataBodyDataConferenceMeeting"
    ] = UNSET
    description: Unset | str = UNSET
    external_properties: (
        Unset | list["CalendarEntrycreateDataBodyDataExternalPropertiesItem"]
    ) = UNSET
    location: Unset | str = UNSET
    matter: Union[Unset, "CalendarEntrycreateDataBodyDataMatter"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        calendar_owner = CalendarEntrycreateDataBodyDataCalendarOwner.from_dict(
            d.pop("calendar_owner")
        )
        ...
        field_deleted: Unset | CalendarEntrycreateDataBodyDataDeleted
        if isinstance(_field_deleted, Unset):
            field_deleted = UNSET
        else:
            field_deleted = CalendarEntrycreateDataBodyDataDeleted(_field_deleted)
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntrycreateDataBodyDataAttendeesItem.from_dict(
                attendees_item_data
            )
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = (
                CalendarEntrycreateDataBodyDataCalendarEntryEventType.from_dict(
                    _calendar_entry_event_type
                )
            )

        _conference_meeting = d.pop("conference_meeting", UNSET)
        conference_meeting: Unset | CalendarEntrycreateDataBodyDataConferenceMeeting
        if isinstance(_conference_meeting, Unset):
            conference_meeting = UNSET
        else:
            conference_meeting = (
                CalendarEntrycreateDataBodyDataConferenceMeeting.from_dict(
                    _conference_meeting
                )
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CalendarEntrycreateDataBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CalendarEntrycreateDataBodyDataMatter
        if isinstance(_matter, Unset):
            matter = UNSET
        else:
            matter = CalendarEntrycreateDataBodyDataMatter.from_dict(_matter)

        recurrence_rule = d.pop("recurrence_rule", UNSET)

        send_email_notification = d.pop("send_email_notification", UNSET)

        calendar_entrycreate_data_body_data = cls(
            calendar_owner=calendar_owner,
            end_at=end_at,
            start_at=start_at,
            summary=summary,
        ...
        calendar_entrycreate_data_body_data.additional_properties = d
        return calendar_entrycreate_data_body_data
