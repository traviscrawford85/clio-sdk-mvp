...
T = TypeVar("T", bound="TextSnippetupdateDataBodyData")


@_attrs_define
class TextSnippetupdateDataBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_snippetupdate_data_body_data = cls(
            phrase=phrase,
            snippet=snippet,
            whole_word=whole_word,
        )

        text_snippetupdate_data_body_data.additional_properties = d
        return text_snippetupdate_data_body_data
