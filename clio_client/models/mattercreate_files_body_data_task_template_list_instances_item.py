...
@_attrs_define
class MattercreateFilesBodyDataTaskTemplateListInstancesItem:
    """
    Attributes:
        task_template_list (MattercreateFilesBodyDataTaskTemplateListInstancesItemTaskTemplateList):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mattercreate_files_body_data_task_template_list_instances_item = cls(
            task_template_list=task_template_list,
        ...
        mattercreate_files_body_data_task_template_list_instances_item.additional_properties = d
        return mattercreate_files_body_data_task_template_list_instances_item
