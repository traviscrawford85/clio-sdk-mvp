...
class CommunicationcreateDataBodyData:
    ...
    external_properties: (
        Unset | list["CommunicationcreateDataBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    receivers: Unset | list["CommunicationcreateDataBodyDataReceiversItem"] = UNSET
    senders: Unset | list["CommunicationcreateDataBodyDataSendersItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CommunicationcreateDataBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CommunicationcreateDataBodyDataMatter
        ...
        for notification_event_subscribers_item_data in (
            ...
            notification_event_subscribers_item = CommunicationcreateDataBodyDataNotificationEventSubscribersItem.from_dict(
                notification_event_subscribers_item_data
            )
        ...
        for receivers_item_data in _receivers or []:
            receivers_item = CommunicationcreateDataBodyDataReceiversItem.from_dict(
                receivers_item_data
            )
        ...
        for senders_item_data in _senders or []:
            senders_item = CommunicationcreateDataBodyDataSendersItem.from_dict(
                senders_item_data
            )
