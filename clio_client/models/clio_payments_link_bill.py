...
T = TypeVar("T", bound="ClioPaymentsLinkBill")


@_attrs_define
class ClioPaymentsLinkBill:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_link_bill.additional_properties = d
        return clio_payments_link_bill
