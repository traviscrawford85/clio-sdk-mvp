...
class BillableClient:
    ...
    amount_in_trust: Unset | float = UNSET
    billable_matters_count: Unset | int = UNSET
    id: Unset | int = UNSET
    name: Unset | str = UNSET
    unbilled_amount: Unset | float = UNSET
    unbilled_hours: Unset | float = UNSET
    billable_matters: Unset | list["BillableMatterBase"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        billable_matters: Unset | list[dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for billable_matters_item_data in _billable_matters or []:
            billable_matters_item = BillableMatterBase.from_dict(
                billable_matters_item_data
            )
