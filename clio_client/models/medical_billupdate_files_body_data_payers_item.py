...
T = TypeVar("T", bound="MedicalBillupdateFilesBodyDataPayersItem")


@_attrs_define
class MedicalBillupdateFilesBodyDataPayersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        medical_billupdate_files_body_data_payers_item = cls(
            amount=amount,
            holder_id=holder_id,
            mark_as_lien=mark_as_lien,
        )

        medical_billupdate_files_body_data_payers_item.additional_properties = d
        return medical_billupdate_files_body_data_payers_item
