...
if TYPE_CHECKING:
    from ..models.documentcopy_files_body_data_document_category import (
        DocumentcopyFilesBodyDataDocumentCategory,
    )
    from ..models.documentcopy_files_body_data_external_properties_item import (
        DocumentcopyFilesBodyDataExternalPropertiesItem,
    )
    from ..models.documentcopy_files_body_data_parent import (
        DocumentcopyFilesBodyDataParent,
    )


T = TypeVar("T", bound="DocumentcopyFilesBodyData")


@_attrs_define
class DocumentcopyFilesBodyData:
    """
    Attributes:
        parent (DocumentcopyFilesBodyDataParent):
        communication_id (Union[Unset, int]): Related communication record.
        document_category (Union[Unset, DocumentcopyFilesBodyDataDocumentCategory]):
        external_properties (Union[Unset, list['DocumentcopyFilesBodyDataExternalPropertiesItem']]):
    ...
    document_category: Union[Unset, "DocumentcopyFilesBodyDataDocumentCategory"] = UNSET
    external_properties: (
        Unset | list["DocumentcopyFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    filename: Unset | str = "name"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        parent = DocumentcopyFilesBodyDataParent.from_dict(d.pop("parent"))

        communication_id = d.pop("communication_id", UNSET)

        _document_category = d.pop("document_category", UNSET)
        document_category: Unset | DocumentcopyFilesBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentcopyFilesBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                DocumentcopyFilesBodyDataExternalPropertiesItem.from_dict(
        ...
        documentcopy_files_body_data = cls(
            parent=parent,
        ...
        documentcopy_files_body_data.additional_properties = d
        return documentcopy_files_body_data
