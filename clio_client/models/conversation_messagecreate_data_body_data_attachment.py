...
T = TypeVar("T", bound="ConversationMessagecreateDataBodyDataAttachment")


@_attrs_define
class ConversationMessagecreateDataBodyDataAttachment:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversation_messagecreate_data_body_data_attachment = cls(
            document_id=document_id,
            document_version_id=document_version_id,
        )

        conversation_messagecreate_data_body_data_attachment.additional_properties = d
        return conversation_messagecreate_data_body_data_attachment
