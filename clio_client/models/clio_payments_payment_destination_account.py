...
T = TypeVar("T", bound="ClioPaymentsPaymentDestinationAccount")


@_attrs_define
class ClioPaymentsPaymentDestinationAccount:
    """
    Attributes:
        ...
        created_at (Union[Unset, str]): The time the *BankAccount* was created (as a ISO-8601 timestamp)
        ...
        updated_at (Union[Unset, str]): The time the *BankAccount* was last updated (as a ISO-8601 timestamp)
    """

    account_number: Unset | str = UNSET
    balance: Unset | float = UNSET
    bank_transactions_count: Unset | int = UNSET
    clio_payment_page_link: Unset | str = UNSET
    clio_payment_page_qr_code: Unset | str = UNSET
    clio_payments_enabled: Unset | bool = UNSET
    controlled_account: Unset | bool = UNSET
    created_at: Unset | str = UNSET
    currency: Unset | str = UNSET
    default_account: Unset | bool = UNSET
    domicile_branch: Unset | str = UNSET
    etag: Unset | str = UNSET
    general_ledger_number: Unset | str = UNSET
    holder: Unset | str = UNSET
    id: Unset | int = UNSET
    institution: Unset | str = UNSET
    name: Unset | str = UNSET
    swift: Unset | str = UNSET
    transit_number: Unset | str = UNSET
    type_: Unset | BankAccountBaseType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | BankAccountBaseType
        ...
        clio_payments_payment_destination_account = cls(
        ...
        clio_payments_payment_destination_account.additional_properties = d
        return clio_payments_payment_destination_account
