...
from ..models.report_scheduleupdate_files_body_data_frequency import (
    ReportScheduleupdateFilesBodyDataFrequency,
)
from ..models.report_scheduleupdate_files_body_data_time_zone import (
...
class ReportScheduleupdateFilesBodyData:
    ...
    Attributes:
        ...
        time_zone (Union[Unset, ReportScheduleupdateFilesBodyDataTimeZone]): Used in conjunction with `time_of_day` to
    ...
    frequency: Unset | ReportScheduleupdateFilesBodyDataFrequency = UNSET
    report_preset_id: Unset | int = UNSET
    time_of_day: Unset | str = UNSET
    time_zone: Unset | ReportScheduleupdateFilesBodyDataTimeZone = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        frequency: Unset | ReportScheduleupdateFilesBodyDataFrequency
        ...
        time_zone: Unset | ReportScheduleupdateFilesBodyDataTimeZone
        if isinstance(_time_zone, Unset):
            time_zone = UNSET
        else:
            time_zone = ReportScheduleupdateFilesBodyDataTimeZone(_time_zone)
