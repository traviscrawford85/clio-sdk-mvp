...
T = TypeVar("T", bound="FolderupdateFilesBodyDataExternalPropertiesItem")


@_attrs_define
class FolderupdateFilesBodyDataExternalPropertiesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        folderupdate_files_body_data_external_properties_item = cls(
        ...
        folderupdate_files_body_data_external_properties_item.additional_properties = d
        return folderupdate_files_body_data_external_properties_item
