...
T = TypeVar("T", bound="MattercreateFilesBodyDataSplitInvoicePayersItem")


@_attrs_define
class MattercreateFilesBodyDataSplitInvoicePayersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mattercreate_files_body_data_split_invoice_payers_item = cls(
            contact_id=contact_id,
            split_portion=split_portion,
            send_to_bill_recipients=send_to_bill_recipients,
        )

        mattercreate_files_body_data_split_invoice_payers_item.additional_properties = d
        return mattercreate_files_body_data_split_invoice_payers_item
