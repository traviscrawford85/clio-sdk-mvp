...
class TaskupdateJsonBodyData:
    ...
    cascading_offset_polarity: Unset | TaskupdateJsonBodyDataCascadingOffsetPolarity = (
        UNSET
    )
    cascading_offset_type: Unset | TaskupdateJsonBodyDataCascadingOffsetType = UNSET
    ...
    permission: Unset | TaskupdateJsonBodyDataPermission = (
        TaskupdateJsonBodyDataPermission.PUBLIC
    )
    priority: Unset | TaskupdateJsonBodyDataPriority = (
        TaskupdateJsonBodyDataPriority.NORMAL
    )
    status: Unset | TaskupdateJsonBodyDataStatus = TaskupdateJsonBodyDataStatus.PENDING
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assignee: Unset | TaskupdateJsonBodyDataAssignee
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = TaskupdateJsonBodyDataCascadingOffsetPolarity(
                _cascading_offset_polarity
            )

        _cascading_offset_type = d.pop("cascading_offset_type", UNSET)
        cascading_offset_type: Unset | TaskupdateJsonBodyDataCascadingOffsetType
        if isinstance(_cascading_offset_type, Unset):
            cascading_offset_type = UNSET
        else:
            cascading_offset_type = TaskupdateJsonBodyDataCascadingOffsetType(
        ...
        matter: Unset | TaskupdateJsonBodyDataMatter
        ...
        status: Unset | TaskupdateJsonBodyDataStatus
        ...
        task_type: Unset | TaskupdateJsonBodyDataTaskType
