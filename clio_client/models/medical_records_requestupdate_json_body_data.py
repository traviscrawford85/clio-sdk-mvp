...
class MedicalRecordsRequestupdateJsonBodyData:
    ...
    bills_status: Unset | MedicalRecordsRequestupdateJsonBodyDataBillsStatus = UNSET
    description: Unset | str = UNSET
    in_treatment: Unset | bool = UNSET
    medical_bills: (
        Unset | list["MedicalRecordsRequestupdateJsonBodyDataMedicalBillsItem"]
    ) = UNSET
    medical_provider_id: Unset | int = UNSET
    medical_records: (
        Unset | list["MedicalRecordsRequestupdateJsonBodyDataMedicalRecordsItem"]
    ) = UNSET
    records_follow_up_date: Unset | str = UNSET
    records_request_date: Unset | str = UNSET
    records_status: Unset | MedicalRecordsRequestupdateJsonBodyDataRecordsStatus = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bills_status: Unset | MedicalRecordsRequestupdateJsonBodyDataBillsStatus
        if isinstance(_bills_status, Unset):
            bills_status = UNSET
        else:
            bills_status = MedicalRecordsRequestupdateJsonBodyDataBillsStatus(
                _bills_status
            )
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = (
                MedicalRecordsRequestupdateJsonBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = (
                MedicalRecordsRequestupdateJsonBodyDataMedicalRecordsItem.from_dict(
        ...
        records_status: Unset | MedicalRecordsRequestupdateJsonBodyDataRecordsStatus
        if isinstance(_records_status, Unset):
            records_status = UNSET
        else:
            records_status = MedicalRecordsRequestupdateJsonBodyDataRecordsStatus(
                _records_status
            )
