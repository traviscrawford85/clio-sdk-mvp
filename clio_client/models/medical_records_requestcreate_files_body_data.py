...
class MedicalRecordsRequestcreateFilesBodyData:
    ...
    medical_bills: (
        Unset | list["MedicalRecordsRequestcreateFilesBodyDataMedicalBillsItem"]
    ) = UNSET
    medical_records: (
        Unset | list["MedicalRecordsRequestcreateFilesBodyDataMedicalRecordsItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = (
                MedicalRecordsRequestcreateFilesBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = (
                MedicalRecordsRequestcreateFilesBodyDataMedicalRecordsItem.from_dict(
