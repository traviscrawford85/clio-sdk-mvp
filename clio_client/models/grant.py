...
class Grant:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        grant_funding_source: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grant_funding_source: Unset | GrantGrantFundingSource
        if isinstance(_grant_funding_source, Unset):
            grant_funding_source = UNSET
        else:
            grant_funding_source = GrantGrantFundingSource.from_dict(
                _grant_funding_source
            )
