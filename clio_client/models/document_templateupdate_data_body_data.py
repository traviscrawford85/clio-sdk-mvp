...
class DocumentTemplateupdateDataBodyData:
    ...
    document_category: Union[
        Unset, "DocumentTemplateupdateDataBodyDataDocumentCategory"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentTemplateupdateDataBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = (
                DocumentTemplateupdateDataBodyDataDocumentCategory.from_dict(
                    _document_category
                )
            )
