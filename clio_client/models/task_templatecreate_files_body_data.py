...
from ..models.task_templatecreate_files_body_data_priority import (
...
class TaskTemplatecreateFilesBodyData:
    ...
    cascading_offset_polarity: (
        Unset | TaskTemplatecreateFilesBodyDataCascadingOffsetPolarity
    ) = UNSET
    cascading_offset_type: (
        Unset | TaskTemplatecreateFilesBodyDataCascadingOffsetType
    ) = UNSET
    cascading_source: Union[Unset, "TaskTemplatecreateFilesBodyDataCascadingSource"] = (
        UNSET
    )
    description: Unset | str = UNSET
    priority: Unset | TaskTemplatecreateFilesBodyDataPriority = (
        TaskTemplatecreateFilesBodyDataPriority.NORMAL
    )
    private: Unset | bool = UNSET
    reminder_templates: (
        Unset | list["TaskTemplatecreateFilesBodyDataReminderTemplatesItem"]
    ) = UNSET
    task_template_list: Union[
        Unset, "TaskTemplatecreateFilesBodyDataTaskTemplateList"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = TaskTemplatecreateFilesBodyDataCascadingOffsetType(
                _cascading_offset_type
            )

        _cascading_source = d.pop("cascading_source", UNSET)
        cascading_source: Unset | TaskTemplatecreateFilesBodyDataCascadingSource
        if isinstance(_cascading_source, Unset):
            cascading_source = UNSET
        else:
            cascading_source = TaskTemplatecreateFilesBodyDataCascadingSource.from_dict(
                _cascading_source
            )
        ...
        for reminder_templates_item_data in _reminder_templates or []:
            reminder_templates_item = (
                TaskTemplatecreateFilesBodyDataReminderTemplatesItem.from_dict(
        ...
        task_template_list: Unset | TaskTemplatecreateFilesBodyDataTaskTemplateList
        if isinstance(_task_template_list, Unset):
            task_template_list = UNSET
        else:
            task_template_list = (
                TaskTemplatecreateFilesBodyDataTaskTemplateList.from_dict(
                    _task_template_list
                )
            )
