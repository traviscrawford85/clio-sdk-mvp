...
class CalendarupdateJsonBodyData:
    ...
    color: Unset | CalendarupdateJsonBodyDataColor = UNSET
    name: Unset | str = UNSET
    source: Unset | CalendarupdateJsonBodyDataSource = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: Unset | CalendarupdateJsonBodyDataColor
        ...
        source: Unset | CalendarupdateJsonBodyDataSource
