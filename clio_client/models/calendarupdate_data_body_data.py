...
from ..models.calendarupdate_data_body_data_source import (
...
class CalendarupdateDataBodyData:
    ...
    color: Unset | CalendarupdateDataBodyDataColor = UNSET
    name: Unset | str = UNSET
    source: Unset | CalendarupdateDataBodyDataSource = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: Unset | CalendarupdateDataBodyDataColor
        ...
        source: Unset | CalendarupdateDataBodyDataSource
