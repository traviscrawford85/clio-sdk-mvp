...
T = TypeVar("T", bound="TrustRequestcreateFilesBodyDataMatterItem")


@_attrs_define
class TrustRequestcreateFilesBodyDataMatterItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trust_requestcreate_files_body_data_matter_item = cls(
            id=id,
            note=note,
            trust_amount=trust_amount,
        )

        trust_requestcreate_files_body_data_matter_item.additional_properties = d
        return trust_requestcreate_files_body_data_matter_item
