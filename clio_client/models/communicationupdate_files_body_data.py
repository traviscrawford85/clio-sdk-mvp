...
from ..models.communicationupdate_files_body_data_type import (
...
if TYPE_CHECKING:
    ...
    from ..models.communicationupdate_files_body_data_matter import (
...
class CommunicationupdateFilesBodyData:
    ...
    external_properties: (
        Unset | list["CommunicationupdateFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    receivers: Unset | list["CommunicationupdateFilesBodyDataReceiversItem"] = UNSET
    senders: Unset | list["CommunicationupdateFilesBodyDataSendersItem"] = UNSET
    subject: Unset | str = UNSET
    type_: Unset | CommunicationupdateFilesBodyDataType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CommunicationupdateFilesBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CommunicationupdateFilesBodyDataMatter
        ...
        for notification_event_subscribers_item_data in (
            ...
            notification_event_subscribers_item = CommunicationupdateFilesBodyDataNotificationEventSubscribersItem.from_dict(
                notification_event_subscribers_item_data
            )
        ...
        for receivers_item_data in _receivers or []:
            receivers_item = CommunicationupdateFilesBodyDataReceiversItem.from_dict(
                receivers_item_data
            )
        ...
        for senders_item_data in _senders or []:
            senders_item = CommunicationupdateFilesBodyDataSendersItem.from_dict(
                senders_item_data
            )
        ...
        type_: Unset | CommunicationupdateFilesBodyDataType
