...
class TaskTemplate:
    ...
    priority: Unset | TaskTemplateBasePriority = UNSET
    ...
    reminder_templates: Unset | list["ReminderTemplateBase"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        template_creator: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        priority: Unset | TaskTemplateBasePriority
        ...
        assignee: Unset | TaskTemplateAssignee
        ...
        cascading_source: Unset | TaskTemplateCascadingSource
        ...
        for reminder_templates_item_data in _reminder_templates or []:
            reminder_templates_item = ReminderTemplateBase.from_dict(
        ...
        task_template_list: Unset | TaskTemplateTaskTemplateList
        if isinstance(_task_template_list, Unset):
            task_template_list = UNSET
        else:
            task_template_list = TaskTemplateTaskTemplateList.from_dict(
                _task_template_list
            )

        _task_type = d.pop("task_type", UNSET)
        task_type: Unset | TaskTemplateTaskType
        ...
        template_creator: Unset | TaskTemplateTemplateCreator
