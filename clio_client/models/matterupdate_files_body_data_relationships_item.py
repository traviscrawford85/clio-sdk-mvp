...
if TYPE_CHECKING:
    from ..models.matterupdate_files_body_data_relationships_item_contact import (
        MatterupdateFilesBodyDataRelationshipsItemContact,
    )


T = TypeVar("T", bound="MatterupdateFilesBodyDataRelationshipsItem")


@_attrs_define
class MatterupdateFilesBodyDataRelationshipsItem:
    """
    Attributes:
        ...
        contact (Union[Unset, MatterupdateFilesBodyDataRelationshipsItemContact]):
    ...
    contact: Union[Unset, "MatterupdateFilesBodyDataRelationshipsItemContact"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact: Unset | MatterupdateFilesBodyDataRelationshipsItemContact
        if isinstance(_contact, Unset):
            contact = UNSET
        else:
            contact = MatterupdateFilesBodyDataRelationshipsItemContact.from_dict(
                _contact
            )
        ...
        matterupdate_files_body_data_relationships_item = cls(
        ...
        matterupdate_files_body_data_relationships_item.additional_properties = d
        return matterupdate_files_body_data_relationships_item
