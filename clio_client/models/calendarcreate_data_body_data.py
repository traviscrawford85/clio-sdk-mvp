...
from ..models.calendarcreate_data_body_data_source import (
...
class CalendarcreateDataBodyData:
    ...
    name: str
    color: Unset | CalendarcreateDataBodyDataColor = UNSET
    source: Unset | CalendarcreateDataBodyDataSource = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: Unset | CalendarcreateDataBodyDataColor
        ...
        source: Unset | CalendarcreateDataBodyDataSource
