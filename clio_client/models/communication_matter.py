...
T = TypeVar("T", bound="CommunicationMatter")


@_attrs_define
class CommunicationMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        communication_matter.additional_properties = d
        return communication_matter
