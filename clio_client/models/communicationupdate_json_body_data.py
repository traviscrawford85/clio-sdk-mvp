...
class CommunicationupdateJsonBodyData:
    ...
    external_properties: (
        Unset | list["CommunicationupdateJsonBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    receivers: Unset | list["CommunicationupdateJsonBodyDataReceiversItem"] = UNSET
    senders: Unset | list["CommunicationupdateJsonBodyDataSendersItem"] = UNSET
    subject: Unset | str = UNSET
    type_: Unset | CommunicationupdateJsonBodyDataType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CommunicationupdateJsonBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CommunicationupdateJsonBodyDataMatter
        ...
        for notification_event_subscribers_item_data in (
            ...
            notification_event_subscribers_item = CommunicationupdateJsonBodyDataNotificationEventSubscribersItem.from_dict(
                notification_event_subscribers_item_data
            )
        ...
        for receivers_item_data in _receivers or []:
            receivers_item = CommunicationupdateJsonBodyDataReceiversItem.from_dict(
                receivers_item_data
            )
        ...
        for senders_item_data in _senders or []:
            senders_item = CommunicationupdateJsonBodyDataSendersItem.from_dict(
                senders_item_data
            )
        ...
        type_: Unset | CommunicationupdateJsonBodyDataType
