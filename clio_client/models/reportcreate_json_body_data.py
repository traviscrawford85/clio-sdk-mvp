...
class ReportcreateJsonBodyData:
    ...
    originating_attorney: Union[
        Unset, "ReportcreateJsonBodyDataOriginatingAttorney"
    ] = UNSET
    practice_area: Union[Unset, "ReportcreateJsonBodyDataPracticeArea"] = UNSET
    responsible_attorney: Union[
        Unset, "ReportcreateJsonBodyDataResponsibleAttorney"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        client: Unset | ReportcreateJsonBodyDataClient
        ...
        matter: Unset | ReportcreateJsonBodyDataMatter
        ...
        originating_attorney: Unset | ReportcreateJsonBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                ReportcreateJsonBodyDataOriginatingAttorney.from_dict(
                    _originating_attorney
                )
            )

        _practice_area = d.pop("practice_area", UNSET)
        practice_area: Unset | ReportcreateJsonBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = ReportcreateJsonBodyDataPracticeArea.from_dict(
                _practice_area
            )

        _responsible_attorney = d.pop("responsible_attorney", UNSET)
        responsible_attorney: Unset | ReportcreateJsonBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                ReportcreateJsonBodyDataResponsibleAttorney.from_dict(
        ...
        user: Unset | ReportcreateJsonBodyDataUser
