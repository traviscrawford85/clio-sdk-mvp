...
T = TypeVar("T", bound="TextSnippetcreateFilesBodyData")


@_attrs_define
class TextSnippetcreateFilesBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_snippetcreate_files_body_data = cls(
            phrase=phrase,
            snippet=snippet,
            whole_word=whole_word,
        )

        text_snippetcreate_files_body_data.additional_properties = d
        return text_snippetcreate_files_body_data
