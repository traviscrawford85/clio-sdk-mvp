...
if TYPE_CHECKING:
    from ..models.custom_fieldupdate_data_body_data_picklist_options_item import (
        CustomFieldupdateDataBodyDataPicklistOptionsItem,
    )


T = TypeVar("T", bound="CustomFieldupdateDataBodyData")


@_attrs_define
class CustomFieldupdateDataBodyData:
    """
    Attributes:
        ...
        picklist_options (Union[Unset, list['CustomFieldupdateDataBodyDataPicklistOptionsItem']]):
    ...
    picklist_options: (
        Unset | list["CustomFieldupdateDataBodyDataPicklistOptionsItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for picklist_options_item_data in _picklist_options or []:
            picklist_options_item = (
                CustomFieldupdateDataBodyDataPicklistOptionsItem.from_dict(
        ...
        custom_fieldupdate_data_body_data = cls(
        ...
        custom_fieldupdate_data_body_data.additional_properties = d
        return custom_fieldupdate_data_body_data
