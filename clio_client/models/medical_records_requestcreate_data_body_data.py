...
class MedicalRecordsRequestcreateDataBodyData:
    ...
    medical_bills: (
        Unset | list["MedicalRecordsRequestcreateDataBodyDataMedicalBillsItem"]
    ) = UNSET
    medical_records: (
        Unset | list["MedicalRecordsRequestcreateDataBodyDataMedicalRecordsItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = (
                MedicalRecordsRequestcreateDataBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = (
                MedicalRecordsRequestcreateDataBodyDataMedicalRecordsItem.from_dict(
