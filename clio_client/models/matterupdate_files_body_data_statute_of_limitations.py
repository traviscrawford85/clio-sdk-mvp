...
class MatterupdateFilesBodyDataStatuteOfLimitations:
    ...
    reminders: (
        Unset | list["MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItem"]
    ) = UNSET
    status: Unset | MatterupdateFilesBodyDataStatuteOfLimitationsStatus = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for reminders_item_data in _reminders or []:
            reminders_item = (
                MatterupdateFilesBodyDataStatuteOfLimitationsRemindersItem.from_dict(
                    reminders_item_data
                )
            )
        ...
        status: Unset | MatterupdateFilesBodyDataStatuteOfLimitationsStatus
