...
@_attrs_define
class DocumentcreateDataBodyDataParent:
    """
    Attributes:
        id (int): The unique identifier of the parent object.
        type_ (DocumentcreateDataBodyDataParentType): Type of parent object:
    ...
    id: int
    type_: DocumentcreateDataBodyDataParentType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DocumentcreateDataBodyDataParentType(d.pop("type"))

        documentcreate_data_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        documentcreate_data_body_data_parent.additional_properties = d
        return documentcreate_data_body_data_parent
