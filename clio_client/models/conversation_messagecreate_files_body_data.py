...
class ConversationMessagecreateFilesBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for receivers_item_data in _receivers:
            receivers_item = (
                ConversationMessagecreateFilesBodyDataReceiversItem.from_dict(
                    receivers_item_data
                )
            )
        ...
        attachment: Unset | ConversationMessagecreateFilesBodyDataAttachment
        if isinstance(_attachment, Unset):
            attachment = UNSET
        else:
            attachment = ConversationMessagecreateFilesBodyDataAttachment.from_dict(
                _attachment
            )

        _conversation = d.pop("conversation", UNSET)
        conversation: Unset | ConversationMessagecreateFilesBodyDataConversation
        if isinstance(_conversation, Unset):
            conversation = UNSET
        else:
            conversation = ConversationMessagecreateFilesBodyDataConversation.from_dict(
                _conversation
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ConversationMessagecreateFilesBodyDataMatter
