...
from ..models.reminderupdate_data_body_data_duration_unit import (
...
class ReminderupdateDataBodyData:
    ...
    duration_unit: Unset | ReminderupdateDataBodyDataDurationUnit = UNSET
    duration_value: Unset | int = UNSET
    notification_method: Union[
        Unset, "ReminderupdateDataBodyDataNotificationMethod"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duration_unit: Unset | ReminderupdateDataBodyDataDurationUnit
        ...
        notification_method: Unset | ReminderupdateDataBodyDataNotificationMethod
        if isinstance(_notification_method, Unset):
            notification_method = UNSET
        else:
            notification_method = (
                ReminderupdateDataBodyDataNotificationMethod.from_dict(
