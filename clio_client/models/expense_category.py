...
class ExpenseCategory:
    ...
    Attributes:
        ...
        utbms_code (Union[Unset, ExpenseCategoryUtbmsCode]):
    """
    ...
    utbms_code: Union[Unset, "ExpenseCategoryUtbmsCode"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        utbms_code: Unset | ExpenseCategoryUtbmsCode
        if isinstance(_utbms_code, Unset):
            utbms_code = UNSET
        else:
            utbms_code = ExpenseCategoryUtbmsCode.from_dict(_utbms_code)
