...
class TaskTemplateupdateJsonBodyData:
    ...
    cascading_offset_polarity: (
        Unset | TaskTemplateupdateJsonBodyDataCascadingOffsetPolarity
    ) = UNSET
    cascading_offset_type: Unset | TaskTemplateupdateJsonBodyDataCascadingOffsetType = (
        UNSET
    )
    cascading_source: Union[Unset, "TaskTemplateupdateJsonBodyDataCascadingSource"] = (
        UNSET
    ...
    priority: Unset | TaskTemplateupdateJsonBodyDataPriority = (
        TaskTemplateupdateJsonBodyDataPriority.NORMAL
    )
    private: Unset | bool = UNSET
    reminder_templates: (
        Unset | list["TaskTemplateupdateJsonBodyDataReminderTemplatesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = TaskTemplateupdateJsonBodyDataCascadingOffsetType(
                _cascading_offset_type
            )

        _cascading_source = d.pop("cascading_source", UNSET)
        cascading_source: Unset | TaskTemplateupdateJsonBodyDataCascadingSource
        if isinstance(_cascading_source, Unset):
            cascading_source = UNSET
        else:
            cascading_source = TaskTemplateupdateJsonBodyDataCascadingSource.from_dict(
                _cascading_source
            )
        ...
        for reminder_templates_item_data in _reminder_templates or []:
            reminder_templates_item = (
                TaskTemplateupdateJsonBodyDataReminderTemplatesItem.from_dict(
