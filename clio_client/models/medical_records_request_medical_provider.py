...
T = TypeVar("T", bound="MedicalRecordsRequestMedicalProvider")


@_attrs_define
class MedicalRecordsRequestMedicalProvider:
    """
    Attributes:
    ...
    has_clio_for_clients_permission: Unset | bool = UNSET
    id: Unset | int = UNSET
    initials: Unset | str = UNSET
    is_bill_recipient: Unset | bool = UNSET
    is_client: Unset | bool = UNSET
    is_clio_for_client_user: Unset | bool = UNSET
    is_co_counsel: Unset | bool = UNSET
    last_name: Unset | str = UNSET
    ledes_client_id: Unset | str = UNSET
    locked_clio_connect_email: Unset | bool = UNSET
    ...
    type_: Unset | ContactBaseType = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if has_clio_for_clients_permission is not UNSET:
            field_dict["has_clio_for_clients_permission"] = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        has_clio_for_clients_permission = d.pop(
            "has_clio_for_clients_permission", UNSET
        )
        ...
        medical_records_request_medical_provider = cls(
        ...
        medical_records_request_medical_provider.additional_properties = d
        return medical_records_request_medical_provider
