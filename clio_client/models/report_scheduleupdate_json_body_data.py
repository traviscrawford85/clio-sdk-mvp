...
class ReportScheduleupdateJsonBodyData:
    ...
    frequency: Unset | ReportScheduleupdateJsonBodyDataFrequency = UNSET
    report_preset_id: Unset | int = UNSET
    time_of_day: Unset | str = UNSET
    time_zone: Unset | ReportScheduleupdateJsonBodyDataTimeZone = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        frequency: Unset | ReportScheduleupdateJsonBodyDataFrequency
        ...
        time_zone: Unset | ReportScheduleupdateJsonBodyDataTimeZone
