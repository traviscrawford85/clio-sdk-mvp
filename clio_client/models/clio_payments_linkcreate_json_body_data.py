...
if TYPE_CHECKING:
    from ..models.clio_payments_linkcreate_json_body_data_destination_account import (
        ClioPaymentsLinkcreateJsonBodyDataDestinationAccount,
    )
    from ..models.clio_payments_linkcreate_json_body_data_destination_contact import (
        ClioPaymentsLinkcreateJsonBodyDataDestinationContact,
    )
    from ..models.clio_payments_linkcreate_json_body_data_subject import (
        ClioPaymentsLinkcreateJsonBodyDataSubject,
    )


T = TypeVar("T", bound="ClioPaymentsLinkcreateJsonBodyData")


@_attrs_define
class ClioPaymentsLinkcreateJsonBodyData:
    """
    Attributes:
        ...
        description (str): Only applicable for a direct payment. A short description of the purpose of the payment. Max
            255 characters.
        destination_account (ClioPaymentsLinkcreateJsonBodyDataDestinationAccount):
        ...
        subject (ClioPaymentsLinkcreateJsonBodyDataSubject):
        amount (Union[Unset, float]): The amount to be paid. If not provided, the client will be able to specify an
            amount.
        destination_contact (Union[Unset, ClioPaymentsLinkcreateJsonBodyDataDestinationContact]):
    ...
    destination_contact: Union[
        Unset, "ClioPaymentsLinkcreateJsonBodyDataDestinationContact"
    ] = UNSET
    email_address: Unset | str = UNSET
    is_allocated_as_revenue: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        destination_contact: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        destination_account = (
            ClioPaymentsLinkcreateJsonBodyDataDestinationAccount.from_dict(
        ...
        subject = ClioPaymentsLinkcreateJsonBodyDataSubject.from_dict(d.pop("subject"))
        ...
        if isinstance(_destination_contact, Unset):
            ...
            destination_contact = (
                ClioPaymentsLinkcreateJsonBodyDataDestinationContact.from_dict(
                    _destination_contact
                )
            )
        ...
        clio_payments_linkcreate_json_body_data = cls(
            currency=currency,
            description=description,
            destination_account=destination_account,
            duration=duration,
        ...
        clio_payments_linkcreate_json_body_data.additional_properties = d
        return clio_payments_linkcreate_json_body_data
