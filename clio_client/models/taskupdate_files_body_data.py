...
class TaskupdateFilesBodyData:
    ...
    cascading_offset_polarity: (
        Unset | TaskupdateFilesBodyDataCascadingOffsetPolarity
    ) = UNSET
    cascading_offset_type: Unset | TaskupdateFilesBodyDataCascadingOffsetType = UNSET
    ...
    permission: Unset | TaskupdateFilesBodyDataPermission = (
        TaskupdateFilesBodyDataPermission.PUBLIC
    )
    priority: Unset | TaskupdateFilesBodyDataPriority = (
        TaskupdateFilesBodyDataPriority.NORMAL
    )
    status: Unset | TaskupdateFilesBodyDataStatus = (
        TaskupdateFilesBodyDataStatus.PENDING
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assignee: Unset | TaskupdateFilesBodyDataAssignee
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = TaskupdateFilesBodyDataCascadingOffsetPolarity(
                _cascading_offset_polarity
            )

        _cascading_offset_type = d.pop("cascading_offset_type", UNSET)
        cascading_offset_type: Unset | TaskupdateFilesBodyDataCascadingOffsetType
        if isinstance(_cascading_offset_type, Unset):
            cascading_offset_type = UNSET
        else:
            cascading_offset_type = TaskupdateFilesBodyDataCascadingOffsetType(
        ...
        matter: Unset | TaskupdateFilesBodyDataMatter
        ...
        task_type: Unset | TaskupdateFilesBodyDataTaskType
