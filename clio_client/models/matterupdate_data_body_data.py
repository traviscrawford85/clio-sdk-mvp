...
if TYPE_CHECKING:
    from ..models.matterupdate_data_body_data_client import (
    ...
    from ..models.matterupdate_data_body_data_custom_rate import (
        MatterupdateDataBodyDataCustomRate,
    )
    from ..models.matterupdate_data_body_data_evergreen_retainer import (
    ...
    from ..models.matterupdate_data_body_data_matter_budget import (
        MatterupdateDataBodyDataMatterBudget,
    )
    from ..models.matterupdate_data_body_data_matter_stage import (
    ...
    from ..models.matterupdate_data_body_data_practice_area import (
        MatterupdateDataBodyDataPracticeArea,
    )
    from ..models.matterupdate_data_body_data_relationships_item import (
...
class MatterupdateDataBodyData:
    ...
    custom_field_set_associations: (
        Unset | list["MatterupdateDataBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["MatterupdateDataBodyDataCustomFieldValuesItem"]
    ) = UNSET
    ...
    originating_attorney: Union[
        Unset, "MatterupdateDataBodyDataOriginatingAttorney"
    ] = UNSET
    pending_date: Unset | str = UNSET
    practice_area: Union[Unset, "MatterupdateDataBodyDataPracticeArea"] = UNSET
    relationships: Unset | list["MatterupdateDataBodyDataRelationshipsItem"] = UNSET
    reset_matter_number: Unset | bool = False
    responsible_attorney: Union[
        Unset, "MatterupdateDataBodyDataResponsibleAttorney"
    ] = UNSET
    split_invoice_payers: (
        Unset | list["MatterupdateDataBodyDataSplitInvoicePayersItem"]
    ) = UNSET
    status: Unset | MatterupdateDataBodyDataStatus = UNSET
    statute_of_limitations: Union[
        Unset, "MatterupdateDataBodyDataStatuteOfLimitations"
    ] = UNSET
    task_template_list_instances: (
        Unset | list["MatterupdateDataBodyDataTaskTemplateListInstancesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.matterupdate_data_body_data_group import (
        ...
        client: Unset | MatterupdateDataBodyDataClient
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                MatterupdateDataBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                MatterupdateDataBodyDataCustomFieldValuesItem.from_dict(
        ...
        custom_rate: Unset | MatterupdateDataBodyDataCustomRate
        ...
        evergreen_retainer: Unset | MatterupdateDataBodyDataEvergreenRetainer
        if isinstance(_evergreen_retainer, Unset):
            evergreen_retainer = UNSET
        else:
            evergreen_retainer = MatterupdateDataBodyDataEvergreenRetainer.from_dict(
                _evergreen_retainer
            )

        _group = d.pop("group", UNSET)
        group: Unset | MatterupdateDataBodyDataGroup
        ...
        matter_budget: Unset | MatterupdateDataBodyDataMatterBudget
        if isinstance(_matter_budget, Unset):
            matter_budget = UNSET
        else:
            matter_budget = MatterupdateDataBodyDataMatterBudget.from_dict(
                _matter_budget
            )

        _matter_stage = d.pop("matter_stage", UNSET)
        matter_stage: Unset | MatterupdateDataBodyDataMatterStage
        ...
        originating_attorney: Unset | MatterupdateDataBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                MatterupdateDataBodyDataOriginatingAttorney.from_dict(
        ...
        practice_area: Unset | MatterupdateDataBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = MatterupdateDataBodyDataPracticeArea.from_dict(
                _practice_area
            )
        ...
        for relationships_item_data in _relationships or []:
            relationships_item = MatterupdateDataBodyDataRelationshipsItem.from_dict(
        ...
        responsible_attorney: Unset | MatterupdateDataBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                MatterupdateDataBodyDataResponsibleAttorney.from_dict(
        ...
        for split_invoice_payers_item_data in _split_invoice_payers or []:
            split_invoice_payers_item = (
                MatterupdateDataBodyDataSplitInvoicePayersItem.from_dict(
        ...
        status: Unset | MatterupdateDataBodyDataStatus
        ...
        statute_of_limitations: Unset | MatterupdateDataBodyDataStatuteOfLimitations
        if isinstance(_statute_of_limitations, Unset):
            statute_of_limitations = UNSET
        else:
            statute_of_limitations = (
                MatterupdateDataBodyDataStatuteOfLimitations.from_dict(
        ...
        for task_template_list_instances_item_data in (
            ...
            task_template_list_instances_item = (
                MatterupdateDataBodyDataTaskTemplateListInstancesItem.from_dict(
                    task_template_list_instances_item_data
                )
            )
