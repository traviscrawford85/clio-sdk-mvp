...
@_attrs_define
class MedicalBillupdateDataBody:
    """
    Attributes:
        data (MedicalBillupdateDataBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        medical_billupdate_data_body = cls(
            data=data,
        )

        medical_billupdate_data_body.additional_properties = d
        return medical_billupdate_data_body
