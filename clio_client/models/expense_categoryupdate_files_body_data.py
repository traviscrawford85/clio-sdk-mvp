...
class ExpenseCategoryupdateFilesBodyData:
    ...
    entry_type: Unset | ExpenseCategoryupdateFilesBodyDataEntryType = UNSET
    groups: Unset | list["ExpenseCategoryupdateFilesBodyDataGroupsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entry_type: Unset | ExpenseCategoryupdateFilesBodyDataEntryType
        ...
        for groups_item_data in _groups or []:
            groups_item = ExpenseCategoryupdateFilesBodyDataGroupsItem.from_dict(
                groups_item_data
            )
        ...
        utbms_code: Unset | ExpenseCategoryupdateFilesBodyDataUtbmsCode
        if isinstance(_utbms_code, Unset):
            utbms_code = UNSET
        else:
            utbms_code = ExpenseCategoryupdateFilesBodyDataUtbmsCode.from_dict(
                _utbms_code
            )
