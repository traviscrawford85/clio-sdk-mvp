...
T = TypeVar("T", bound="TrustLineItemMatter")


@_attrs_define
class TrustLineItemMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trust_line_item_matter.additional_properties = d
        return trust_line_item_matter
