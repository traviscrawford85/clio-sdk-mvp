...
if TYPE_CHECKING:
    from ..models.document_templateupdate_json_body_data_document_category import (
        DocumentTemplateupdateJsonBodyDataDocumentCategory,
    )


T = TypeVar("T", bound="DocumentTemplateupdateJsonBodyData")


@_attrs_define
class DocumentTemplateupdateJsonBodyData:
    """
    Attributes:
        document_category (Union[Unset, DocumentTemplateupdateJsonBodyDataDocumentCategory]):
    ...
    document_category: Union[
        Unset, "DocumentTemplateupdateJsonBodyDataDocumentCategory"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentTemplateupdateJsonBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = (
                DocumentTemplateupdateJsonBodyDataDocumentCategory.from_dict(
                    _document_category
                )
            )
        ...
        document_templateupdate_json_body_data = cls(
            document_category=document_category,
            file=file,
            filename=filename,
        )

        document_templateupdate_json_body_data.additional_properties = d
        return document_templateupdate_json_body_data
