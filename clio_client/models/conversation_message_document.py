...
T = TypeVar("T", bound="ConversationMessageDocument")
...
class ConversationMessageDocument:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversation_message_document = cls(
        ...
        conversation_message_document.additional_properties = d
        return conversation_message_document
