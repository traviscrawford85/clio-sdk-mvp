...
T = TypeVar("T", bound="MatterupdateFilesBodyDataMatterBudget")


@_attrs_define
class MatterupdateFilesBodyDataMatterBudget:
    """
    Attributes:
    ...
    budget: Unset | float = UNSET
    include_expenses: Unset | bool = UNSET
    notification_threshold: Unset | int = UNSET
    notify_users: Unset | bool = False
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matterupdate_files_body_data_matter_budget = cls(
        ...
        matterupdate_files_body_data_matter_budget.additional_properties = d
        return matterupdate_files_body_data_matter_budget
