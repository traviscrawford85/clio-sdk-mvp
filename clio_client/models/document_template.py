...
class DocumentTemplate:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        last_modified_by: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentTemplateDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = DocumentTemplateDocumentCategory.from_dict(
                _document_category
            )

        _last_modified_by = d.pop("last_modified_by", UNSET)
        last_modified_by: Unset | DocumentTemplateLastModifiedBy
        if isinstance(_last_modified_by, Unset):
            last_modified_by = UNSET
        else:
            last_modified_by = DocumentTemplateLastModifiedBy.from_dict(
                _last_modified_by
            )
