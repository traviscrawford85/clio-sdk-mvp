...
T = TypeVar("T", bound="TextSnippetupdateJsonBodyData")


@_attrs_define
class TextSnippetupdateJsonBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_snippetupdate_json_body_data = cls(
            phrase=phrase,
            snippet=snippet,
            whole_word=whole_word,
        )

        text_snippetupdate_json_body_data.additional_properties = d
        return text_snippetupdate_json_body_data
