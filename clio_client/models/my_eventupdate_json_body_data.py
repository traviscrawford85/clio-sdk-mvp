...
T = TypeVar("T", bound="MyEventupdateJsonBodyData")


@_attrs_define
class MyEventupdateJsonBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        my_eventupdate_json_body_data = cls(
            marked_as_read=marked_as_read,
        )

        my_eventupdate_json_body_data.additional_properties = d
        return my_eventupdate_json_body_data
