...
class MatterupdateFilesBodyDataCustomRate:
    ...
    rates: Unset | list["MatterupdateFilesBodyDataCustomRateRatesItem"] = UNSET
    type_: Unset | MatterupdateFilesBodyDataCustomRateType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rates_item_data in _rates or []:
            rates_item = MatterupdateFilesBodyDataCustomRateRatesItem.from_dict(
                rates_item_data
            )
        ...
        type_: Unset | MatterupdateFilesBodyDataCustomRateType
