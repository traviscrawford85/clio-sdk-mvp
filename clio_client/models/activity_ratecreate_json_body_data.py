...
T = TypeVar("T", bound="ActivityRatecreateJsonBodyData")


@_attrs_define
class ActivityRatecreateJsonBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_ratecreate_json_body_data = cls(
        ...
        activity_ratecreate_json_body_data.additional_properties = d
        return activity_ratecreate_json_body_data
