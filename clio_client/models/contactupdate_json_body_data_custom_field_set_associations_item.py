...
if TYPE_CHECKING:
    from ..models.contactupdate_json_body_data_custom_field_set_associations_item_custom_field_set import (
        ContactupdateJsonBodyDataCustomFieldSetAssociationsItemCustomFieldSet,
    )


T = TypeVar("T", bound="ContactupdateJsonBodyDataCustomFieldSetAssociationsItem")


@_attrs_define
class ContactupdateJsonBodyDataCustomFieldSetAssociationsItem:
    """
    Attributes:
        ...
        custom_field_set (Union[Unset, ContactupdateJsonBodyDataCustomFieldSetAssociationsItemCustomFieldSet]):
    ...
    custom_field_set: Union[
        Unset, "ContactupdateJsonBodyDataCustomFieldSetAssociationsItemCustomFieldSet"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_field_set, Unset):
            ...
            custom_field_set = ContactupdateJsonBodyDataCustomFieldSetAssociationsItemCustomFieldSet.from_dict(
                _custom_field_set
            )
        ...
        contactupdate_json_body_data_custom_field_set_associations_item = cls(
        ...
        contactupdate_json_body_data_custom_field_set_associations_item.additional_properties = d
        return contactupdate_json_body_data_custom_field_set_associations_item
