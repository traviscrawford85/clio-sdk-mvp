...
if TYPE_CHECKING:
    from ..models.matterupdate_json_body_data_custom_field_values_item_custom_field import (
        MatterupdateJsonBodyDataCustomFieldValuesItemCustomField,
    )


T = TypeVar("T", bound="MatterupdateJsonBodyDataCustomFieldValuesItem")


@_attrs_define
class MatterupdateJsonBodyDataCustomFieldValuesItem:
    """
    Attributes:
        ...
        custom_field (Union[Unset, MatterupdateJsonBodyDataCustomFieldValuesItemCustomField]):
    ...
    custom_field: Union[
        Unset, "MatterupdateJsonBodyDataCustomFieldValuesItemCustomField"
    ] = UNSET
    id: Unset | int = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field: Unset | MatterupdateJsonBodyDataCustomFieldValuesItemCustomField
        if isinstance(_custom_field, Unset):
            custom_field = UNSET
        else:
            custom_field = (
                MatterupdateJsonBodyDataCustomFieldValuesItemCustomField.from_dict(
                    _custom_field
                )
            )
        ...
        matterupdate_json_body_data_custom_field_values_item = cls(
        ...
        matterupdate_json_body_data_custom_field_values_item.additional_properties = d
        return matterupdate_json_body_data_custom_field_values_item
