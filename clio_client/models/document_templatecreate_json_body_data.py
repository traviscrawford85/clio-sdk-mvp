...
class DocumentTemplatecreateJsonBodyData:
    ...
    document_category: Union[
        Unset, "DocumentTemplatecreateJsonBodyDataDocumentCategory"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentTemplatecreateJsonBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = (
                DocumentTemplatecreateJsonBodyDataDocumentCategory.from_dict(
                    _document_category
                )
            )
