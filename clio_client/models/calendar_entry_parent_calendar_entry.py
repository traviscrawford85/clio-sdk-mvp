...
T = TypeVar("T", bound="CalendarEntryParentCalendarEntry")


@_attrs_define
class CalendarEntryParentCalendarEntry:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calendar_entry_parent_calendar_entry = cls(
            all_day=all_day,
        ...
        calendar_entry_parent_calendar_entry.additional_properties = d
        return calendar_entry_parent_calendar_entry
