...
T = TypeVar("T", bound="ActivityRateupdateJsonBodyData")


@_attrs_define
class ActivityRateupdateJsonBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_rateupdate_json_body_data = cls(
        ...
        activity_rateupdate_json_body_data.additional_properties = d
        return activity_rateupdate_json_body_data
