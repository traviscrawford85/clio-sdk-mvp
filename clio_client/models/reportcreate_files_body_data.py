...
if TYPE_CHECKING:
    from ..models.reportcreate_files_body_data_client import (
        ReportcreateFilesBodyDataClient,
    )
    from ..models.reportcreate_files_body_data_matter import (
    ...
    from ..models.reportcreate_files_body_data_practice_area import (
...
class ReportcreateFilesBodyData:
    ...
    originating_attorney: Union[
        Unset, "ReportcreateFilesBodyDataOriginatingAttorney"
    ] = UNSET
    practice_area: Union[Unset, "ReportcreateFilesBodyDataPracticeArea"] = UNSET
    responsible_attorney: Union[
        Unset, "ReportcreateFilesBodyDataResponsibleAttorney"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.reportcreate_files_body_data_user import (
        ...
        client: Unset | ReportcreateFilesBodyDataClient
        ...
        matter: Unset | ReportcreateFilesBodyDataMatter
        ...
        originating_attorney: Unset | ReportcreateFilesBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                ReportcreateFilesBodyDataOriginatingAttorney.from_dict(
                    _originating_attorney
                )
            )

        _practice_area = d.pop("practice_area", UNSET)
        practice_area: Unset | ReportcreateFilesBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = ReportcreateFilesBodyDataPracticeArea.from_dict(
                _practice_area
            )

        _responsible_attorney = d.pop("responsible_attorney", UNSET)
        responsible_attorney: Unset | ReportcreateFilesBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                ReportcreateFilesBodyDataResponsibleAttorney.from_dict(
        ...
        user: Unset | ReportcreateFilesBodyDataUser
