...
@_attrs_define
class DocumentTemplatecreateFilesBody:
    """
    Attributes:
        data (DocumentTemplatecreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_templatecreate_files_body = cls(
            data=data,
        )

        document_templatecreate_files_body.additional_properties = d
        return document_templatecreate_files_body
