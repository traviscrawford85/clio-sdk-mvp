...
from ..models.billupdate_files_body_data_interest_type import (
...
class BillupdateFilesBodyDataInterest:
    ...
    type_: Unset | BillupdateFilesBodyDataInterestType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | BillupdateFilesBodyDataInterestType
