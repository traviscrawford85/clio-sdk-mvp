...
if TYPE_CHECKING:
    from ..models.folderupdate_files_body_data_document_category import (
    ...
    from ..models.folderupdate_files_body_data_parent import (
...
class FolderupdateFilesBodyData:
    ...
    external_properties: (
        Unset | list["FolderupdateFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | FolderupdateFilesBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = FolderupdateFilesBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                FolderupdateFilesBodyDataExternalPropertiesItem.from_dict(
        ...
        parent: Unset | FolderupdateFilesBodyDataParent
