...
T = TypeVar("T", bound="DocumentcreateFilesBodyDataMultipartsItem")


@_attrs_define
class DocumentcreateFilesBodyDataMultipartsItem:
    """
    Attributes:
        content_length (str): The size of the part of the upload file in bytes.
        part_number (int): The part number of multipart upload. It must be an integer between 1 to 10,000, inclusive.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documentcreate_files_body_data_multiparts_item = cls(
            content_length=content_length,
            part_number=part_number,
            content_md5=content_md5,
        )

        documentcreate_files_body_data_multiparts_item.additional_properties = d
        return documentcreate_files_body_data_multiparts_item
