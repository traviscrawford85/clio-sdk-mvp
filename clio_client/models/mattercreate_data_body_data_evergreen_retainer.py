...
if TYPE_CHECKING:
    from ..models.mattercreate_data_body_data_evergreen_retainer_recipients_item import (
        MattercreateDataBodyDataEvergreenRetainerRecipientsItem,
    )


T = TypeVar("T", bound="MattercreateDataBodyDataEvergreenRetainer")


@_attrs_define
class MattercreateDataBodyDataEvergreenRetainer:
    """
    Attributes:
        ...
        recipients (Union[Unset, list['MattercreateDataBodyDataEvergreenRetainerRecipientsItem']]):
    """

    minimum_threshold: Unset | float = UNSET
    recipients: (
        Unset | list["MattercreateDataBodyDataEvergreenRetainerRecipientsItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for recipients_item_data in _recipients or []:
            recipients_item = (
                MattercreateDataBodyDataEvergreenRetainerRecipientsItem.from_dict(
        ...
        mattercreate_data_body_data_evergreen_retainer = cls(
            minimum_threshold=minimum_threshold,
            recipients=recipients,
        )

        mattercreate_data_body_data_evergreen_retainer.additional_properties = d
        return mattercreate_data_body_data_evergreen_retainer
