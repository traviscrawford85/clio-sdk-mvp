...
class ActivitycreateFilesBodyData:
    ...
    activity_description: Union[
        Unset, "ActivitycreateFilesBodyDataActivityDescription"
    ] = UNSET
    ...
    tax_setting: Unset | ActivitycreateFilesBodyDataTaxSetting = UNSET
    text_message_conversation: Union[
        Unset, "ActivitycreateFilesBodyDataTextMessageConversation"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_description: Unset | ActivitycreateFilesBodyDataActivityDescription
        if isinstance(_activity_description, Unset):
            activity_description = UNSET
        else:
            activity_description = (
                ActivitycreateFilesBodyDataActivityDescription.from_dict(
                    _activity_description
                )
            )

        _calendar_entry = d.pop("calendar_entry", UNSET)
        calendar_entry: Unset | ActivitycreateFilesBodyDataCalendarEntry
        if isinstance(_calendar_entry, Unset):
            calendar_entry = UNSET
        else:
            calendar_entry = ActivitycreateFilesBodyDataCalendarEntry.from_dict(
                _calendar_entry
            )

        _client_portal = d.pop("client_portal", UNSET)
        client_portal: Unset | ActivitycreateFilesBodyDataClientPortal
        if isinstance(_client_portal, Unset):
            client_portal = UNSET
        else:
            client_portal = ActivitycreateFilesBodyDataClientPortal.from_dict(
                _client_portal
            )

        _communication = d.pop("communication", UNSET)
        communication: Unset | ActivitycreateFilesBodyDataCommunication
        if isinstance(_communication, Unset):
            communication = UNSET
        else:
            communication = ActivitycreateFilesBodyDataCommunication.from_dict(
                _communication
            )

        _contact_note = d.pop("contact_note", UNSET)
        contact_note: Unset | ActivitycreateFilesBodyDataContactNote
        if isinstance(_contact_note, Unset):
            contact_note = UNSET
        else:
            contact_note = ActivitycreateFilesBodyDataContactNote.from_dict(
                _contact_note
            )

        _expense_category = d.pop("expense_category", UNSET)
        expense_category: Unset | ActivitycreateFilesBodyDataExpenseCategory
        if isinstance(_expense_category, Unset):
            expense_category = UNSET
        else:
            expense_category = ActivitycreateFilesBodyDataExpenseCategory.from_dict(
                _expense_category
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ActivitycreateFilesBodyDataMatter
        ...
        matter_note: Unset | ActivitycreateFilesBodyDataMatterNote
        ...
        task: Unset | ActivitycreateFilesBodyDataTask
        ...
        tax_setting: Unset | ActivitycreateFilesBodyDataTaxSetting
        ...
        if isinstance(_text_message_conversation, Unset):
            ...
            text_message_conversation = (
                ActivitycreateFilesBodyDataTextMessageConversation.from_dict(
                    _text_message_conversation
                )
            )

        _user = d.pop("user", UNSET)
        user: Unset | ActivitycreateFilesBodyDataUser
        ...
        utbms_expense: Unset | ActivitycreateFilesBodyDataUtbmsExpense
        if isinstance(_utbms_expense, Unset):
            utbms_expense = UNSET
        else:
            utbms_expense = ActivitycreateFilesBodyDataUtbmsExpense.from_dict(
                _utbms_expense
            )

        _vendor = d.pop("vendor", UNSET)
        vendor: Unset | ActivitycreateFilesBodyDataVendor
