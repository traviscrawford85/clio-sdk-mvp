...
if TYPE_CHECKING:
    from ..models.document_templateupdate_files_body_data_document_category import (
        DocumentTemplateupdateFilesBodyDataDocumentCategory,
    )


T = TypeVar("T", bound="DocumentTemplateupdateFilesBodyData")


@_attrs_define
class DocumentTemplateupdateFilesBodyData:
    """
    Attributes:
        document_category (Union[Unset, DocumentTemplateupdateFilesBodyDataDocumentCategory]):
    ...
    document_category: Union[
        Unset, "DocumentTemplateupdateFilesBodyDataDocumentCategory"
    ] = UNSET
    file: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentTemplateupdateFilesBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = (
                DocumentTemplateupdateFilesBodyDataDocumentCategory.from_dict(
                    _document_category
                )
            )
        ...
        document_templateupdate_files_body_data = cls(
            document_category=document_category,
            file=file,
            filename=filename,
        )

        document_templateupdate_files_body_data.additional_properties = d
        return document_templateupdate_files_body_data
