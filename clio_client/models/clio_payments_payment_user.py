...
T = TypeVar("T", bound="ClioPaymentsPaymentUser")


@_attrs_define
class ClioPaymentsPaymentUser:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_payment_user = cls(
        ...
        clio_payments_payment_user.additional_properties = d
        return clio_payments_payment_user
