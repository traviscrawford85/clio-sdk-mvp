...
if TYPE_CHECKING:
    from ..models.medical_billupdate_files_body_data_payers_item import (
...
class MedicalBillupdateFilesBodyData:
    ...
    payers: Unset | list["MedicalBillupdateFilesBodyDataPayersItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for payers_item_data in _payers or []:
            payers_item = MedicalBillupdateFilesBodyDataPayersItem.from_dict(
                payers_item_data
            )
