...
from ..models.expense_categoryupdate_json_body_data_entry_type import (
...
if TYPE_CHECKING:
    ...
    from ..models.expense_categoryupdate_json_body_data_utbms_code import (
...
class ExpenseCategoryupdateJsonBodyData:
    ...
    entry_type: Unset | ExpenseCategoryupdateJsonBodyDataEntryType = UNSET
    groups: Unset | list["ExpenseCategoryupdateJsonBodyDataGroupsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entry_type: Unset | ExpenseCategoryupdateJsonBodyDataEntryType
        ...
        for groups_item_data in _groups or []:
            groups_item = ExpenseCategoryupdateJsonBodyDataGroupsItem.from_dict(
                groups_item_data
            )
        ...
        utbms_code: Unset | ExpenseCategoryupdateJsonBodyDataUtbmsCode
        if isinstance(_utbms_code, Unset):
            utbms_code = UNSET
        else:
            utbms_code = ExpenseCategoryupdateJsonBodyDataUtbmsCode.from_dict(
                _utbms_code
            )
