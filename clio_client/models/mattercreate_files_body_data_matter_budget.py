...
T = TypeVar("T", bound="MattercreateFilesBodyDataMatterBudget")


@_attrs_define
class MattercreateFilesBodyDataMatterBudget:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mattercreate_files_body_data_matter_budget = cls(
        ...
        mattercreate_files_body_data_matter_budget.additional_properties = d
        return mattercreate_files_body_data_matter_budget
