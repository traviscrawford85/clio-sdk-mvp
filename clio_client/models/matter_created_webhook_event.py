...
class MatterCreatedWebhookEvent:
    ...
    event: Unset | MatterCreatedWebhookEventEvent = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        payload: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event: Unset | MatterCreatedWebhookEventEvent
        ...
        payload: Unset | MatterCreatedWebhookEventPayload
