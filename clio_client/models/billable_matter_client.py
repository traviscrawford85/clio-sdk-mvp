...
T = TypeVar("T", bound="BillableMatterClient")


@_attrs_define
class BillableMatterClient:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        billable_matter_client.additional_properties = d
        return billable_matter_client
