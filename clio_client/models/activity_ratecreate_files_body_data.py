...
T = TypeVar("T", bound="ActivityRatecreateFilesBodyData")


@_attrs_define
class ActivityRatecreateFilesBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_ratecreate_files_body_data = cls(
        ...
        activity_ratecreate_files_body_data.additional_properties = d
        return activity_ratecreate_files_body_data
