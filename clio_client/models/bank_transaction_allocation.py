...
T = TypeVar("T", bound="BankTransactionAllocation")
...
class BankTransactionAllocation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_transaction_allocation = cls(
            amount=amount,
        ...
        bank_transaction_allocation.additional_properties = d
        return bank_transaction_allocation
