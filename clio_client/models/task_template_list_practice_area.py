...
T = TypeVar("T", bound="TaskTemplateListPracticeArea")


@_attrs_define
class TaskTemplateListPracticeArea:
    """
    Attributes:
    ...
    category: Unset | PracticeAreaBaseCategory = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category: Unset | PracticeAreaBaseCategory
        ...
        task_template_list_practice_area = cls(
            category=category,
            code=code,
        ...
        task_template_list_practice_area.additional_properties = d
        return task_template_list_practice_area
