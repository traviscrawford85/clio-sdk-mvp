...
class MattercreateFilesBodyData:
    ...
    custom_field_set_associations: (
        Unset | list["MattercreateFilesBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["MattercreateFilesBodyDataCustomFieldValuesItem"]
    ) = UNSET
    ...
    originating_attorney: Union[
        Unset, "MattercreateFilesBodyDataOriginatingAttorney"
    ] = UNSET
    pending_date: Unset | str = UNSET
    practice_area: Union[Unset, "MattercreateFilesBodyDataPracticeArea"] = UNSET
    relationships: Unset | list["MattercreateFilesBodyDataRelationshipsItem"] = UNSET
    reset_matter_number: Unset | bool = False
    responsible_attorney: Union[
        Unset, "MattercreateFilesBodyDataResponsibleAttorney"
    ] = UNSET
    split_invoice_payers: (
        Unset | list["MattercreateFilesBodyDataSplitInvoicePayersItem"]
    ) = UNSET
    status: Unset | MattercreateFilesBodyDataStatus = UNSET
    statute_of_limitations: Union[
        Unset, "MattercreateFilesBodyDataStatuteOfLimitations"
    ] = UNSET
    task_template_list_instances: (
        Unset | list["MattercreateFilesBodyDataTaskTemplateListInstancesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                MattercreateFilesBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                MattercreateFilesBodyDataCustomFieldValuesItem.from_dict(
        ...
        custom_rate: Unset | MattercreateFilesBodyDataCustomRate
        ...
        evergreen_retainer: Unset | MattercreateFilesBodyDataEvergreenRetainer
        if isinstance(_evergreen_retainer, Unset):
            evergreen_retainer = UNSET
        else:
            evergreen_retainer = MattercreateFilesBodyDataEvergreenRetainer.from_dict(
                _evergreen_retainer
            )

        _group = d.pop("group", UNSET)
        group: Unset | MattercreateFilesBodyDataGroup
        ...
        matter_budget: Unset | MattercreateFilesBodyDataMatterBudget
        if isinstance(_matter_budget, Unset):
            matter_budget = UNSET
        else:
            matter_budget = MattercreateFilesBodyDataMatterBudget.from_dict(
                _matter_budget
            )

        _matter_stage = d.pop("matter_stage", UNSET)
        matter_stage: Unset | MattercreateFilesBodyDataMatterStage
        ...
        originating_attorney: Unset | MattercreateFilesBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                MattercreateFilesBodyDataOriginatingAttorney.from_dict(
        ...
        practice_area: Unset | MattercreateFilesBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = MattercreateFilesBodyDataPracticeArea.from_dict(
                _practice_area
            )
        ...
        for relationships_item_data in _relationships or []:
            relationships_item = MattercreateFilesBodyDataRelationshipsItem.from_dict(
        ...
        responsible_attorney: Unset | MattercreateFilesBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                MattercreateFilesBodyDataResponsibleAttorney.from_dict(
        ...
        for split_invoice_payers_item_data in _split_invoice_payers or []:
            split_invoice_payers_item = (
                MattercreateFilesBodyDataSplitInvoicePayersItem.from_dict(
        ...
        status: Unset | MattercreateFilesBodyDataStatus
        ...
        statute_of_limitations: Unset | MattercreateFilesBodyDataStatuteOfLimitations
        if isinstance(_statute_of_limitations, Unset):
            statute_of_limitations = UNSET
        else:
            statute_of_limitations = (
                MattercreateFilesBodyDataStatuteOfLimitations.from_dict(
        ...
        for task_template_list_instances_item_data in (
            ...
            task_template_list_instances_item = (
                MattercreateFilesBodyDataTaskTemplateListInstancesItem.from_dict(
                    task_template_list_instances_item_data
                )
            )
