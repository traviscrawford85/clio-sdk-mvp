...
from ..models.reminderupdate_json_body_data_duration_unit import (
...
class ReminderupdateJsonBodyData:
    ...
    duration_unit: Unset | ReminderupdateJsonBodyDataDurationUnit = UNSET
    duration_value: Unset | int = UNSET
    notification_method: Union[
        Unset, "ReminderupdateJsonBodyDataNotificationMethod"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duration_unit: Unset | ReminderupdateJsonBodyDataDurationUnit
        ...
        notification_method: Unset | ReminderupdateJsonBodyDataNotificationMethod
        if isinstance(_notification_method, Unset):
            notification_method = UNSET
        else:
            notification_method = (
                ReminderupdateJsonBodyDataNotificationMethod.from_dict(
