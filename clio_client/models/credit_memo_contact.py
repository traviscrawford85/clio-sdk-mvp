...
T = TypeVar("T", bound="CreditMemoContact")


@_attrs_define
class CreditMemoContact:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credit_memo_contact.additional_properties = d
        return credit_memo_contact
