...
class MedicalRecordsRequestupdateFilesBodyData:
    ...
    bills_status: Unset | MedicalRecordsRequestupdateFilesBodyDataBillsStatus = UNSET
    description: Unset | str = UNSET
    in_treatment: Unset | bool = UNSET
    medical_bills: (
        Unset | list["MedicalRecordsRequestupdateFilesBodyDataMedicalBillsItem"]
    ) = UNSET
    medical_provider_id: Unset | int = UNSET
    medical_records: (
        Unset | list["MedicalRecordsRequestupdateFilesBodyDataMedicalRecordsItem"]
    ) = UNSET
    records_follow_up_date: Unset | str = UNSET
    records_request_date: Unset | str = UNSET
    records_status: Unset | MedicalRecordsRequestupdateFilesBodyDataRecordsStatus = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bills_status: Unset | MedicalRecordsRequestupdateFilesBodyDataBillsStatus
        if isinstance(_bills_status, Unset):
            bills_status = UNSET
        else:
            bills_status = MedicalRecordsRequestupdateFilesBodyDataBillsStatus(
                _bills_status
            )
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = (
                MedicalRecordsRequestupdateFilesBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = (
                MedicalRecordsRequestupdateFilesBodyDataMedicalRecordsItem.from_dict(
        ...
        if isinstance(_records_status, Unset):
            ...
            records_status = MedicalRecordsRequestupdateFilesBodyDataRecordsStatus(
                _records_status
            )
