...
T = TypeVar("T", bound="MattercreateDataBodyDataMatterBudget")


@_attrs_define
class MattercreateDataBodyDataMatterBudget:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mattercreate_data_body_data_matter_budget = cls(
        ...
        mattercreate_data_body_data_matter_budget.additional_properties = d
        return mattercreate_data_body_data_matter_budget
