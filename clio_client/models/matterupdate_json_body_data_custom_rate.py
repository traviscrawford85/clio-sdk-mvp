...
from ..models.matterupdate_json_body_data_custom_rate_type import (
...
class MatterupdateJsonBodyDataCustomRate:
    ...
    rates: Unset | list["MatterupdateJsonBodyDataCustomRateRatesItem"] = UNSET
    type_: Unset | MatterupdateJsonBodyDataCustomRateType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rates_item_data in _rates or []:
            rates_item = MatterupdateJsonBodyDataCustomRateRatesItem.from_dict(
                rates_item_data
            )
        ...
        type_: Unset | MatterupdateJsonBodyDataCustomRateType
