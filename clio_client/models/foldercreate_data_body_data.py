...
class FoldercreateDataBodyData:
    ...
    external_properties: (
        Unset | list["FoldercreateDataBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | FoldercreateDataBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = FoldercreateDataBodyDataDocumentCategory.from_dict(
                _document_category
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                FoldercreateDataBodyDataExternalPropertiesItem.from_dict(
