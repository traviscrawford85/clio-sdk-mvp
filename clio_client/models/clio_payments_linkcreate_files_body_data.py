...
@_attrs_define
class ClioPaymentsLinkcreateFilesBodyData:
    """
    Attributes:
        ...
        description (str): Only applicable for a direct payment. A short description of the purpose of the payment. Max
            255 characters.
        destination_account (ClioPaymentsLinkcreateFilesBodyDataDestinationAccount):
        ...
        subject (ClioPaymentsLinkcreateFilesBodyDataSubject):
        amount (Union[Unset, float]): The amount to be paid. If not provided, the client will be able to specify an
            amount.
        destination_contact (Union[Unset, ClioPaymentsLinkcreateFilesBodyDataDestinationContact]):
    ...
    destination_contact: Union[
        Unset, "ClioPaymentsLinkcreateFilesBodyDataDestinationContact"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        destination_account = (
            ClioPaymentsLinkcreateFilesBodyDataDestinationAccount.from_dict(
        ...
        subject = ClioPaymentsLinkcreateFilesBodyDataSubject.from_dict(d.pop("subject"))
        ...
        if isinstance(_destination_contact, Unset):
            ...
            destination_contact = (
                ClioPaymentsLinkcreateFilesBodyDataDestinationContact.from_dict(
        ...
        clio_payments_linkcreate_files_body_data = cls(
            currency=currency,
            description=description,
            destination_account=destination_account,
            duration=duration,
        ...
        clio_payments_linkcreate_files_body_data.additional_properties = d
        return clio_payments_linkcreate_files_body_data
