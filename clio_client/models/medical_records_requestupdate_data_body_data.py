...
class MedicalRecordsRequestupdateDataBodyData:
    ...
    bills_status: Unset | MedicalRecordsRequestupdateDataBodyDataBillsStatus = UNSET
    description: Unset | str = UNSET
    in_treatment: Unset | bool = UNSET
    medical_bills: (
        Unset | list["MedicalRecordsRequestupdateDataBodyDataMedicalBillsItem"]
    ) = UNSET
    medical_provider_id: Unset | int = UNSET
    medical_records: (
        Unset | list["MedicalRecordsRequestupdateDataBodyDataMedicalRecordsItem"]
    ) = UNSET
    records_follow_up_date: Unset | str = UNSET
    records_request_date: Unset | str = UNSET
    records_status: Unset | MedicalRecordsRequestupdateDataBodyDataRecordsStatus = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bills_status: Unset | MedicalRecordsRequestupdateDataBodyDataBillsStatus
        if isinstance(_bills_status, Unset):
            bills_status = UNSET
        else:
            bills_status = MedicalRecordsRequestupdateDataBodyDataBillsStatus(
                _bills_status
            )
        ...
        for medical_bills_item_data in _medical_bills or []:
            medical_bills_item = (
                MedicalRecordsRequestupdateDataBodyDataMedicalBillsItem.from_dict(
        ...
        for medical_records_item_data in _medical_records or []:
            medical_records_item = (
                MedicalRecordsRequestupdateDataBodyDataMedicalRecordsItem.from_dict(
        ...
        records_status: Unset | MedicalRecordsRequestupdateDataBodyDataRecordsStatus
        if isinstance(_records_status, Unset):
            records_status = UNSET
        else:
            records_status = MedicalRecordsRequestupdateDataBodyDataRecordsStatus(
                _records_status
            )
