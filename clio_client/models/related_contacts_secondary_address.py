...
T = TypeVar("T", bound="RelatedContactsSecondaryAddress")


@_attrs_define
class RelatedContactsSecondaryAddress:
    """
    Attributes:
    ...
    id: Unset | int = UNSET
    name: Unset | AddressBaseName = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_contacts_secondary_address = cls(
            city=city,
            country=country,
        ...
        related_contacts_secondary_address.additional_properties = d
        return related_contacts_secondary_address
