...
T = TypeVar("T", bound="ConversationMessagecreateFilesBodyDataAttachment")


@_attrs_define
class ConversationMessagecreateFilesBodyDataAttachment:
    """
    Attributes:
    ...
    document_version_id: Unset | int = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversation_messagecreate_files_body_data_attachment = cls(
            document_id=document_id,
            document_version_id=document_version_id,
        )

        conversation_messagecreate_files_body_data_attachment.additional_properties = d
        return conversation_messagecreate_files_body_data_attachment
