...
@_attrs_define
class ClioPaymentsLinkClioPaymentsPayment:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_link_clio_payments_payment = cls(
            amount=amount,
        ...
        clio_payments_link_clio_payments_payment.additional_properties = d
        return clio_payments_link_clio_payments_payment
