...
T = TypeVar("T", bound="TaskTemplateListCreator")


@_attrs_define
class TaskTemplateListCreator:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_template_list_creator = cls(
        ...
        task_template_list_creator.additional_properties = d
        return task_template_list_creator
