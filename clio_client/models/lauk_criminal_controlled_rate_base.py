...
T = TypeVar("T", bound="LaukCriminalControlledRateBase")


@_attrs_define
class LaukCriminalControlledRateBase:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lauk_criminal_controlled_rate_base = cls(
            activity=activity,
        ...
        lauk_criminal_controlled_rate_base.additional_properties = d
        return lauk_criminal_controlled_rate_base
