...
T = TypeVar("T", bound="EventMetrics")
...
class EventMetrics:
    ...
    unread_client_portal_messages: Unset | int = UNSET
    unread_mobile_events: Unset | int = UNSET
    unread_secure_messages: Unset | int = UNSET
    unread_text_messages: Unset | int = UNSET
    unread_web_events: Unset | int = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_metrics.additional_properties = d
