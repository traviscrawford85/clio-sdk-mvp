...
class DocumentVersionCreator:
    ...
    Attributes:
        ...
        court_rules_default_attendee (Union[Unset, bool]): Whether the *ClioCreator* is a default attendee for court
            rules events
        created_at (Union[Unset, str]): The time the *ClioCreator* was created (as a ISO-8601 timestamp)
        ...
        updated_at (Union[Unset, str]): The time the *ClioCreator* was last updated (as a ISO-8601 timestamp)
    """

    account_owner: Unset | bool = UNSET
    clio_connect: Unset | bool = UNSET
    court_rules_default_attendee: Unset | bool = UNSET
    created_at: Unset | str = UNSET
    default_calendar_id: Unset | int = UNSET
    ...
    roles: Unset | list[str] = UNSET
    subscription_type: Unset | ClioCreatorBaseSubscriptionType = UNSET
    time_zone: Unset | str = UNSET
    type_: Unset | ClioCreatorBaseType = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        subscription_type: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subscription_type: Unset | ClioCreatorBaseSubscriptionType
        ...
        type_: Unset | ClioCreatorBaseType
        ...
        document_version_creator.additional_properties = d
        return document_version_creator
