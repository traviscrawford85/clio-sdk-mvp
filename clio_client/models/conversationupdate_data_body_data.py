...
class ConversationupdateDataBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter: Unset | ConversationupdateDataBodyDataMatter
        if isinstance(_matter, Unset):
            matter = UNSET
        else:
            matter = ConversationupdateDataBodyDataMatter.from_dict(_matter)

        read = d.pop("read", UNSET)

        conversationupdate_data_body_data = cls(
            archived=archived,
            matter=matter,
            read=read,
        )

        conversationupdate_data_body_data.additional_properties = d
        return conversationupdate_data_body_data
