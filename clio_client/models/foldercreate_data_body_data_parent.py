...
from ..models.foldercreate_data_body_data_parent_type import (
    FoldercreateDataBodyDataParentType,
)

T = TypeVar("T", bound="FoldercreateDataBodyDataParent")


@_attrs_define
class FoldercreateDataBodyDataParent:
    """
    Attributes:
        id (int): The unique identifier of the parent object.
        type_ (FoldercreateDataBodyDataParentType): Type of parent object:
    ...
    id: int
    type_: FoldercreateDataBodyDataParentType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = FoldercreateDataBodyDataParentType(d.pop("type"))

        foldercreate_data_body_data_parent = cls(
            id=id,
            type_=type_,
        )

        foldercreate_data_body_data_parent.additional_properties = d
        return foldercreate_data_body_data_parent
