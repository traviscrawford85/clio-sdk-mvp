...
T = TypeVar("T", bound="AllocationDestinationBankAccount")


@_attrs_define
class AllocationDestinationBankAccount:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allocation_destination_bank_account = cls(
        ...
        allocation_destination_bank_account.additional_properties = d
        return allocation_destination_bank_account
