...
T = TypeVar("T", bound="ContactupdateDataBodyDataAvatar")


@_attrs_define
class ContactupdateDataBodyDataAvatar:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contactupdate_data_body_data_avatar = cls(
            field_destroy=field_destroy,
            image=image,
        )

        contactupdate_data_body_data_avatar.additional_properties = d
        return contactupdate_data_body_data_avatar
