...
class ContactupdateJsonBodyData:
    ...
    addresses: Unset | list["ContactupdateJsonBodyDataAddressesItem"] = UNSET
    ...
    custom_field_set_associations: (
        Unset | list["ContactupdateJsonBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["ContactupdateJsonBodyDataCustomFieldValuesItem"]
    ) = UNSET
    date_of_birth: Unset | str = UNSET
    email_addresses: Unset | list["ContactupdateJsonBodyDataEmailAddressesItem"] = UNSET
    first_name: Unset | str = UNSET
    instant_messengers: (
        Unset | list["ContactupdateJsonBodyDataInstantMessengersItem"]
    ) = UNSET
    last_name: Unset | str = UNSET
    ledes_client_id: Unset | str = UNSET
    middle_name: Unset | str = UNSET
    name: Unset | str = UNSET
    phone_numbers: Unset | list["ContactupdateJsonBodyDataPhoneNumbersItem"] = UNSET
    prefix: Unset | str = UNSET
    sales_tax_number: Unset | str = UNSET
    title: Unset | str = UNSET
    type_: Unset | ContactupdateJsonBodyDataType = UNSET
    web_sites: Unset | list["ContactupdateJsonBodyDataWebSitesItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for addresses_item_data in _addresses or []:
            addresses_item = ContactupdateJsonBodyDataAddressesItem.from_dict(
                addresses_item_data
            )
        ...
        avatar: Unset | ContactupdateJsonBodyDataAvatar
        ...
        co_counsel_rate: Unset | ContactupdateJsonBodyDataCoCounselRate
        if isinstance(_co_counsel_rate, Unset):
            co_counsel_rate = UNSET
        else:
            co_counsel_rate = ContactupdateJsonBodyDataCoCounselRate.from_dict(
                _co_counsel_rate
            )

        _company = d.pop("company", UNSET)
        company: Unset | ContactupdateJsonBodyDataCompany
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                ContactupdateJsonBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                ContactupdateJsonBodyDataCustomFieldValuesItem.from_dict(
        ...
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = (
                ContactupdateJsonBodyDataEmailAddressesItem.from_dict(
        ...
        for instant_messengers_item_data in _instant_messengers or []:
            instant_messengers_item = (
                ContactupdateJsonBodyDataInstantMessengersItem.from_dict(
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = ContactupdateJsonBodyDataPhoneNumbersItem.from_dict(
        ...
        type_: Unset | ContactupdateJsonBodyDataType
        ...
        for web_sites_item_data in _web_sites or []:
            web_sites_item = ContactupdateJsonBodyDataWebSitesItem.from_dict(
                web_sites_item_data
            )
