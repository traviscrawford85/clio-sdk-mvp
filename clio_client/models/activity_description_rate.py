...
class ActivityDescriptionRate:
    ...
    hierarchy: Unset | ActivityDescriptionRateBaseHierarchy = UNSET
    non_billable_amount: Unset | float = UNSET
    type_: Unset | ActivityDescriptionRateBaseType = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        amount = self.amount

        hierarchy: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hierarchy: Unset | ActivityDescriptionRateBaseHierarchy
        ...
        type_: Unset | ActivityDescriptionRateBaseType
