...
from ..models.taskupdate_data_body_data_assignee_type import (
...
class TaskupdateDataBodyDataAssignee:
    ...
    id: Unset | int = UNSET
    type_: Unset | TaskupdateDataBodyDataAssigneeType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | TaskupdateDataBodyDataAssigneeType
