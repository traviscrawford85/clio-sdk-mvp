...
class RemindercreateJsonBodyData:
    ...
    notification_method: "RemindercreateJsonBodyDataNotificationMethod"
    subject: "RemindercreateJsonBodyDataSubject"
    duration_unit: Unset | RemindercreateJsonBodyDataDurationUnit = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        notification_method = RemindercreateJsonBodyDataNotificationMethod.from_dict(
        ...
        duration_unit: Unset | RemindercreateJsonBodyDataDurationUnit
