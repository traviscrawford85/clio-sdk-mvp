...
class MattercreateDataBodyDataStatuteOfLimitations:
    ...
    reminders: (
        Unset | list["MattercreateDataBodyDataStatuteOfLimitationsRemindersItem"]
    ) = UNSET
    status: Unset | MattercreateDataBodyDataStatuteOfLimitationsStatus = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for reminders_item_data in _reminders or []:
            reminders_item = (
                MattercreateDataBodyDataStatuteOfLimitationsRemindersItem.from_dict(
                    reminders_item_data
                )
            )
        ...
        status: Unset | MattercreateDataBodyDataStatuteOfLimitationsStatus
