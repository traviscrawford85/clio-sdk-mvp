...
from ..models.contactcreate_json_body_data_type import ContactcreateJsonBodyDataType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.contactcreate_json_body_data_addresses_item import (
        ContactcreateJsonBodyDataAddressesItem,
    )
    from ..models.contactcreate_json_body_data_avatar import (
        ContactcreateJsonBodyDataAvatar,
    )
    from ..models.contactcreate_json_body_data_co_counsel_rate import (
        ContactcreateJsonBodyDataCoCounselRate,
    )
    from ..models.contactcreate_json_body_data_company import (
        ContactcreateJsonBodyDataCompany,
    )
    from ..models.contactcreate_json_body_data_custom_field_set_associations_item import (
        ContactcreateJsonBodyDataCustomFieldSetAssociationsItem,
    )
    from ..models.contactcreate_json_body_data_custom_field_values_item import (
        ContactcreateJsonBodyDataCustomFieldValuesItem,
    )
    from ..models.contactcreate_json_body_data_email_addresses_item import (
        ContactcreateJsonBodyDataEmailAddressesItem,
    )
    from ..models.contactcreate_json_body_data_instant_messengers_item import (
        ContactcreateJsonBodyDataInstantMessengersItem,
    )
    from ..models.contactcreate_json_body_data_phone_numbers_item import (
        ContactcreateJsonBodyDataPhoneNumbersItem,
    )
    from ..models.contactcreate_json_body_data_web_sites_item import (
        ContactcreateJsonBodyDataWebSitesItem,
    )


T = TypeVar("T", bound="ContactcreateJsonBodyData")


@_attrs_define
class ContactcreateJsonBodyData:
    """
    Attributes:
        ...
        type_ (ContactcreateJsonBodyDataType): Type of the Contact.
        addresses (Union[Unset, list['ContactcreateJsonBodyDataAddressesItem']]):
        avatar (Union[Unset, ContactcreateJsonBodyDataAvatar]):
        clio_connect_email (Union[Unset, str]): Notifications will be sent to this email when a resource is shared.
        co_counsel_rate (Union[Unset, ContactcreateJsonBodyDataCoCounselRate]):
        company (Union[Unset, ContactcreateJsonBodyDataCompany]):
        custom_field_set_associations (Union[Unset, list['ContactcreateJsonBodyDataCustomFieldSetAssociationsItem']]):
        custom_field_values (Union[Unset, list['ContactcreateJsonBodyDataCustomFieldValuesItem']]):
        date_of_birth (Union[Unset, str]): Date of birth of the Contact.
        email_addresses (Union[Unset, list['ContactcreateJsonBodyDataEmailAddressesItem']]):
        first_name (Union[Unset, str]): First name of the Contact.
        instant_messengers (Union[Unset, list['ContactcreateJsonBodyDataInstantMessengersItem']]):
        ...
        phone_numbers (Union[Unset, list['ContactcreateJsonBodyDataPhoneNumbersItem']]):
        ...
        web_sites (Union[Unset, list['ContactcreateJsonBodyDataWebSitesItem']]):
    """

    name: str
    type_: ContactcreateJsonBodyDataType
    addresses: Unset | list["ContactcreateJsonBodyDataAddressesItem"] = UNSET
    avatar: Union[Unset, "ContactcreateJsonBodyDataAvatar"] = UNSET
    clio_connect_email: Unset | str = UNSET
    co_counsel_rate: Union[Unset, "ContactcreateJsonBodyDataCoCounselRate"] = UNSET
    company: Union[Unset, "ContactcreateJsonBodyDataCompany"] = UNSET
    custom_field_set_associations: (
        Unset | list["ContactcreateJsonBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["ContactcreateJsonBodyDataCustomFieldValuesItem"]
    ) = UNSET
    date_of_birth: Unset | str = UNSET
    email_addresses: Unset | list["ContactcreateJsonBodyDataEmailAddressesItem"] = UNSET
    first_name: Unset | str = UNSET
    instant_messengers: (
        Unset | list["ContactcreateJsonBodyDataInstantMessengersItem"]
    ) = UNSET
    last_name: Unset | str = UNSET
    ledes_client_id: Unset | str = UNSET
    middle_name: Unset | str = UNSET
    phone_numbers: Unset | list["ContactcreateJsonBodyDataPhoneNumbersItem"] = UNSET
    prefix: Unset | str = UNSET
    sales_tax_number: Unset | str = UNSET
    title: Unset | str = UNSET
    web_sites: Unset | list["ContactcreateJsonBodyDataWebSitesItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ContactcreateJsonBodyDataType(d.pop("type"))

        addresses = []
        _addresses = d.pop("addresses", UNSET)
        for addresses_item_data in _addresses or []:
            addresses_item = ContactcreateJsonBodyDataAddressesItem.from_dict(
                addresses_item_data
            )
        ...
        avatar: Unset | ContactcreateJsonBodyDataAvatar
        if isinstance(_avatar, Unset):
            avatar = UNSET
        else:
            avatar = ContactcreateJsonBodyDataAvatar.from_dict(_avatar)

        clio_connect_email = d.pop("clio_connect_email", UNSET)

        _co_counsel_rate = d.pop("co_counsel_rate", UNSET)
        co_counsel_rate: Unset | ContactcreateJsonBodyDataCoCounselRate
        if isinstance(_co_counsel_rate, Unset):
            co_counsel_rate = UNSET
        else:
            co_counsel_rate = ContactcreateJsonBodyDataCoCounselRate.from_dict(
                _co_counsel_rate
            )

        _company = d.pop("company", UNSET)
        company: Unset | ContactcreateJsonBodyDataCompany
        if isinstance(_company, Unset):
            company = UNSET
        else:
            company = ContactcreateJsonBodyDataCompany.from_dict(_company)
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                ContactcreateJsonBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                ContactcreateJsonBodyDataCustomFieldValuesItem.from_dict(
        ...
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = (
                ContactcreateJsonBodyDataEmailAddressesItem.from_dict(
        ...
        for instant_messengers_item_data in _instant_messengers or []:
            instant_messengers_item = (
                ContactcreateJsonBodyDataInstantMessengersItem.from_dict(
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = ContactcreateJsonBodyDataPhoneNumbersItem.from_dict(
        ...
        for web_sites_item_data in _web_sites or []:
            web_sites_item = ContactcreateJsonBodyDataWebSitesItem.from_dict(
                web_sites_item_data
            )

            web_sites.append(web_sites_item)

        contactcreate_json_body_data = cls(
            name=name,
            type_=type_,
            addresses=addresses,
            avatar=avatar,
        ...
        contactcreate_json_body_data.additional_properties = d
        return contactcreate_json_body_data
