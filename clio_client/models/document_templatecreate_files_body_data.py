...
if TYPE_CHECKING:
    from ..models.document_templatecreate_files_body_data_document_category import (
        DocumentTemplatecreateFilesBodyDataDocumentCategory,
    )


T = TypeVar("T", bound="DocumentTemplatecreateFilesBodyData")


@_attrs_define
class DocumentTemplatecreateFilesBodyData:
    """
    Attributes:
        ...
        document_category (Union[Unset, DocumentTemplatecreateFilesBodyDataDocumentCategory]):
    ...
    document_category: Union[
        Unset, "DocumentTemplatecreateFilesBodyDataDocumentCategory"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | DocumentTemplatecreateFilesBodyDataDocumentCategory
        if isinstance(_document_category, Unset):
            document_category = UNSET
        else:
            document_category = (
                DocumentTemplatecreateFilesBodyDataDocumentCategory.from_dict(
                    _document_category
                )
            )
        ...
        document_templatecreate_files_body_data = cls(
            file=file,
            document_category=document_category,
            filename=filename,
        )

        document_templatecreate_files_body_data.additional_properties = d
        return document_templatecreate_files_body_data
