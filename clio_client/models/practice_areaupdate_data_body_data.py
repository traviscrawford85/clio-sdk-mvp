...
from ..models.practice_areaupdate_data_body_data_category import (
...
class PracticeAreaupdateDataBodyData:
    ...
    category: Unset | PracticeAreaupdateDataBodyDataCategory = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category: Unset | PracticeAreaupdateDataBodyDataCategory
