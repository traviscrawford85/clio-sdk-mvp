...
if TYPE_CHECKING:
    from ..models.bank_account_user import BankAccountUser
...
class BankAccount:
    ...
    Attributes:
        ...
        user (Union[Unset, BankAccountUser]):
    """
    ...
    user: Union[Unset, "BankAccountUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user: Unset | BankAccountUser
        if isinstance(_user, Unset):
            user = UNSET
        else:
            user = BankAccountUser.from_dict(_user)
