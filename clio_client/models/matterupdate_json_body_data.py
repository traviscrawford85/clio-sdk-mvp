...
class MatterupdateJsonBodyData:
    ...
    custom_field_set_associations: (
        Unset | list["MatterupdateJsonBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["MatterupdateJsonBodyDataCustomFieldValuesItem"]
    ) = UNSET
    ...
    originating_attorney: Union[
        Unset, "MatterupdateJsonBodyDataOriginatingAttorney"
    ] = UNSET
    pending_date: Unset | str = UNSET
    practice_area: Union[Unset, "MatterupdateJsonBodyDataPracticeArea"] = UNSET
    relationships: Unset | list["MatterupdateJsonBodyDataRelationshipsItem"] = UNSET
    reset_matter_number: Unset | bool = False
    responsible_attorney: Union[
        Unset, "MatterupdateJsonBodyDataResponsibleAttorney"
    ] = UNSET
    split_invoice_payers: (
        Unset | list["MatterupdateJsonBodyDataSplitInvoicePayersItem"]
    ) = UNSET
    status: Unset | MatterupdateJsonBodyDataStatus = UNSET
    statute_of_limitations: Union[
        Unset, "MatterupdateJsonBodyDataStatuteOfLimitations"
    ] = UNSET
    task_template_list_instances: (
        Unset | list["MatterupdateJsonBodyDataTaskTemplateListInstancesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        client: Unset | MatterupdateJsonBodyDataClient
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                MatterupdateJsonBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                MatterupdateJsonBodyDataCustomFieldValuesItem.from_dict(
        ...
        custom_rate: Unset | MatterupdateJsonBodyDataCustomRate
        ...
        evergreen_retainer: Unset | MatterupdateJsonBodyDataEvergreenRetainer
        if isinstance(_evergreen_retainer, Unset):
            evergreen_retainer = UNSET
        else:
            evergreen_retainer = MatterupdateJsonBodyDataEvergreenRetainer.from_dict(
                _evergreen_retainer
            )

        _group = d.pop("group", UNSET)
        group: Unset | MatterupdateJsonBodyDataGroup
        ...
        matter_budget: Unset | MatterupdateJsonBodyDataMatterBudget
        if isinstance(_matter_budget, Unset):
            matter_budget = UNSET
        else:
            matter_budget = MatterupdateJsonBodyDataMatterBudget.from_dict(
                _matter_budget
            )

        _matter_stage = d.pop("matter_stage", UNSET)
        matter_stage: Unset | MatterupdateJsonBodyDataMatterStage
        ...
        originating_attorney: Unset | MatterupdateJsonBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                MatterupdateJsonBodyDataOriginatingAttorney.from_dict(
        ...
        practice_area: Unset | MatterupdateJsonBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = MatterupdateJsonBodyDataPracticeArea.from_dict(
                _practice_area
            )
        ...
        for relationships_item_data in _relationships or []:
            relationships_item = MatterupdateJsonBodyDataRelationshipsItem.from_dict(
        ...
        responsible_attorney: Unset | MatterupdateJsonBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                MatterupdateJsonBodyDataResponsibleAttorney.from_dict(
        ...
        for split_invoice_payers_item_data in _split_invoice_payers or []:
            split_invoice_payers_item = (
                MatterupdateJsonBodyDataSplitInvoicePayersItem.from_dict(
        ...
        status: Unset | MatterupdateJsonBodyDataStatus
        ...
        statute_of_limitations: Unset | MatterupdateJsonBodyDataStatuteOfLimitations
        if isinstance(_statute_of_limitations, Unset):
            statute_of_limitations = UNSET
        else:
            statute_of_limitations = (
                MatterupdateJsonBodyDataStatuteOfLimitations.from_dict(
        ...
        for task_template_list_instances_item_data in (
            ...
            task_template_list_instances_item = (
                MatterupdateJsonBodyDataTaskTemplateListInstancesItem.from_dict(
                    task_template_list_instances_item_data
                )
            )
