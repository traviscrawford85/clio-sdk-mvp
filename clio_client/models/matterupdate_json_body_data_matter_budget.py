...
T = TypeVar("T", bound="MatterupdateJsonBodyDataMatterBudget")


@_attrs_define
class MatterupdateJsonBodyDataMatterBudget:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matterupdate_json_body_data_matter_budget = cls(
        ...
        matterupdate_json_body_data_matter_budget.additional_properties = d
        return matterupdate_json_body_data_matter_budget
