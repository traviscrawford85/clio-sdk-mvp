...
from ..models.contactcreate_files_body_data_type import ContactcreateFilesBodyDataType
...
@_attrs_define
class ContactcreateFilesBodyData:
    """
    Attributes:
        ...
        type_ (ContactcreateFilesBodyDataType): Type of the Contact.
        addresses (Union[Unset, list['ContactcreateFilesBodyDataAddressesItem']]):
        avatar (Union[Unset, ContactcreateFilesBodyDataAvatar]):
        clio_connect_email (Union[Unset, str]): Notifications will be sent to this email when a resource is shared.
        co_counsel_rate (Union[Unset, ContactcreateFilesBodyDataCoCounselRate]):
        company (Union[Unset, ContactcreateFilesBodyDataCompany]):
        custom_field_set_associations (Union[Unset, list['ContactcreateFilesBodyDataCustomFieldSetAssociationsItem']]):
        custom_field_values (Union[Unset, list['ContactcreateFilesBodyDataCustomFieldValuesItem']]):
        date_of_birth (Union[Unset, str]): Date of birth of the Contact.
        email_addresses (Union[Unset, list['ContactcreateFilesBodyDataEmailAddressesItem']]):
        first_name (Union[Unset, str]): First name of the Contact.
        instant_messengers (Union[Unset, list['ContactcreateFilesBodyDataInstantMessengersItem']]):
        ...
        phone_numbers (Union[Unset, list['ContactcreateFilesBodyDataPhoneNumbersItem']]):
        ...
        web_sites (Union[Unset, list['ContactcreateFilesBodyDataWebSitesItem']]):
    """

    name: str
    type_: ContactcreateFilesBodyDataType
    addresses: Unset | list["ContactcreateFilesBodyDataAddressesItem"] = UNSET
    avatar: Union[Unset, "ContactcreateFilesBodyDataAvatar"] = UNSET
    clio_connect_email: Unset | str = UNSET
    co_counsel_rate: Union[Unset, "ContactcreateFilesBodyDataCoCounselRate"] = UNSET
    company: Union[Unset, "ContactcreateFilesBodyDataCompany"] = UNSET
    custom_field_set_associations: (
        Unset | list["ContactcreateFilesBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["ContactcreateFilesBodyDataCustomFieldValuesItem"]
    ) = UNSET
    date_of_birth: Unset | str = UNSET
    email_addresses: Unset | list["ContactcreateFilesBodyDataEmailAddressesItem"] = (
        UNSET
    )
    first_name: Unset | str = UNSET
    instant_messengers: (
        Unset | list["ContactcreateFilesBodyDataInstantMessengersItem"]
    ) = UNSET
    last_name: Unset | str = UNSET
    ledes_client_id: Unset | str = UNSET
    middle_name: Unset | str = UNSET
    phone_numbers: Unset | list["ContactcreateFilesBodyDataPhoneNumbersItem"] = UNSET
    prefix: Unset | str = UNSET
    sales_tax_number: Unset | str = UNSET
    title: Unset | str = UNSET
    web_sites: Unset | list["ContactcreateFilesBodyDataWebSitesItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ContactcreateFilesBodyDataType(d.pop("type"))

        addresses = []
        _addresses = d.pop("addresses", UNSET)
        for addresses_item_data in _addresses or []:
            addresses_item = ContactcreateFilesBodyDataAddressesItem.from_dict(
                addresses_item_data
            )
        ...
        avatar: Unset | ContactcreateFilesBodyDataAvatar
        if isinstance(_avatar, Unset):
            avatar = UNSET
        else:
            avatar = ContactcreateFilesBodyDataAvatar.from_dict(_avatar)

        clio_connect_email = d.pop("clio_connect_email", UNSET)

        _co_counsel_rate = d.pop("co_counsel_rate", UNSET)
        co_counsel_rate: Unset | ContactcreateFilesBodyDataCoCounselRate
        if isinstance(_co_counsel_rate, Unset):
            co_counsel_rate = UNSET
        else:
            co_counsel_rate = ContactcreateFilesBodyDataCoCounselRate.from_dict(
                _co_counsel_rate
            )

        _company = d.pop("company", UNSET)
        company: Unset | ContactcreateFilesBodyDataCompany
        if isinstance(_company, Unset):
            company = UNSET
        else:
            company = ContactcreateFilesBodyDataCompany.from_dict(_company)
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                ContactcreateFilesBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                ContactcreateFilesBodyDataCustomFieldValuesItem.from_dict(
        ...
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = (
                ContactcreateFilesBodyDataEmailAddressesItem.from_dict(
        ...
        for instant_messengers_item_data in _instant_messengers or []:
            instant_messengers_item = (
                ContactcreateFilesBodyDataInstantMessengersItem.from_dict(
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = ContactcreateFilesBodyDataPhoneNumbersItem.from_dict(
        ...
        for web_sites_item_data in _web_sites or []:
            web_sites_item = ContactcreateFilesBodyDataWebSitesItem.from_dict(
                web_sites_item_data
            )

            web_sites.append(web_sites_item)

        contactcreate_files_body_data = cls(
            name=name,
            type_=type_,
            addresses=addresses,
            avatar=avatar,
        ...
        contactcreate_files_body_data.additional_properties = d
        return contactcreate_files_body_data
