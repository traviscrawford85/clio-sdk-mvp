...
T = TypeVar("T", bound="TaskTemplateTemplateCreator")


@_attrs_define
class TaskTemplateTemplateCreator:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_template_template_creator = cls(
        ...
        task_template_template_creator.additional_properties = d
        return task_template_template_creator
