...
T = TypeVar("T", bound="DocumentupdateFilesBodyDataMultipartsItem")


@_attrs_define
class DocumentupdateFilesBodyDataMultipartsItem:
    """
    Attributes:
    ...
    content_length: Unset | str = UNSET
    content_md5: Unset | str = UNSET
    part_number: Unset | int = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documentupdate_files_body_data_multiparts_item = cls(
            content_length=content_length,
            content_md5=content_md5,
            part_number=part_number,
        )

        documentupdate_files_body_data_multiparts_item.additional_properties = d
        return documentupdate_files_body_data_multiparts_item
