...
T = TypeVar("T", bound="MatterDocketMatter")


@_attrs_define
class MatterDocketMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_docket_matter.additional_properties = d
        return matter_docket_matter
