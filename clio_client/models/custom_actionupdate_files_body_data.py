...
@_attrs_define
class CustomActionupdateFilesBodyData:
    """
    Attributes:
        ...
        target_url (Union[Unset, str]): Target URL which will be opened in a new tab when the user clicks the custom
            link.
        ui_reference (Union[Unset, CustomActionupdateFilesBodyDataUiReference]): UI reference location within Clio where
            the link will be displayed.
    """

    label: Unset | str = UNSET
    target_url: Unset | str = UNSET
    ui_reference: Unset | CustomActionupdateFilesBodyDataUiReference = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ui_reference: Unset | CustomActionupdateFilesBodyDataUiReference
        if isinstance(_ui_reference, Unset):
            ui_reference = UNSET
        else:
            ui_reference = CustomActionupdateFilesBodyDataUiReference(_ui_reference)

        custom_actionupdate_files_body_data = cls(
            label=label,
            target_url=target_url,
            ui_reference=ui_reference,
        )

        custom_actionupdate_files_body_data.additional_properties = d
        return custom_actionupdate_files_body_data
