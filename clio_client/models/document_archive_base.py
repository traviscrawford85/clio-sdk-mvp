...
T = TypeVar("T", bound="DocumentArchiveBase")


@_attrs_define
class DocumentArchiveBase:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_archive_base.additional_properties = d
        return document_archive_base
