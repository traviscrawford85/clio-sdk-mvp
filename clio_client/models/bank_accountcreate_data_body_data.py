...
from ..models.bank_accountcreate_data_body_data_type import (
    BankAccountcreateDataBodyDataType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BankAccountcreateDataBodyData")


@_attrs_define
class BankAccountcreateDataBodyData:
    """
    Attributes:
        currency (str): Currency the BankAccount is in.
        type_ (BankAccountcreateDataBodyDataType): Type of BankAccount.
    ...
    currency: str
    type_: BankAccountcreateDataBodyDataType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = BankAccountcreateDataBodyDataType(d.pop("type"))
        ...
        bank_accountcreate_data_body_data = cls(
            currency=currency,
            type_=type_,
        ...
        bank_accountcreate_data_body_data.additional_properties = d
        return bank_accountcreate_data_body_data
