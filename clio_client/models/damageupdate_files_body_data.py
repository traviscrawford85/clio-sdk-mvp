...
from ..models.damageupdate_files_body_data_damage_type import (
...
class DamageupdateFilesBodyData:
    ...
    damage_type: Unset | DamageupdateFilesBodyDataDamageType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        damage_type: Unset | DamageupdateFilesBodyDataDamageType
