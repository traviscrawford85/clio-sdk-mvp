...
T = TypeVar("T", bound="ClioPaymentsLinkDestinationContact")


@_attrs_define
class ClioPaymentsLinkDestinationContact:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_link_destination_contact = cls(
        ...
        clio_payments_link_destination_contact.additional_properties = d
        return clio_payments_link_destination_contact
