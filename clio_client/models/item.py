...
class Item:
    ...
    type_: Unset | ItemBaseType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_category: Unset | ItemDocumentCategory
        ...
        latest_document_version: Unset | ItemLatestDocumentVersion
        if isinstance(_latest_document_version, Unset):
            latest_document_version = UNSET
        else:
            latest_document_version = ItemLatestDocumentVersion.from_dict(
                _latest_document_version
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ItemMatter
