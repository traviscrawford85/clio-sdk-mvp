...
T = TypeVar("T", bound="ClioPaymentsPaymentClioPaymentsLink")


@_attrs_define
class ClioPaymentsPaymentClioPaymentsLink:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_payment_clio_payments_link = cls(
            active=active,
            amount=amount,
        ...
        clio_payments_payment_clio_payments_link.additional_properties = d
        return clio_payments_payment_clio_payments_link
