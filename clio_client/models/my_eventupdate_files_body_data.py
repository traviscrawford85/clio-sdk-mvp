...
T = TypeVar("T", bound="MyEventupdateFilesBodyData")


@_attrs_define
class MyEventupdateFilesBodyData:
    """
    Attributes:
    ...
    marked_as_read: Unset | bool = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        my_eventupdate_files_body_data = cls(
            marked_as_read=marked_as_read,
        )

        my_eventupdate_files_body_data.additional_properties = d
        return my_eventupdate_files_body_data
