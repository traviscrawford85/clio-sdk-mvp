...
T = TypeVar("T", bound="ReportPresetReportSchedule")


@_attrs_define
class ReportPresetReportSchedule:
    """
    Attributes:
    ...
    frequency: Unset | ReportScheduleBaseFrequency = UNSET
    id: Unset | int = UNSET
    next_scheduled_date: Unset | str = UNSET
    report_preset_id: Unset | int = UNSET
    status: Unset | ReportScheduleBaseStatus = UNSET
    status_updated_at: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        frequency: Unset | ReportScheduleBaseFrequency
        ...
        status: Unset | ReportScheduleBaseStatus
        ...
        report_preset_report_schedule = cls(
        ...
        report_preset_report_schedule.additional_properties = d
        return report_preset_report_schedule
