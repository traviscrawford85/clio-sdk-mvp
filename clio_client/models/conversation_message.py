...
class ConversationMessage:
    ...
    receivers: Unset | list["UnredactedParticipantBase"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        sender: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversation: Unset | ConversationMessageConversation
        ...
        document: Unset | ConversationMessageDocument
        ...
        sender: Unset | ConversationMessageSender
