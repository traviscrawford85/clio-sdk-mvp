...
from ..models.calendar_entryupdate_json_body_data_deleted import (
    CalendarEntryupdateJsonBodyDataDeleted,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.calendar_entryupdate_json_body_data_attendees_item import (
        CalendarEntryupdateJsonBodyDataAttendeesItem,
    )
    from ..models.calendar_entryupdate_json_body_data_calendar_entry_event_type import (
        CalendarEntryupdateJsonBodyDataCalendarEntryEventType,
    )
    from ..models.calendar_entryupdate_json_body_data_calendar_owner import (
        CalendarEntryupdateJsonBodyDataCalendarOwner,
    )
    from ..models.calendar_entryupdate_json_body_data_conference_meeting import (
        CalendarEntryupdateJsonBodyDataConferenceMeeting,
    )
    from ..models.calendar_entryupdate_json_body_data_external_properties_item import (
        CalendarEntryupdateJsonBodyDataExternalPropertiesItem,
    )
    from ..models.calendar_entryupdate_json_body_data_matter import (
        CalendarEntryupdateJsonBodyDataMatter,
    )


T = TypeVar("T", bound="CalendarEntryupdateJsonBodyData")


@_attrs_define
class CalendarEntryupdateJsonBodyData:
    """
    Attributes:
        field_deleted (Union[Unset, CalendarEntryupdateJsonBodyDataDeleted]): Flag to delete a specific instance of a
            recurring event.
        all_day (Union[Unset, bool]): Whether or not the CalendarEntry is for all day.
        attendees (Union[Unset, list['CalendarEntryupdateJsonBodyDataAttendeesItem']]):
        calendar_entry_event_type (Union[Unset, CalendarEntryupdateJsonBodyDataCalendarEntryEventType]):
        calendar_owner (Union[Unset, CalendarEntryupdateJsonBodyDataCalendarOwner]):
        conference_meeting (Union[Unset, CalendarEntryupdateJsonBodyDataConferenceMeeting]):
        description (Union[Unset, str]): A detailed description of the CalendarEntry.
        end_at (Union[Unset, str]): The time the CalendarEntry ends (Expects an ISO-8601 timestamp).
        external_properties (Union[Unset, list['CalendarEntryupdateJsonBodyDataExternalPropertiesItem']]):
        location (Union[Unset, str]): The geographic location of the CalendarEntry.
        matter (Union[Unset, CalendarEntryupdateJsonBodyDataMatter]):
        ...
        send_email_notification (Union[Unset, bool]): Whether the calendar Entry should send email notifications to
            attendees
        start_at (Union[Unset, str]): The time the CalendarEntry starts (Expects an ISO-8601 timestamp).
        summary (Union[Unset, str]): A short summary of the CalendarEntry.
    """

    field_deleted: Unset | CalendarEntryupdateJsonBodyDataDeleted = UNSET
    all_day: Unset | bool = UNSET
    attendees: Unset | list["CalendarEntryupdateJsonBodyDataAttendeesItem"] = UNSET
    calendar_entry_event_type: Union[
        Unset, "CalendarEntryupdateJsonBodyDataCalendarEntryEventType"
    ] = UNSET
    calendar_owner: Union[Unset, "CalendarEntryupdateJsonBodyDataCalendarOwner"] = UNSET
    conference_meeting: Union[
        Unset, "CalendarEntryupdateJsonBodyDataConferenceMeeting"
    ] = UNSET
    description: Unset | str = UNSET
    end_at: Unset | str = UNSET
    external_properties: (
        Unset | list["CalendarEntryupdateJsonBodyDataExternalPropertiesItem"]
    ) = UNSET
    location: Unset | str = UNSET
    matter: Union[Unset, "CalendarEntryupdateJsonBodyDataMatter"] = UNSET
    recurrence_rule: Unset | str = UNSET
    send_email_notification: Unset | bool = UNSET
    start_at: Unset | str = UNSET
    summary: Unset | str = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        field_deleted: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_deleted: Unset | CalendarEntryupdateJsonBodyDataDeleted
        if isinstance(_field_deleted, Unset):
            field_deleted = UNSET
        else:
            field_deleted = CalendarEntryupdateJsonBodyDataDeleted(_field_deleted)
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntryupdateJsonBodyDataAttendeesItem.from_dict(
                attendees_item_data
            )
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = (
                CalendarEntryupdateJsonBodyDataCalendarEntryEventType.from_dict(
                    _calendar_entry_event_type
                )
            )

        _calendar_owner = d.pop("calendar_owner", UNSET)
        calendar_owner: Unset | CalendarEntryupdateJsonBodyDataCalendarOwner
        if isinstance(_calendar_owner, Unset):
            calendar_owner = UNSET
        else:
            calendar_owner = CalendarEntryupdateJsonBodyDataCalendarOwner.from_dict(
                _calendar_owner
            )

        _conference_meeting = d.pop("conference_meeting", UNSET)
        conference_meeting: Unset | CalendarEntryupdateJsonBodyDataConferenceMeeting
        if isinstance(_conference_meeting, Unset):
            conference_meeting = UNSET
        else:
            conference_meeting = (
                CalendarEntryupdateJsonBodyDataConferenceMeeting.from_dict(
                    _conference_meeting
                )
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CalendarEntryupdateJsonBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CalendarEntryupdateJsonBodyDataMatter
        if isinstance(_matter, Unset):
            matter = UNSET
        else:
            matter = CalendarEntryupdateJsonBodyDataMatter.from_dict(_matter)
        ...
        calendar_entryupdate_json_body_data = cls(
        ...
        calendar_entryupdate_json_body_data.additional_properties = d
        return calendar_entryupdate_json_body_data
