...
from ..models.mattercreate_json_body_data_custom_rate_type import (
...
class MattercreateJsonBodyDataCustomRate:
    ...
    rates: Unset | list["MattercreateJsonBodyDataCustomRateRatesItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rates_item_data in _rates or []:
            rates_item = MattercreateJsonBodyDataCustomRateRatesItem.from_dict(
                rates_item_data
            )
