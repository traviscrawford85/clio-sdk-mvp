...
@_attrs_define
class MattercreateDataBodyDataCustomFieldSetAssociationsItem:
    """
    Attributes:
        custom_field_set (MattercreateDataBodyDataCustomFieldSetAssociationsItemCustomFieldSet):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mattercreate_data_body_data_custom_field_set_associations_item = cls(
            custom_field_set=custom_field_set,
            display_order=display_order,
        )

        mattercreate_data_body_data_custom_field_set_associations_item.additional_properties = d
        return mattercreate_data_body_data_custom_field_set_associations_item
