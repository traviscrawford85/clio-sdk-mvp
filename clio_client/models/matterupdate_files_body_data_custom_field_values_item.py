...
class MatterupdateFilesBodyDataCustomFieldValuesItem:
    ...
    custom_field: Union[
        Unset, "MatterupdateFilesBodyDataCustomFieldValuesItemCustomField"
    ] = UNSET
    id: Unset | int = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field: Unset | MatterupdateFilesBodyDataCustomFieldValuesItemCustomField
        if isinstance(_custom_field, Unset):
            custom_field = UNSET
        else:
            custom_field = (
                MatterupdateFilesBodyDataCustomFieldValuesItemCustomField.from_dict(
                    _custom_field
                )
            )
