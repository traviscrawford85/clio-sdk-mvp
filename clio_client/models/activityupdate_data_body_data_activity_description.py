...
T = TypeVar("T", bound="ActivityupdateDataBodyDataActivityDescription")


@_attrs_define
class ActivityupdateDataBodyDataActivityDescription:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activityupdate_data_body_data_activity_description = cls(
            id=id,
            utbms_activity_id=utbms_activity_id,
            utbms_task_id=utbms_task_id,
        )

        activityupdate_data_body_data_activity_description.additional_properties = d
        return activityupdate_data_body_data_activity_description
