...
class LineItemupdateJsonBodyData:
    ...
    kind: Unset | LineItemupdateJsonBodyDataKind = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity: Unset | LineItemupdateJsonBodyDataActivity
        ...
        bill: Unset | LineItemupdateJsonBodyDataBill
        ...
        discount: Unset | LineItemupdateJsonBodyDataDiscount
        ...
        kind: Unset | LineItemupdateJsonBodyDataKind
        ...
        matter: Unset | LineItemupdateJsonBodyDataMatter
