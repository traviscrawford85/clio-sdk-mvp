...
T = TypeVar("T", bound="BankAccountupdateFilesBodyData")


@_attrs_define
class BankAccountupdateFilesBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bank_accountupdate_files_body_data = cls(
        ...
        bank_accountupdate_files_body_data.additional_properties = d
        return bank_accountupdate_files_body_data
