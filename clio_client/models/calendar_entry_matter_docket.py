...
T = TypeVar("T", bound="CalendarEntryMatterDocket")


@_attrs_define
class CalendarEntryMatterDocket:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calendar_entry_matter_docket = cls(
        ...
        calendar_entry_matter_docket.additional_properties = d
        return calendar_entry_matter_docket
