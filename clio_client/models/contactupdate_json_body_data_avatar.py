...
T = TypeVar("T", bound="ContactupdateJsonBodyDataAvatar")


@_attrs_define
class ContactupdateJsonBodyDataAvatar:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contactupdate_json_body_data_avatar = cls(
            field_destroy=field_destroy,
            image=image,
        )

        contactupdate_json_body_data_avatar.additional_properties = d
        return contactupdate_json_body_data_avatar
