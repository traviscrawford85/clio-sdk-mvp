...
T = TypeVar("T", bound="DocumentTemplateLastModifiedBy")


@_attrs_define
class DocumentTemplateLastModifiedBy:
    """
    Attributes:
        ...
        court_rules_default_attendee (Union[Unset, bool]): Whether the *User* is a default attendee for court rules
            events
        created_at (Union[Unset, str]): The time the *User* was created (as a ISO-8601 timestamp)
        ...
        updated_at (Union[Unset, str]): The time the *User* was last updated (as a ISO-8601 timestamp)
    """
    ...
    subscription_type: Unset | UserBaseSubscriptionType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subscription_type: Unset | UserBaseSubscriptionType
        ...
        document_template_last_modified_by = cls(
        ...
        document_template_last_modified_by.additional_properties = d
        return document_template_last_modified_by
