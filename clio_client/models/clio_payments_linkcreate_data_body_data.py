...
if TYPE_CHECKING:
    ...
    from ..models.clio_payments_linkcreate_data_body_data_subject import (
...
class ClioPaymentsLinkcreateDataBodyData:
    ...
    destination_contact: Union[
        Unset, "ClioPaymentsLinkcreateDataBodyDataDestinationContact"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        destination_account = (
            ClioPaymentsLinkcreateDataBodyDataDestinationAccount.from_dict(
        ...
        if isinstance(_destination_contact, Unset):
            ...
            destination_contact = (
                ClioPaymentsLinkcreateDataBodyDataDestinationContact.from_dict(
