...
@_attrs_define
class TrustLineItemupdateFilesBody:
    """
    Attributes:
        data (TrustLineItemupdateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trust_line_itemupdate_files_body = cls(
            data=data,
        )

        trust_line_itemupdate_files_body.additional_properties = d
        return trust_line_itemupdate_files_body
