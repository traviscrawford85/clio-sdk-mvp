...
T = TypeVar("T", bound="TrustLineItemClient")


@_attrs_define
class TrustLineItemClient:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trust_line_item_client.additional_properties = d
        return trust_line_item_client
