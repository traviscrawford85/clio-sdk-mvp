...
T = TypeVar("T", bound="ContactcreateJsonBodyDataAvatar")


@_attrs_define
class ContactcreateJsonBodyDataAvatar:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contactcreate_json_body_data_avatar = cls(
            field_destroy=field_destroy,
            image=image,
        )

        contactcreate_json_body_data_avatar.additional_properties = d
        return contactcreate_json_body_data_avatar
