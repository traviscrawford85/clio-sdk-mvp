...
class Bill:
    ...
    balances: Unset | list["BalanceBase"] = UNSET
    ...
    client_addresses: Unset | list["AddressBase"] = UNSET
    ...
    matter_totals: Unset | list["MatterBalanceBase"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        balances: Unset | list[dict[str, Any]] = UNSET
        ...
        billing_setting: Unset | dict[str, Any] = UNSET
        ...
        client_addresses: Unset | list[dict[str, Any]] = UNSET
        ...
        currency: Unset | dict[str, Any] = UNSET
        ...
        original_bill: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bill_theme: Unset | BillBillTheme
        ...
        billing_setting: Unset | BillBillingSetting
        ...
        destination_account: Unset | BillDestinationAccount
        ...
        legal_aid_uk_bill: Unset | BillLegalAidUkBill
        ...
        original_bill: Unset | BillOriginalBill
