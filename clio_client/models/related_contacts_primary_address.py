...
T = TypeVar("T", bound="RelatedContactsPrimaryAddress")


@_attrs_define
class RelatedContactsPrimaryAddress:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_contacts_primary_address = cls(
            city=city,
            country=country,
        ...
        related_contacts_primary_address.additional_properties = d
        return related_contacts_primary_address
