...
@_attrs_define
class ClioPaymentsLinkDestinationAccount:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_link_destination_account = cls(
        ...
        clio_payments_link_destination_account.additional_properties = d
        return clio_payments_link_destination_account
