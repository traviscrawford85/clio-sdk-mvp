...
T = TypeVar("T", bound="BillLegalAidUkBill")


@_attrs_define
class BillLegalAidUkBill:
    """
    Attributes:
        ...
        case_concluded (Union[Unset, str]): Case concluded
        ...
        date_of_claim (Union[Unset, str]): Date of claim
        ...
        representation_order_date (Union[Unset, str]): Representation order date
    ...
    additional_travel_payment: Unset | bool = UNSET
    adjourned_hearing_fee: Unset | str = UNSET
    advice_time: Unset | int = UNSET
    advocacy_costs: Unset | float = UNSET
    bill_type: Unset | int = UNSET
    case_concluded: Unset | str = UNSET
    case_stage_level: Unset | int = UNSET
    cla_exemption_code: Unset | str = UNSET
    cla_reference: Unset | str = UNSET
    cmrh_oral: Unset | int = UNSET
    cmrh_telephone: Unset | int = UNSET
    cost_of_counsel: Unset | str = UNSET
    costs_are_those_of: Unset | int = UNSET
    court_location: Unset | str = UNSET
    date_of_claim: Unset | str = UNSET
    designated_accredited_representative: Unset | int = UNSET
    detention_travel_and_waiting_costs: Unset | str = UNSET
    disbursements_vat: Unset | float = UNSET
    exceptional_case_funding_reference: Unset | str = UNSET
    exemption_criteria_satisfied: Unset | int = UNSET
    follow_on_work: Unset | int = UNSET
    ho_interview: Unset | int = UNSET
    ho_ucn: Unset | int = UNSET
    id: Unset | int = UNSET
    independent_medical_reports_claimed: Unset | str = UNSET
    jr_form_filling: Unset | str = UNSET
    maat_id: Unset | str = UNSET
    meetings_attended: Unset | int = UNSET
    mht_ref_no: Unset | str = UNSET
    net_disbursements: Unset | float = UNSET
    net_profit_costs: Unset | float = UNSET
    niat_disbursement_prior_authority_number: Unset | str = UNSET
    number_of_attendances: Unset | int = UNSET
    outcome_for_the_client: Unset | int = UNSET
    prior_authority_reference: Unset | str = UNSET
    profit_costs_ex_vat: Unset | int = UNSET
    representation_order_date: Unset | str = UNSET
    stage_reached: Unset | int = UNSET
    substantive_hearing: Unset | int = UNSET
    travel_and_waiting_costs: Unset | float = UNSET
    travel_time: Unset | int = UNSET
    value_of_costs: Unset | str = UNSET
    waiting_time: Unset | int = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        case_concluded = self.case_concluded
        ...
        niat_disbursement_prior_authority_number = (
            self.niat_disbursement_prior_authority_number
        )
        ...
        representation_order_date = self.representation_order_date
        ...
        if designated_accredited_representative is not UNSET:
            field_dict["designated_accredited_representative"] = (
                designated_accredited_representative
            )
        if detention_travel_and_waiting_costs is not UNSET:
            field_dict["detention_travel_and_waiting_costs"] = (
        ...
        if exceptional_case_funding_reference is not UNSET:
            field_dict["exceptional_case_funding_reference"] = (
        ...
        if independent_medical_reports_claimed is not UNSET:
            field_dict["independent_medical_reports_claimed"] = (
        ...
        if niat_disbursement_prior_authority_number is not UNSET:
            field_dict["niat_disbursement_prior_authority_number"] = (
                niat_disbursement_prior_authority_number
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        case_concluded = d.pop("case_concluded", UNSET)
        ...
        date_of_claim = d.pop("date_of_claim", UNSET)

        designated_accredited_representative = d.pop(
            "designated_accredited_representative", UNSET
        )

        detention_travel_and_waiting_costs = d.pop(
            "detention_travel_and_waiting_costs", UNSET
        )

        disbursements_vat = d.pop("disbursements_vat", UNSET)

        exceptional_case_funding_reference = d.pop(
            "exceptional_case_funding_reference", UNSET
        )
        ...
        independent_medical_reports_claimed = d.pop(
            "independent_medical_reports_claimed", UNSET
        )
        ...
        niat_disbursement_prior_authority_number = d.pop(
            "niat_disbursement_prior_authority_number", UNSET
        )
        ...
        representation_order_date = d.pop("representation_order_date", UNSET)
        ...
        bill_legal_aid_uk_bill.additional_properties = d
        return bill_legal_aid_uk_bill
