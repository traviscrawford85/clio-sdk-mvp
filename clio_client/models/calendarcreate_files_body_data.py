...
from ..models.calendarcreate_files_body_data_color import (
    CalendarcreateFilesBodyDataColor,
)
from ..models.calendarcreate_files_body_data_source import (
...
class CalendarcreateFilesBodyData:
    ...
    name: str
    color: Unset | CalendarcreateFilesBodyDataColor = UNSET
    source: Unset | CalendarcreateFilesBodyDataSource = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color: Unset | CalendarcreateFilesBodyDataColor
        ...
        source: Unset | CalendarcreateFilesBodyDataSource
