...
from ..models.matterupdate_data_body_data_custom_rate_type import (
...
class MatterupdateDataBodyDataCustomRate:
    ...
    rates: Unset | list["MatterupdateDataBodyDataCustomRateRatesItem"] = UNSET
    type_: Unset | MatterupdateDataBodyDataCustomRateType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rates_item_data in _rates or []:
            rates_item = MatterupdateDataBodyDataCustomRateRatesItem.from_dict(
                rates_item_data
            )
        ...
        type_: Unset | MatterupdateDataBodyDataCustomRateType
