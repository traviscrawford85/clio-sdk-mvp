...
if TYPE_CHECKING:
    from ..models.matterupdate_files_body_data_custom_rate_rates_item_activity_description import (
        MatterupdateFilesBodyDataCustomRateRatesItemActivityDescription,
    )
    from ..models.matterupdate_files_body_data_custom_rate_rates_item_group import (
        MatterupdateFilesBodyDataCustomRateRatesItemGroup,
    )
    from ..models.matterupdate_files_body_data_custom_rate_rates_item_user import (
        MatterupdateFilesBodyDataCustomRateRatesItemUser,
    )


T = TypeVar("T", bound="MatterupdateFilesBodyDataCustomRateRatesItem")


@_attrs_define
class MatterupdateFilesBodyDataCustomRateRatesItem:
    """
    Attributes:
        ...
        activity_description (Union[Unset, MatterupdateFilesBodyDataCustomRateRatesItemActivityDescription]):
        ...
        group (Union[Unset, MatterupdateFilesBodyDataCustomRateRatesItemGroup]):
        ...
        user (Union[Unset, MatterupdateFilesBodyDataCustomRateRatesItemUser]):
    """

    field_destroy: Unset | bool = UNSET
    activity_description: Union[
        Unset, "MatterupdateFilesBodyDataCustomRateRatesItemActivityDescription"
    ] = UNSET
    award: Unset | float = UNSET
    date: Unset | str = UNSET
    group: Union[Unset, "MatterupdateFilesBodyDataCustomRateRatesItemGroup"] = UNSET
    id: Unset | int = UNSET
    note: Unset | str = UNSET
    rate: Unset | float = UNSET
    user: Union[Unset, "MatterupdateFilesBodyDataCustomRateRatesItemUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_activity_description, Unset):
            ...
            activity_description = MatterupdateFilesBodyDataCustomRateRatesItemActivityDescription.from_dict(
        ...
        group: Unset | MatterupdateFilesBodyDataCustomRateRatesItemGroup
        if isinstance(_group, Unset):
            group = UNSET
        else:
            group = MatterupdateFilesBodyDataCustomRateRatesItemGroup.from_dict(_group)
        ...
        user: Unset | MatterupdateFilesBodyDataCustomRateRatesItemUser
        if isinstance(_user, Unset):
            user = UNSET
        else:
            user = MatterupdateFilesBodyDataCustomRateRatesItemUser.from_dict(_user)

        matterupdate_files_body_data_custom_rate_rates_item = cls(
        ...
        matterupdate_files_body_data_custom_rate_rates_item.additional_properties = d
        return matterupdate_files_body_data_custom_rate_rates_item
