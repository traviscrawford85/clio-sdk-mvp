...
T = TypeVar("T", bound="ClioPaymentsLinkContact")


@_attrs_define
class ClioPaymentsLinkContact:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clio_payments_link_contact = cls(
        ...
        clio_payments_link_contact.additional_properties = d
        return clio_payments_link_contact
