...
T = TypeVar("T", bound="AllocationSourceBankAccount")


@_attrs_define
class AllocationSourceBankAccount:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allocation_source_bank_account = cls(
        ...
        allocation_source_bank_account.additional_properties = d
        return allocation_source_bank_account
