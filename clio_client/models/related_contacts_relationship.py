...
T = TypeVar("T", bound="RelatedContactsRelationship")


@_attrs_define
class RelatedContactsRelationship:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_contacts_relationship = cls(
        ...
        related_contacts_relationship.additional_properties = d
        return related_contacts_relationship
