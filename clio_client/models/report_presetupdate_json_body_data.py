...
class ReportPresetupdateJsonBodyData:
    ...
    format_: Unset | ReportPresetupdateJsonBodyDataFormat = UNSET
    kind: Unset | ReportPresetupdateJsonBodyDataKind = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        format_: Unset | ReportPresetupdateJsonBodyDataFormat
        ...
        kind: Unset | ReportPresetupdateJsonBodyDataKind
