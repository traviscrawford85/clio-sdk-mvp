...
T = TypeVar("T", bound="ActivityRateupdateFilesBodyData")


@_attrs_define
class ActivityRateupdateFilesBodyData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_rateupdate_files_body_data = cls(
        ...
        activity_rateupdate_files_body_data.additional_properties = d
        return activity_rateupdate_files_body_data
