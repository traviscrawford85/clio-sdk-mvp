...
class ConversationMessagecreateDataBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for receivers_item_data in _receivers:
            receivers_item = (
                ConversationMessagecreateDataBodyDataReceiversItem.from_dict(
                    receivers_item_data
                )
            )
        ...
        attachment: Unset | ConversationMessagecreateDataBodyDataAttachment
        if isinstance(_attachment, Unset):
            attachment = UNSET
        else:
            attachment = ConversationMessagecreateDataBodyDataAttachment.from_dict(
                _attachment
            )

        _conversation = d.pop("conversation", UNSET)
        conversation: Unset | ConversationMessagecreateDataBodyDataConversation
        if isinstance(_conversation, Unset):
            conversation = UNSET
        else:
            conversation = ConversationMessagecreateDataBodyDataConversation.from_dict(
                _conversation
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ConversationMessagecreateDataBodyDataMatter
