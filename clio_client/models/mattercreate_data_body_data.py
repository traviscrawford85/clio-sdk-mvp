...
if TYPE_CHECKING:
    from ..models.mattercreate_data_body_data_client import (
    ...
    from ..models.mattercreate_data_body_data_custom_rate import (
        MattercreateDataBodyDataCustomRate,
    )
    from ..models.mattercreate_data_body_data_evergreen_retainer import (
    ...
    from ..models.mattercreate_data_body_data_matter_budget import (
        MattercreateDataBodyDataMatterBudget,
    )
    from ..models.mattercreate_data_body_data_matter_stage import (
    ...
    from ..models.mattercreate_data_body_data_practice_area import (
        MattercreateDataBodyDataPracticeArea,
    )
    from ..models.mattercreate_data_body_data_relationships_item import (
...
class MattercreateDataBodyData:
    ...
    custom_field_set_associations: (
        Unset | list["MattercreateDataBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["MattercreateDataBodyDataCustomFieldValuesItem"]
    ) = UNSET
    ...
    originating_attorney: Union[
        Unset, "MattercreateDataBodyDataOriginatingAttorney"
    ] = UNSET
    pending_date: Unset | str = UNSET
    practice_area: Union[Unset, "MattercreateDataBodyDataPracticeArea"] = UNSET
    relationships: Unset | list["MattercreateDataBodyDataRelationshipsItem"] = UNSET
    reset_matter_number: Unset | bool = False
    responsible_attorney: Union[
        Unset, "MattercreateDataBodyDataResponsibleAttorney"
    ] = UNSET
    split_invoice_payers: (
        Unset | list["MattercreateDataBodyDataSplitInvoicePayersItem"]
    ) = UNSET
    status: Unset | MattercreateDataBodyDataStatus = UNSET
    statute_of_limitations: Union[
        Unset, "MattercreateDataBodyDataStatuteOfLimitations"
    ] = UNSET
    task_template_list_instances: (
        Unset | list["MattercreateDataBodyDataTaskTemplateListInstancesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.mattercreate_data_body_data_group import (
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                MattercreateDataBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                MattercreateDataBodyDataCustomFieldValuesItem.from_dict(
        ...
        custom_rate: Unset | MattercreateDataBodyDataCustomRate
        ...
        evergreen_retainer: Unset | MattercreateDataBodyDataEvergreenRetainer
        if isinstance(_evergreen_retainer, Unset):
            evergreen_retainer = UNSET
        else:
            evergreen_retainer = MattercreateDataBodyDataEvergreenRetainer.from_dict(
                _evergreen_retainer
            )

        _group = d.pop("group", UNSET)
        group: Unset | MattercreateDataBodyDataGroup
        ...
        matter_budget: Unset | MattercreateDataBodyDataMatterBudget
        if isinstance(_matter_budget, Unset):
            matter_budget = UNSET
        else:
            matter_budget = MattercreateDataBodyDataMatterBudget.from_dict(
                _matter_budget
            )

        _matter_stage = d.pop("matter_stage", UNSET)
        matter_stage: Unset | MattercreateDataBodyDataMatterStage
        ...
        originating_attorney: Unset | MattercreateDataBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                MattercreateDataBodyDataOriginatingAttorney.from_dict(
        ...
        practice_area: Unset | MattercreateDataBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = MattercreateDataBodyDataPracticeArea.from_dict(
                _practice_area
            )
        ...
        for relationships_item_data in _relationships or []:
            relationships_item = MattercreateDataBodyDataRelationshipsItem.from_dict(
        ...
        responsible_attorney: Unset | MattercreateDataBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                MattercreateDataBodyDataResponsibleAttorney.from_dict(
        ...
        for split_invoice_payers_item_data in _split_invoice_payers or []:
            split_invoice_payers_item = (
                MattercreateDataBodyDataSplitInvoicePayersItem.from_dict(
        ...
        status: Unset | MattercreateDataBodyDataStatus
        ...
        statute_of_limitations: Unset | MattercreateDataBodyDataStatuteOfLimitations
        if isinstance(_statute_of_limitations, Unset):
            statute_of_limitations = UNSET
        else:
            statute_of_limitations = (
                MattercreateDataBodyDataStatuteOfLimitations.from_dict(
        ...
        for task_template_list_instances_item_data in (
            ...
            task_template_list_instances_item = (
                MattercreateDataBodyDataTaskTemplateListInstancesItem.from_dict(
                    task_template_list_instances_item_data
                )
            )
