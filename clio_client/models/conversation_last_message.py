...
T = TypeVar("T", bound="ConversationLastMessage")
...
class ConversationLastMessage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversation_last_message.additional_properties = d
        return conversation_last_message
