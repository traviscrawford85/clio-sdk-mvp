...
T = TypeVar("T", bound="MattercreateJsonBodyDataMatterBudget")


@_attrs_define
class MattercreateJsonBodyDataMatterBudget:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mattercreate_json_body_data_matter_budget = cls(
        ...
        mattercreate_json_body_data_matter_budget.additional_properties = d
        return mattercreate_json_body_data_matter_budget
