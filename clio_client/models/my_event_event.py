...
class MyEventEvent:
    ...
    description_url: Unset | str = UNSET
    etag: Unset | str = UNSET
    icon: Unset | str = UNSET
    id: Unset | int = UNSET
    message: Unset | str = UNSET
    mobile_icon: Unset | str = UNSET
    occurred_at: Unset | str = UNSET
    primary_detail: Unset | str = UNSET
    primary_detail_url: Unset | str = UNSET
    secondary_detail: Unset | str = UNSET
    secondary_detail_url: Unset | str = UNSET
    subject_id: Unset | int = UNSET
    subject_type: Unset | str = UNSET
    title: Unset | str = UNSET
    title_url: Unset | str = UNSET
