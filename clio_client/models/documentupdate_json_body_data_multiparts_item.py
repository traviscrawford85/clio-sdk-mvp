...
T = TypeVar("T", bound="DocumentupdateJsonBodyDataMultipartsItem")


@_attrs_define
class DocumentupdateJsonBodyDataMultipartsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documentupdate_json_body_data_multiparts_item = cls(
            content_length=content_length,
            content_md5=content_md5,
            part_number=part_number,
        )

        documentupdate_json_body_data_multiparts_item.additional_properties = d
        return documentupdate_json_body_data_multiparts_item
