...
class WebhookBase:
    ...
    events: Unset | list[WebhookBaseEventsItem] = UNSET
    expires_at: Unset | str = UNSET
    fields: Unset | str = UNSET
    id: Unset | int = UNSET
    model: Unset | WebhookBaseModel = UNSET
    shared_secret: Unset | str = UNSET
    status: Unset | WebhookBaseStatus = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Unset | WebhookBaseStatus
