...
@_attrs_define
class ReminderupdateFilesBodyData:
    """
    Attributes:
        duration_unit (Union[Unset, ReminderupdateFilesBodyDataDurationUnit]): Unit to measure the duration value in.
        duration_value (Union[Unset, int]): Time measured in `duration_unit` to remind user before the subject.
        notification_method (Union[Unset, ReminderupdateFilesBodyDataNotificationMethod]):
    """

    duration_unit: Unset | ReminderupdateFilesBodyDataDurationUnit = UNSET
    duration_value: Unset | int = UNSET
    notification_method: Union[
        Unset, "ReminderupdateFilesBodyDataNotificationMethod"
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        notification_method: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duration_unit: Unset | ReminderupdateFilesBodyDataDurationUnit
        if isinstance(_duration_unit, Unset):
            duration_unit = UNSET
        else:
            duration_unit = ReminderupdateFilesBodyDataDurationUnit(_duration_unit)

        duration_value = d.pop("duration_value", UNSET)

        _notification_method = d.pop("notification_method", UNSET)
        notification_method: Unset | ReminderupdateFilesBodyDataNotificationMethod
        if isinstance(_notification_method, Unset):
            notification_method = UNSET
        else:
            notification_method = (
                ReminderupdateFilesBodyDataNotificationMethod.from_dict(
                    _notification_method
                )
            )

        reminderupdate_files_body_data = cls(
            duration_unit=duration_unit,
            duration_value=duration_value,
            notification_method=notification_method,
        )

        reminderupdate_files_body_data.additional_properties = d
        return reminderupdate_files_body_data
