...
class CalendarEntryupdateFilesBodyData:
    ...
    field_deleted: Unset | CalendarEntryupdateFilesBodyDataDeleted = UNSET
    all_day: Unset | bool = UNSET
    attendees: Unset | list["CalendarEntryupdateFilesBodyDataAttendeesItem"] = UNSET
    calendar_entry_event_type: Union[
        Unset, "CalendarEntryupdateFilesBodyDataCalendarEntryEventType"
    ] = UNSET
    calendar_owner: Union[Unset, "CalendarEntryupdateFilesBodyDataCalendarOwner"] = (
        UNSET
    )
    conference_meeting: Union[
        Unset, "CalendarEntryupdateFilesBodyDataConferenceMeeting"
    ] = UNSET
    description: Unset | str = UNSET
    end_at: Unset | str = UNSET
    external_properties: (
        Unset | list["CalendarEntryupdateFilesBodyDataExternalPropertiesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_deleted: Unset | CalendarEntryupdateFilesBodyDataDeleted
        ...
        for attendees_item_data in _attendees or []:
            attendees_item = CalendarEntryupdateFilesBodyDataAttendeesItem.from_dict(
                attendees_item_data
            )
        ...
        if isinstance(_calendar_entry_event_type, Unset):
            ...
            calendar_entry_event_type = (
                CalendarEntryupdateFilesBodyDataCalendarEntryEventType.from_dict(
                    _calendar_entry_event_type
                )
            )

        _calendar_owner = d.pop("calendar_owner", UNSET)
        calendar_owner: Unset | CalendarEntryupdateFilesBodyDataCalendarOwner
        if isinstance(_calendar_owner, Unset):
            calendar_owner = UNSET
        else:
            calendar_owner = CalendarEntryupdateFilesBodyDataCalendarOwner.from_dict(
                _calendar_owner
            )

        _conference_meeting = d.pop("conference_meeting", UNSET)
        conference_meeting: Unset | CalendarEntryupdateFilesBodyDataConferenceMeeting
        if isinstance(_conference_meeting, Unset):
            conference_meeting = UNSET
        else:
            conference_meeting = (
                CalendarEntryupdateFilesBodyDataConferenceMeeting.from_dict(
                    _conference_meeting
                )
            )
        ...
        for external_properties_item_data in _external_properties or []:
            external_properties_item = (
                CalendarEntryupdateFilesBodyDataExternalPropertiesItem.from_dict(
        ...
        matter: Unset | CalendarEntryupdateFilesBodyDataMatter
