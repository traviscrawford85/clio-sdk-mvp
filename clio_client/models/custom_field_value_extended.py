...
T = TypeVar("T", bound="CustomFieldValueExtended")


@_attrs_define
class CustomFieldValueExtended:
    """
    Attributes:
    ...
    field_display_order: Unset | int = UNSET
    field_displayed: Unset | bool = UNSET
    field_name: Unset | str = UNSET
    field_required: Unset | bool = UNSET
    field_type: Unset | CustomFieldValueBaseFieldType = UNSET
    id: Unset | str = UNSET
    soft_deleted: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        picklist_option: Unset | dict[str, Any] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_type: Unset | CustomFieldValueBaseFieldType
        ...
        custom_field: Unset | CustomField
        ...
        picklist_option: Unset | PicklistOption
        ...
        matter: Unset | CustomFieldValueExtendedMatter
        ...
        contact: Unset | ClioContact
        if isinstance(_contact, Unset):
            contact = UNSET
        else:
            contact = ClioContact.from_dict(_contact)

        custom_field_value_extended = cls(
        ...
        custom_field_value_extended.additional_properties = d
        return custom_field_value_extended
