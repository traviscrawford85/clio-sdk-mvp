...
class MattercreateJsonBodyData:
    ...
    custom_field_set_associations: (
        Unset | list["MattercreateJsonBodyDataCustomFieldSetAssociationsItem"]
    ) = UNSET
    custom_field_values: (
        Unset | list["MattercreateJsonBodyDataCustomFieldValuesItem"]
    ) = UNSET
    ...
    originating_attorney: Union[
        Unset, "MattercreateJsonBodyDataOriginatingAttorney"
    ] = UNSET
    pending_date: Unset | str = UNSET
    practice_area: Union[Unset, "MattercreateJsonBodyDataPracticeArea"] = UNSET
    relationships: Unset | list["MattercreateJsonBodyDataRelationshipsItem"] = UNSET
    reset_matter_number: Unset | bool = False
    responsible_attorney: Union[
        Unset, "MattercreateJsonBodyDataResponsibleAttorney"
    ] = UNSET
    split_invoice_payers: (
        Unset | list["MattercreateJsonBodyDataSplitInvoicePayersItem"]
    ) = UNSET
    status: Unset | MattercreateJsonBodyDataStatus = UNSET
    statute_of_limitations: Union[
        Unset, "MattercreateJsonBodyDataStatuteOfLimitations"
    ] = UNSET
    task_template_list_instances: (
        Unset | list["MattercreateJsonBodyDataTaskTemplateListInstancesItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for custom_field_set_associations_item_data in (
            ...
            custom_field_set_associations_item = (
                MattercreateJsonBodyDataCustomFieldSetAssociationsItem.from_dict(
                    custom_field_set_associations_item_data
                )
            )
        ...
        for custom_field_values_item_data in _custom_field_values or []:
            custom_field_values_item = (
                MattercreateJsonBodyDataCustomFieldValuesItem.from_dict(
        ...
        custom_rate: Unset | MattercreateJsonBodyDataCustomRate
        ...
        evergreen_retainer: Unset | MattercreateJsonBodyDataEvergreenRetainer
        if isinstance(_evergreen_retainer, Unset):
            evergreen_retainer = UNSET
        else:
            evergreen_retainer = MattercreateJsonBodyDataEvergreenRetainer.from_dict(
                _evergreen_retainer
            )

        _group = d.pop("group", UNSET)
        group: Unset | MattercreateJsonBodyDataGroup
        ...
        matter_budget: Unset | MattercreateJsonBodyDataMatterBudget
        if isinstance(_matter_budget, Unset):
            matter_budget = UNSET
        else:
            matter_budget = MattercreateJsonBodyDataMatterBudget.from_dict(
                _matter_budget
            )

        _matter_stage = d.pop("matter_stage", UNSET)
        matter_stage: Unset | MattercreateJsonBodyDataMatterStage
        ...
        originating_attorney: Unset | MattercreateJsonBodyDataOriginatingAttorney
        if isinstance(_originating_attorney, Unset):
            originating_attorney = UNSET
        else:
            originating_attorney = (
                MattercreateJsonBodyDataOriginatingAttorney.from_dict(
        ...
        practice_area: Unset | MattercreateJsonBodyDataPracticeArea
        if isinstance(_practice_area, Unset):
            practice_area = UNSET
        else:
            practice_area = MattercreateJsonBodyDataPracticeArea.from_dict(
                _practice_area
            )
        ...
        for relationships_item_data in _relationships or []:
            relationships_item = MattercreateJsonBodyDataRelationshipsItem.from_dict(
        ...
        responsible_attorney: Unset | MattercreateJsonBodyDataResponsibleAttorney
        if isinstance(_responsible_attorney, Unset):
            responsible_attorney = UNSET
        else:
            responsible_attorney = (
                MattercreateJsonBodyDataResponsibleAttorney.from_dict(
        ...
        for split_invoice_payers_item_data in _split_invoice_payers or []:
            split_invoice_payers_item = (
                MattercreateJsonBodyDataSplitInvoicePayersItem.from_dict(
        ...
        status: Unset | MattercreateJsonBodyDataStatus
        ...
        statute_of_limitations: Unset | MattercreateJsonBodyDataStatuteOfLimitations
        if isinstance(_statute_of_limitations, Unset):
            statute_of_limitations = UNSET
        else:
            statute_of_limitations = (
                MattercreateJsonBodyDataStatuteOfLimitations.from_dict(
        ...
        for task_template_list_instances_item_data in (
            ...
            task_template_list_instances_item = (
                MattercreateJsonBodyDataTaskTemplateListInstancesItem.from_dict(
                    task_template_list_instances_item_data
                )
            )
