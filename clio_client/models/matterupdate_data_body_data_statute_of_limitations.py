...
class MatterupdateDataBodyDataStatuteOfLimitations:
    ...
    reminders: (
        Unset | list["MatterupdateDataBodyDataStatuteOfLimitationsRemindersItem"]
    ) = UNSET
    status: Unset | MatterupdateDataBodyDataStatuteOfLimitationsStatus = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for reminders_item_data in _reminders or []:
            reminders_item = (
                MatterupdateDataBodyDataStatuteOfLimitationsRemindersItem.from_dict(
                    reminders_item_data
                )
            )
        ...
        status: Unset | MatterupdateDataBodyDataStatuteOfLimitationsStatus
