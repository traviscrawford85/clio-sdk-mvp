...
if TYPE_CHECKING:
    ...
    from ..models.activity_descriptioncreate_files_body_data_rate import (
...
class ActivityDescriptioncreateFilesBodyData:
    ...
    groups: Unset | list["ActivityDescriptioncreateFilesBodyDataGroupsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for groups_item_data in _groups or []:
            groups_item = ActivityDescriptioncreateFilesBodyDataGroupsItem.from_dict(
                groups_item_data
            )
        ...
        rate: Unset | ActivityDescriptioncreateFilesBodyDataRate
