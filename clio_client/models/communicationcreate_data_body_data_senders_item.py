...
from ..models.communicationcreate_data_body_data_senders_item_type import (
...
class CommunicationcreateDataBodyDataSendersItem:
    ...
    id: Unset | int = UNSET
    type_: Unset | CommunicationcreateDataBodyDataSendersItemType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | CommunicationcreateDataBodyDataSendersItemType
