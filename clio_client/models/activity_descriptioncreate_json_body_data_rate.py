...
from ..models.activity_descriptioncreate_json_body_data_rate_type import (
...
class ActivityDescriptioncreateJsonBodyDataRate:
    ...
    type_: Unset | ActivityDescriptioncreateJsonBodyDataRateType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Unset | ActivityDescriptioncreateJsonBodyDataRateType
