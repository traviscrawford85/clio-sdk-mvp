...
from ..models.activitycreate_json_body_data_tax_setting import (
...
if TYPE_CHECKING:
    ...
    from ..models.activitycreate_json_body_data_calendar_entry import (
        ActivitycreateJsonBodyDataCalendarEntry,
    )
    from ..models.activitycreate_json_body_data_client_portal import (
        ActivitycreateJsonBodyDataClientPortal,
    )
    from ..models.activitycreate_json_body_data_communication import (
        ActivitycreateJsonBodyDataCommunication,
    )
    from ..models.activitycreate_json_body_data_contact_note import (
        ActivitycreateJsonBodyDataContactNote,
    )
    from ..models.activitycreate_json_body_data_expense_category import (
        ActivitycreateJsonBodyDataExpenseCategory,
    )
    from ..models.activitycreate_json_body_data_matter import (
        ActivitycreateJsonBodyDataMatter,
    )
    from ..models.activitycreate_json_body_data_matter_note import (
        ActivitycreateJsonBodyDataMatterNote,
    )
    from ..models.activitycreate_json_body_data_task import (
    ...
    from ..models.activitycreate_json_body_data_user import (
        ActivitycreateJsonBodyDataUser,
    )
    from ..models.activitycreate_json_body_data_utbms_expense import (
        ActivitycreateJsonBodyDataUtbmsExpense,
    )
    from ..models.activitycreate_json_body_data_vendor import (
...
class ActivitycreateJsonBodyData:
    ...
    activity_description: Union[
        Unset, "ActivitycreateJsonBodyDataActivityDescription"
    ] = UNSET
    ...
    tax_setting: Unset | ActivitycreateJsonBodyDataTaxSetting = UNSET
    text_message_conversation: Union[
        Unset, "ActivitycreateJsonBodyDataTextMessageConversation"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_description: Unset | ActivitycreateJsonBodyDataActivityDescription
        if isinstance(_activity_description, Unset):
            activity_description = UNSET
        else:
            activity_description = (
                ActivitycreateJsonBodyDataActivityDescription.from_dict(
                    _activity_description
                )
            )

        _calendar_entry = d.pop("calendar_entry", UNSET)
        calendar_entry: Unset | ActivitycreateJsonBodyDataCalendarEntry
        if isinstance(_calendar_entry, Unset):
            calendar_entry = UNSET
        else:
            calendar_entry = ActivitycreateJsonBodyDataCalendarEntry.from_dict(
                _calendar_entry
            )

        _client_portal = d.pop("client_portal", UNSET)
        client_portal: Unset | ActivitycreateJsonBodyDataClientPortal
        if isinstance(_client_portal, Unset):
            client_portal = UNSET
        else:
            client_portal = ActivitycreateJsonBodyDataClientPortal.from_dict(
                _client_portal
            )

        _communication = d.pop("communication", UNSET)
        communication: Unset | ActivitycreateJsonBodyDataCommunication
        if isinstance(_communication, Unset):
            communication = UNSET
        else:
            communication = ActivitycreateJsonBodyDataCommunication.from_dict(
                _communication
            )

        _contact_note = d.pop("contact_note", UNSET)
        contact_note: Unset | ActivitycreateJsonBodyDataContactNote
        if isinstance(_contact_note, Unset):
            contact_note = UNSET
        else:
            contact_note = ActivitycreateJsonBodyDataContactNote.from_dict(
                _contact_note
            )

        _expense_category = d.pop("expense_category", UNSET)
        expense_category: Unset | ActivitycreateJsonBodyDataExpenseCategory
        if isinstance(_expense_category, Unset):
            expense_category = UNSET
        else:
            expense_category = ActivitycreateJsonBodyDataExpenseCategory.from_dict(
                _expense_category
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ActivitycreateJsonBodyDataMatter
        ...
        matter_note: Unset | ActivitycreateJsonBodyDataMatterNote
        ...
        task: Unset | ActivitycreateJsonBodyDataTask
        ...
        tax_setting: Unset | ActivitycreateJsonBodyDataTaxSetting
        ...
        if isinstance(_text_message_conversation, Unset):
            ...
            text_message_conversation = (
                ActivitycreateJsonBodyDataTextMessageConversation.from_dict(
                    _text_message_conversation
                )
            )

        _user = d.pop("user", UNSET)
        user: Unset | ActivitycreateJsonBodyDataUser
        ...
        utbms_expense: Unset | ActivitycreateJsonBodyDataUtbmsExpense
        if isinstance(_utbms_expense, Unset):
            utbms_expense = UNSET
        else:
            utbms_expense = ActivitycreateJsonBodyDataUtbmsExpense.from_dict(
                _utbms_expense
            )

        _vendor = d.pop("vendor", UNSET)
        vendor: Unset | ActivitycreateJsonBodyDataVendor
