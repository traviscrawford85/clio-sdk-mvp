...
T = TypeVar("T", bound="PolymorphicCustomRateUser")


@_attrs_define
class PolymorphicCustomRateUser:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        polymorphic_custom_rate_user = cls(
            enabled=enabled,
            etag=etag,
            id=id,
            name=name,
        ...
        polymorphic_custom_rate_user.additional_properties = d
        return polymorphic_custom_rate_user
