...
if TYPE_CHECKING:
    from ..models.mattercreate_files_body_data_evergreen_retainer_recipients_item import (
        MattercreateFilesBodyDataEvergreenRetainerRecipientsItem,
    )


T = TypeVar("T", bound="MattercreateFilesBodyDataEvergreenRetainer")


@_attrs_define
class MattercreateFilesBodyDataEvergreenRetainer:
    """
    Attributes:
        ...
        recipients (Union[Unset, list['MattercreateFilesBodyDataEvergreenRetainerRecipientsItem']]):
    """

    minimum_threshold: Unset | float = UNSET
    recipients: (
        Unset | list["MattercreateFilesBodyDataEvergreenRetainerRecipientsItem"]
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for recipients_item_data in _recipients or []:
            recipients_item = (
                MattercreateFilesBodyDataEvergreenRetainerRecipientsItem.from_dict(
        ...
        mattercreate_files_body_data_evergreen_retainer = cls(
            minimum_threshold=minimum_threshold,
            recipients=recipients,
        )

        mattercreate_files_body_data_evergreen_retainer.additional_properties = d
        return mattercreate_files_body_data_evergreen_retainer
