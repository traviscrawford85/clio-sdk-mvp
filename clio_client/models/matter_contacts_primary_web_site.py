...
T = TypeVar("T", bound="MatterContactsPrimaryWebSite")


@_attrs_define
class MatterContactsPrimaryWebSite:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_contacts_primary_web_site = cls(
            address=address,
        ...
        matter_contacts_primary_web_site.additional_properties = d
        return matter_contacts_primary_web_site
