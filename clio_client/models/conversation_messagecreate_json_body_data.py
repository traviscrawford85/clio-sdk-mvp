...
class ConversationMessagecreateJsonBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for receivers_item_data in _receivers:
            receivers_item = (
                ConversationMessagecreateJsonBodyDataReceiversItem.from_dict(
                    receivers_item_data
                )
            )
        ...
        attachment: Unset | ConversationMessagecreateJsonBodyDataAttachment
        if isinstance(_attachment, Unset):
            attachment = UNSET
        else:
            attachment = ConversationMessagecreateJsonBodyDataAttachment.from_dict(
                _attachment
            )

        _conversation = d.pop("conversation", UNSET)
        conversation: Unset | ConversationMessagecreateJsonBodyDataConversation
        if isinstance(_conversation, Unset):
            conversation = UNSET
        else:
            conversation = ConversationMessagecreateJsonBodyDataConversation.from_dict(
                _conversation
            )

        _matter = d.pop("matter", UNSET)
        matter: Unset | ConversationMessagecreateJsonBodyDataMatter
